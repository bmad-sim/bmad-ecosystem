...
do
  ! Track the beam until loss
  call bbu_track_a_stage (lat, bbu_beam, bbu_param, lost)
  if (lost) then
    print *, 'Beam is lost after tracking a stage. (HOM voltage computed might not be accurate)'
    exit
  endif
...
!!! This subroutine belonged to bbu_track_mod.f90 
!!! OBSOLETE as of May 16 2016 
...
!!!! This function is OBSOLETE as of May 16 2016 
