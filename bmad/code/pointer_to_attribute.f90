...
case ('DETA_A_DS');       a_ptr%r => ele%a%eta
case ('DETA_B_DS');       a_ptr%r => ele%b%eta
case ('DETA_X_DS');       a_ptr%r => ele%x%eta
case ('DETA_Y_DS');       a_ptr%r => ele%y%eta
case ('DETA_Z_DS');       a_ptr%r => ele%z%eta
