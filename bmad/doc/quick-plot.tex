...
\vn{"mediumspringgreen"}). Ten CSS4 names that share both name and RGB value with original \quickplot
colors are excluded: \vn{black}, \vn{blue}, \vn{cyan}, \vn{green}, \vn{magenta}, \vn{orange},
\vn{purple}, \vn{red}, \vn{white}, and \vn{yellow}. The CSS4 colors are ordered by visual
distinctiveness so that devices with limited color index support still get the most distinguishable
colors at lower indices.
