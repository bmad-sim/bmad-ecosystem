...
is a dependent parameter and will be set to the value of \vn{particle_start}. Note: Old deprecated
name for \vn{%use_particle_start} is is \vn{%use_particle_start_for_center}
%
