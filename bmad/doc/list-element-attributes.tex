...
ele_origin                       & ref_time_start [sec]             & x1_limit [m]                     & z_offset [m]                     \\
 ...
 \begin{tabular}{llll} \toprule
alias                            & l [m]                            & thickness [m]                    & x_pitch_tot [rad]                \\
aperture [m]                     & mat6_calc_method                 & tilt [rad]                       & y1_edge [m]                      \\
aperture_at                      & material_type                    & tilt_tot [rad]                   & y1_limit [m]                     \\
aperture_type                    & offset [m]                       & tracking_method                  & y2_edge [m]                      \\
area_density [kg/m$^2$]          & offset_moves_aperture            & type                             & y2_limit [m]                     \\
area_density_used [kg/m$^2$]     & p0c [eV]                         & wall                             & y_limit [m]                      \\
create_jumbo_slave               & ptc_integration_type             & wrap_superimpose                 & y_offset [m]                     \\
delta_ref_time [sec]             & radiation_length [m]             & x1_edge [m]                      & y_offset_tot [m]                 \\
density [kg/m$^3$]               & radiation_length_used [m]        & x1_limit [m]                     & y_pitch [rad]                    \\
density_used [kg/m$^3$]          & ref_origin                       & x2_edge [m]                      & y_pitch_tot [rad]                \\
descrip                          & ref_time_start [sec]             & x2_limit [m]                     & z_offset [m]                     \\
e_tot [eV]                       & reference                        & x_limit [m]                      & z_offset_tot [m]                 \\
ele_origin                       & scatter                          & x_offset [m]                     &                                  \\
final_charge                     & spin_tracking_method             & x_offset_tot [m]                 &                                  \\
