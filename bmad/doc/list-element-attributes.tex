...
dx_origin [m]                    & offset [m]                       & reference                        &                                  \\
 ...
 \begin{tabular}{llll} \toprule
alias                            & delta_ref_time [sec]             & mode_flip_stored                 & spin_x_stored                    \\
alpha_a_stored                   & descrip                          & offset [m]                       & spin_y_stored                    \\
alpha_b_stored                   & deta_dpz_x_stored [m]            & p0c [eV]                         & spin_z_stored                    \\
beta_a_stored [m]                & deta_dpz_y_stored [m]            & phi_a_stored                     & superimpose                      \\
beta_b_stored [m]                & detap_dpz_x_stored               & phi_b_stored                     & tracking_method                  \\
cmat_11_stored                   & detap_dpz_y_stored               & ptc_integration_type             & type                             \\
cmat_12_stored [m]               & e_tot [eV]                       & px_stored                        & wrap_superimpose                 \\
cmat_21_stored [1/m]             & ele_origin                       & py_stored                        & x_stored [m]                     \\
cmat_22_stored                   & eta_x_stored [m]                 & pz_stored                        & y_stored [m]                     \\
dalpha_dpz_a_stored              & eta_y_stored [m]                 & ref_origin                       & z_stored [m]                     \\
dalpha_dpz_b_stored              & etap_x_stored                    & ref_time_start [sec]             &                                  \\
dbeta_dpz_a_stored [m]           & etap_y_stored                    & reference                        &                                  \\
dbeta_dpz_b_stored [m]           & mat6_calc_method                 & spin_tracking_method             &                                  \\
 \bottomrule
 \end{tabular}
 \vfill
