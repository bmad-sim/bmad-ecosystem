...
ele_origin                       & ref_time_start [sec]             & x1_limit [m]                     & z_offset [m]                     \\
 ...
 \begin{tabular}{llll} \toprule
alias                            & final_charge                     & reference                        & x_offset [m]                     \\
aperture [m]                     & is_on                            & spin_tracking_method             & x_offset_tot [m]                 \\
aperture_at                      & l [m]                            & superimpose                      & x_pitch [rad]                    \\
aperture_type                    & mat6_calc_method                 & thickness [m]                    & x_pitch_tot [rad]                \\
area_density [kg/m$^2$]          & material_type                    & tilt [rad]                       & y1_limit [m]                     \\
area_density_used [kg/m$^2$]     & offset [m]                       & tilt_tot [rad]                   & y2_limit [m]                     \\
create_jumbo_slave               & offset_moves_aperture            & tracking_method                  & y_limit [m]                      \\
delta_ref_time [sec]             & p0c [eV]                         & type                             & y_offset [m]                     \\
density [kg/m$^3$]               & ptc_integration_type             & wall                             & y_offset_tot [m]                 \\
density_used [kg/m$^3$]          & radiation_length [m]             & wrap_superimpose                 & y_pitch [rad]                    \\
descrip                          & radiation_length_used [m]        & x1_limit [m]                     & y_pitch_tot [rad]                \\
e_tot [eV]                       & ref_origin                       & x2_limit [m]                     & z_offset [m]                     \\
ele_origin                       & ref_time_start [sec]             & x_limit [m]                      & z_offset_tot [m]                 \\
 \bottomrule
 \end{tabular}
 \vfill
