...
crab_x3 [1/m$^2$]                & p0c [eV]                         & wall                             &                                  \\
 ...
 \begin{tabular}{llll} \toprule
alpha_a                          & dalpha_dpz_b                     & eta_y [m]                        & px_stored                        \\
alpha_a_stored                   & dalpha_dpz_b_stored              & eta_y_stored [m]                 & py_stored                        \\
alpha_b                          & dbeta_dpz_a [m]                  & eta_z [m]                        & pz_stored                        \\
alpha_b_stored                   & dbeta_dpz_a_stored [m]           & etap_x                           & ref_time [sec]                   \\
beta_a [m]                       & dbeta_dpz_b [m]                  & etap_x_stored                    & s [m]                            \\
beta_a_stored [m]                & dbeta_dpz_b_stored [m]           & etap_y                           & spin_dn_dpz_x                    \\
beta_b [m]                       & deta_dpz_x [m]                   & etap_y_stored                    & spin_dn_dpz_y                    \\
beta_b_stored [m]                & deta_dpz_x_stored [m]            & inherit_from_fork                & spin_dn_dpz_z                    \\
cmat_11                          & deta_dpz_y [m]                   & mode_flip                        & spin_x_stored                    \\
cmat_11_stored                   & deta_dpz_y_stored [m]            & mode_flip_stored                 & spin_y_stored                    \\
cmat_12 [m]                      & detap_dpz_x                      & p0c [eV]                         & spin_z_stored                    \\
cmat_12_stored [m]               & detap_dpz_x_stored               & p0c_start [eV]                   & theta_position [rad]             \\
cmat_21 [1/m]                    & detap_dpz_y                      & phi_a [rad]                      & x_position [m]                   \\
cmat_21_stored [1/m]             & detap_dpz_y_stored               & phi_a_stored                     & x_stored [m]                     \\
cmat_22                          & e_tot [eV]                       & phi_b [rad]                      & y_position [m]                   \\
cmat_22_stored                   & e_tot_start [eV]                 & phi_b_stored                     & y_stored [m]                     \\
dalpha_dpz_a                     & eta_x [m]                        & phi_position [rad]               & z_position [m]                   \\
dalpha_dpz_a_stored              & eta_x_stored [m]                 & psi_position [rad]               & z_stored [m]                     \\
 \bottomrule
 \end{tabular}
 \vfill
...
dx_origin [m]                    & offset [m]                       & reference                        &                                  \\
 ...
 \begin{tabular}{llll} \toprule
alias                            & delta_ref_time [sec]             & mat6_calc_method                 & spin_tracking_method             \\
alpha_a_stored                   & descrip                          & mode_flip_stored                 & spin_x_stored                    \\
alpha_b_stored                   & deta_dpz_x_stored [m]            & offset [m]                       & spin_y_stored                    \\
beta_a_stored [m]                & deta_dpz_y_stored [m]            & p0c [eV]                         & spin_z_stored                    \\
beta_b_stored [m]                & detap_dpz_x_stored               & phi_a_stored                     & superimpose                      \\
cmat_11_stored                   & detap_dpz_y_stored               & phi_b_stored                     & tracking_method                  \\
cmat_12_stored [m]               & e_tot [eV]                       & ptc_integration_type             & type                             \\
cmat_21_stored [1/m]             & ele_origin                       & px_stored                        & wrap_superimpose                 \\
cmat_22_stored                   & eta_x_stored [m]                 & py_stored                        & x_stored [m]                     \\
dalpha_dpz_a_stored              & eta_y_stored [m]                 & pz_stored                        & y_stored [m]                     \\
dalpha_dpz_b_stored              & etap_x_stored                    & ref_origin                       & z_stored [m]                     \\
dbeta_dpz_a_stored [m]           & etap_y_stored                    & ref_time_start [sec]             &                                  \\
dbeta_dpz_b_stored [m]           & is_on                            & reference                        &                                  \\
 \bottomrule
 \end{tabular}
 \vfill
