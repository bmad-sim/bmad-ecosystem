...
ele_origin                       & ref_time_start [sec]             & x1_limit [m]                     & z_offset [m]                     \\
 ...
 \begin{tabular}{llll} \toprule
alias                            & is_on                            & superimpose                      & x_offset_tot [m]                 \\
aperture [m]                     & l [m]                            & thickness [m]                    & x_pitch [rad]                    \\
aperture_at                      & mat6_calc_method                 & tilt [rad]                       & x_pitch_tot [rad]                \\
aperture_type                    & material_type                    & tilt_tot [rad]                   & y1_edge [m]                      \\
area_density [kg/m$^2$]          & offset [m]                       & tracking_method                  & y1_limit [m]                     \\
area_density_used [kg/m$^2$]     & offset_moves_aperture            & type                             & y2_edge [m]                      \\
create_jumbo_slave               & p0c [eV]                         & wall                             & y2_limit [m]                     \\
delta_ref_time [sec]             & ptc_integration_type             & wrap_superimpose                 & y_limit [m]                      \\
density [kg/m$^3$]               & radiation_length [m]             & x1_edge [m]                      & y_offset [m]                     \\
density_used [kg/m$^3$]          & radiation_length_used [m]        & x1_limit [m]                     & y_offset_tot [m]                 \\
descrip                          & ref_origin                       & x2_edge [m]                      & y_pitch [rad]                    \\
