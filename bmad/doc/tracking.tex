...
GPU kernels do not check apertures during tracking. Instead, after a bunch is tracked through an
element on the GPU, aperture limits are checked on the CPU at the element exit. This behavior
respects the \vn{bmad_com%aperture_limit_on} setting.
