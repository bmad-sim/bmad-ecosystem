...
type ele_struct
  ...
  type (gen_gradients_struct), pointer :: gen_gradients(:)       ! Used to define E/M fields.
...
\vn{ele%gen_gradients}, and \vn{ele%grid_field}. Since these components potentially contain large
...
\index{ele_struct!\%gen_gradients}
...
\begin{example}
  ...
  ele%gen_gradients(:)      ! Generalized gradient field model
...
\sref{s:ele.em.field}): \vn{%cartesian_map}, \vn{%cylindrical_map}, \vn{%gen_gradients}, or
