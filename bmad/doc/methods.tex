...
%                                      O   C   M  Spt SLP Trk TK
  ...
  \vn{ac_kicker}                     & X & X &   &   &   & D &   \\  
  \vn{beambeam}                      & X & X &   &   &   & D &   \\  
  \vn{bends: rbend and sbend}        & X & X &   & X & X & D &   \\ 
  \vn{converter}                     & X & X &   &   &   & D &   \\  
  \vn{crab_cavity}                   & X & X &   &   &   & D &   \\  
  \vn{custom}                        & X & D &   &   &   & X &   \\  
  \vn{drift}                         & X & X &   & X & X & D &   \\  
  ...
  \vn{hkicker}                       & X & X &   & X & X & D &   \\  
  \vn{instrument, monitor and pipe}  & X & X &   & X & X & D &   \\  
  \vn{kicker}                        & X & X &   & X & X & D &   \\  
  ...
  \vn{patch}                         & X & X &   &   & X & D &   \\ 
  \vn{quadrupole}                    & X & X &   & X & X & D &   \\ 
  \vn{sad_mult}                      & X & X &   &   &   & D &   \\  
  \vn{sextupole}                     & X & X &   & X & X & D &   \\ 
  \vn{solenoid}                      & X & X &   & X & X & D &   \\ 
  \vn{sol_quad}                      & X & X &   &   & X & D & X \\ 
  \vn{taylor}                        & X &   &   &   &   & D &   \\ 
  \vn{vkicker}                       & X & X &   & X & X & D &   \\ 
  \vn{wiggler}                       & X & X &   &   & X & D &   \\ 
  \bottomrule
\end{tabular}
}
