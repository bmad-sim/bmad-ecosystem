...
and, if K0L is set, an error message will be issued.\footnote
  {
One possibility that was considered was to simply treat \vn{K0L} as a kick without any change in reference orbit.
This was rejected since it could be confusing to compare MAD and \bmad computations with lattices that had
a finite \vn{K0L}.
  }
If a zero length kick element is needed, there
is always the \vn{kicker} element. 
