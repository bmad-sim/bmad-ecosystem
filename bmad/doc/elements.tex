...
{Foil geometry. Parameters \vn{thickness}, \vn{drel_thickness_dx}, \vn{x1_edge}, \vn{x2_edge},
...
The \vn{drel_thickness_dx} parameter can be used to get a varying foil thickness. 
The thickness $t$ at a point
$(x,y)$ on the foil (in element body coordinates) will be
\begin{equation}
...
\vn{drel_thickness_dx} parameter. To orient the wedge in the transverse plane, use the \vn{tilt} orientation parameter (\sref{s:offset}).
