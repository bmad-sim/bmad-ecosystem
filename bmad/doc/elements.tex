...
parameters in the output slaves. A feedback element could be used to, for example, simulate RF feedback
systems or beam position feedback.

NOTE! The \vn{feedback} element is currently under development and is not yet useable.
...
The \vn{drel_thickness_dx} can be used to get a varying foil thickness. The thickness $t$ at a point
