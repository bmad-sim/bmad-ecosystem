...
A \vn{fixer} element has zero length. For tracking particles, a \vn{fixer} element is like a \vn{marker}. That is, there is no change in phase space coordinates when a particle is tracked
