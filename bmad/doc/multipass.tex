...
bookkeeping routines. Assuming that the phase of \vn{RF1\B1} gives acceleration, to make the \vn{RF1\B2}
ele to decelerate, the \vn{phi0_multipass} attribute of \vn{RF1\B2} is set to 0.5. This is the one attribute
