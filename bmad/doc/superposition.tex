...
%-----------------------------------------------------------------------------
\section{Superposition Wrapping}
...
%-----------------------------------------------------------------------------
\section{Superposition of Zero Length Elements}
...
%-----------------------------------------------------------------------------
\section{Superposition and Drifts}
...
%-----------------------------------------------------------------------------
\section{Superposition and Element Reversal}
...
%-----------------------------------------------------------------------------
\section{Superposition Order}

Superpositions are done in the same order as the order in which the elements to be superimposed are
defined.  The superposition order typically does not affect the finished lattice but an effect can be
be seen when superpositions use reference elements that are themselves superimposed. An example will
make this clear:
\begin{example}
  A: quad, ...
  B: octupole, ...
  ...
  use, my_line
\end{example}
Here element \vn{A} is defined first (the order of definitions is not affected by element
modifications afterwards) and then \vn{B}. 

Since, when element \vn{A} is to be superimposed, there are no instances of \vn{B} in the expanded
lattice, and element \vn{A} uses \vn{B} as a reference, the finished lattice will not contain any
instances of \vn{A}. On the other hand, when element \vn{B} is to be superimposed, there is an
instance of element \vn{C} to be used as a reference, and so the finished lattice will contain an
instance of element \vn{B}.
