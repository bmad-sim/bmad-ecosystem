...
\index[routine]{gpu_tracking_cleanup}
\label{r:gpu.tracking.cleanup}
\item[gpu_tracking_cleanup ()] \Newline
Routine to release all cached GPU device memory. Optional but recommended to call at program
shutdown.
