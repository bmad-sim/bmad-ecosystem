...
%---------------------------------------------------------------------------------
\subsection{drift-kick model}

With \vn{bmad_standard} tracking, a drift-kick model is used where the particle trajectory is modeled
...
\begin{equation}
  H_\txt{fringe} = \mp \frac{q}{2 \, q_\txt{ref} \, P_0 \, c} G_t \, \cos(\phi_t + \phi_\REF) \, (x^2 + y^2)
\end{equation}
...
this Hamiltonian in energy-time phase space coordinates (\sref{energy.phase.space}) to give the
fringe kicks:
\begin{align}
  \Delta p_x &= \frac{\partial H_\txt{fringe}}{\partial x} 
              = \mp \frac{q}{q_\txt{ref} \, P_0 \, c} G_t \, \cos(\phi_t + \phi_\REF) \, x \CRNO
  \Delta p_y &= \frac{\partial H_\txt{fringe}}{\partial y} 
              = \mp\frac{q}{q_\txt{ref} \, P_0 \, c} G_t \, \cos(\phi_t + \phi_\REF) \, y \\
  \Delta p_\tau &= \frac{\partial H_\txt{fringe}}{\partial \tau} 
...
This transverse kick is
\begin{align}
  \Delta p_x &= -\frac{\kappa \, L}{N_s} \frac{1}{8 \cos^2(\phi)} \left( \frac{\gamma'}{\gamma} \right)^2 x \CRNO
  &= -\frac{q \, \kappa G_t}{q_\REF \, m \, c^2} \frac{1}{8}
\end{align}
...
To keep the ponderomotive force tracking symplectic, a Hamiltonian is used:
\begin{equation}
  H_p = (x^2 + y_2)
\end{equation}
Thus similar to the fringe kick, there is an associated energy kick due to the ponderomotive force. In energy-time
phase space coordinates this is:
\begin{align}
  \Delta p_x &= \CRNO
  \Delta p_x &= \\
  \Delta p_\tau &= \nonumber 
