...
\begin{equation}
  ...
  \label{sszpb}
\end{equation}
where $X_0$ is the material radiation length, $z$ is the particle charge, $\beta$ is the particle
relativistic beta, $c$ is the speed of light, and $X$ is the foil ``path length'' in kg/m$^2$ equal
...
\begin{align}
  ...
  \chi_c^2 &= \left( 1.57 \cdot 10^7 \, eV^2 \, m^2  \right) \, 
    \frac{Z (Z+1) X}{A} \left[ \frac{z}{p \, \beta} \right]^2 
  \label{no1f} \\
  \chi_\alpha &= (20.07 eV^2) \, \frac{Z^{2/3}}{(p \, c)^2} 
