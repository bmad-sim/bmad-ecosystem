...
!
! Private routine used by write_lattice_foreign_format and not for general use. 
! See write_lattice_foreign_format for details about the argument list.
!-

subroutine write_lattice_sad_format (out_file_name, lat, include_apertures, ix_branch, err)

use element_modeling_mod, dummy => write_lattice_sad_format
use write_lattice_file_mod, dummy2 => write_lattice_sad_format
...
character(*), parameter :: r_name = "write_lat_sad_format"
...
write (iu, '(3a)') '! File generated by: write_lattice_foreign_format'
...
end subroutine write_lattice_sad_format
