!+ 
! Subroutine write_lattice_mad_format (out_type, out_file_name, lat, ref_orbit, &
...
use mad_mod, dummy2 => write_lattice_mad_format
use bmad_routine_interface, dummy => write_lattice_mad_format
use write_lattice_file_mod, dummy3 => write_lattice_mad_format
...
character(*), parameter :: r_name = "write_lattice_mad_format"
...
end subroutine write_lattice_mad_format
