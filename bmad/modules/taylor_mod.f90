...
!----------------------------------------------------------------------------
!+
! Subroutine type_taylors (bmad_taylor, max_order, lines, n_lines, file_id, out_style, clean)
!
...
!                     For out_style = 'BMAD', Suggested length of lines 140 characters minimum.
...
integer i, j, k, n, ie, nl, ix, nt

logical, optional :: clean

character(*), optional :: out_style
character(*), optional, allocatable :: lines(:)
character(140), allocatable :: li(:)
