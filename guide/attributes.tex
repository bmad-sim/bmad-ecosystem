...
\vn{beam_energy}, \vn{n_part} and \vn{l_lattice} (lattice length) are
lattice atributes, not element attributes. The first two are set by
the \vn{parameter} statement (See
...
upon the value of the dependent variable.
\begin{table}[h]
\centering {
\begin{tabular}{|l|l|l|} \hline
...
\begin{example}
  s1: sextupole, l = 0.34                       ! symplecitfy = False
  s1: sextupole, symplectify = True, l = 0.34   ! symplecitfy = True
  s1: sextupole, symplectify, l = 0.34          ! symplecitfy = True
\end{example}
