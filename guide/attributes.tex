...
{\em Element}  & {\em Dependent Variables}  & {\em Independent Variables}  \\ \hline
  BeamBeam     & bbi\_const             & 
                                  charge, sig\_x, sig\_y, beam\_energy, n_part  \\ \hline
  ElSeparator  & e_field, volt          & hkick, vkick, gap, l, beam\_energy    \\ \hline
  LCavity      & e\_loss, delta\_e      & gradiant, l                           \\ \hline
  Rbend, Sbend & rho, angle, l\_cord    & g, l                                  \\ \hline
  RFCavity     & rf\_wavelength         & harmon, l\_lattice                    \\ \hline
...
\label{t:dependent}
\end{table}
\vn{bema_energy}, \vn{n_part} and \vn{l_lattice} (lattice length) are
lattice atributes. Not element attributes. The first two are set by
the \vn{parameter} statement (See Section~\ref{s:parameter}).

No attempt should be made to set or vary within a program a dependent
...
{\em Element}  & {\em Dependent Variable Set}  & {\em Independent Variables Not Set}  \\ \hline
  LCavity      & delta\_e                  & gradiant                           \\ \hline
...
\vn{quadrupole} is \vn{k1}.  It is sometimes convienient to be able to
...
\centering {
\begin{tabular}{|l|l|l|} \hline
  {\em Element} & {\em Strength Attribute} & {\em Field Attrubte} \\ \hline
  SBend         &   g                        b_field        \\ \hline
  Solenoid      &   ks                       b_field        \\ \hline
  Quadrupole    &   k1                       b_gradient     \\ \hline
  Sextupole     &   k2                       b_gradient     \\ \hline
  Octupole      &   k3                       b_gradient     \\ \hline
\end{example}
\end{tabular}
}
...
when printing element informatio. \vn{type}
