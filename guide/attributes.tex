...
\begin{example}
  beam_energy   ! Total energy in eV.
  p0c           ! Momentum in eV.
\end{example}
...
\begin{example}
  kick,  bl_kick    ! Used only with a Hkicker or Vkicker
  hkick, bl_hkick
  vkick  bl_vkick
\end{example}
...
\begin{example}
  x_limit      ! Horizontal limit
  y_limit      ! Vertical limit
  aperture     ! Alternative to specifying x_limit and y_limit
  aperture_at  ! What end aperture is at.
\end{example}
