...
\Begineq
  ...
  \label{zz121p}
\Endeq
Using the equtions of motion \Eqs{rshp} this can also be rewritten as
\Begineq
...
\Begineq
  m_{5jk} = - \frac{1}{2 (1 + p_z)^2} \int \! ds \, 
