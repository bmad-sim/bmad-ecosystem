...
%--------------------------------------------------------------------------
\section{Phase Space}
\label{s:etienne_space}
\indexptc{phase space}

PTC uses different longitudinal phase space coordinates compaired to \bmad.
...
\begin{example}
  type universal_taylor
    integer, pointer  :: n       ! Number of coeeficients
