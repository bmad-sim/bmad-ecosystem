...
The energy spread is given by
  \Begineq
    ...
    C_q \gamma^2 \frac{I_3}{2I_2 + I_{4z}}
  \Endeq
where
  \Begineq
...
for the storage ring. Finally the emittances are given by
  \Begineq
    \epsilon_a = C_q \, \gamma^2 \frac{I_{5a}}{I_2 - I_{4a}}
    \epsilon_b = C_q \, \gamma^2 \frac{I_{5b}}{I_2 - I_{4b}}
  \Endeq
...
to take account the changing energy in the line. $I_1$ is not altered
but the other integrals become
  \Begineqs
    L_2 &=& \oint ds \, G^2 \, \gamma^4 \\
    L_3 &=& \oint ds \, G^3 \, \gamma^7 \\
    L_{4a} &=& \oint ds \, \left[ G^2 \, \Bf G \cdot \bfeta\two_a + 
         \nabla G^2 \cdot \bfeta\two_a \right] \, \gamma^4 \\
    L_{4b} &=& \oint ds \, \left[ G^2 \, \Bf G \cdot \bfeta\two_b + 
         \nabla G^2 \cdot \bfeta\two_b \right] \, \gamma^4 \\
    L_{4z} &=& \oint ds \, \left[ G^2 \, \Bf G \cdot \bfeta\two + 
         \nabla G^2 \cdot \bfeta\two \right] \, \gamma^4 \\
    L_{5a} &=& \oint ds \, G^3 \, \calh_a \, \gamma^6 \\
    L_{5b} &=& \oint ds \, G^3 \, \calh_b \, \gamma^6
  \Endeqs
...
any dampling is
  \Begineq
    \sigma_E^2 = \frac{3}{2} \, C_q \, r_e \, \left( m c^2 \right)^2 \, L_3
  \Endeq
and, again neglecting any initial beam width, the transverse beam size
at the end of the linac is
  \Begineq
    \epsilon_a = \frac{3}{2} \, C_q \, r_e \, 
    \left( m c^2 \right)^2 \frac{L_{5a}}(E_f}
  \Endeq
Where $E_f$ is the final energy