...
\Begineq
  B_y(x,y) + i B_x(x,y) = 
                \frac{1}{n!} K_nL e^{-i(n+1)\phi_n} \, e^{i n \theta} \, r^n 
\Endeq
...
\end{equation}
{\cal M} is made up of 6 functions ${\cal M}_i$ mapping ${\cal R}^6
 \rightarrow {\cal R}$ Each of these functions can be expanded in a
Taylor series. The corresponding Taylor Map is the collection of the 6
Taylor series. 
