...
while the stochastic fuluctuating part produces excitation\cite{jowett}.
...
length, $\gamma_0$ is the energy factor of an on-energy particle, $g$
...
where
\Begineq
  k_f \equiv \sqrt{\frac{55 \, r_e \, \hbar \, c}{24 \, \sqrt{3} m_e} \, 
  L_p \, \gamma0^5 \ave{g^3}} \, \xi \, (1 + p_z)
\Endeq
