\chapter {Control Elements: Overlays and Groups}
...
\vn{Groups} are used to make variations in attributes. For example, to
...
selected quads in a specified manner. \vn{Overlays}, on the other hand, set
the value (not a change in) the attributes they control. A \vn{Group}
or \vn{Overlay} can control other \vn{Group} and \vn{Overlay}
elements. There is no limit to the number of levels of a control
hierarchy.
