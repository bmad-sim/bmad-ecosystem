...
$tex_hash{"plot_string"} =             "plot_mod.f90";
$tex_hash{"draw_plot_title"} =         "plot_mod.f90";
$tex_hash{"calc_axis_places"} =        "plot_mod.f90";
$tex_hash{"draw_string"} =             "plot_mod.f90";
$tex_hash{"draw_line"} =               "plot_mod.f90";
$tex_hash{"calc_graph_pixal_limits"} = "plot_mod.f90";
$tex_hash{"graph_clear"} =             "plot_mod.f90";
$tex_hash{"data_to_pix1"} =            "plot_mod.f90";
$tex_hash{"graph_set"} =               "plot_mod.f90";
$tex_hash{"set_plot_character"} =      "plot_mod.f90";
$tex_hash{"set_this_char_size"} =      "plot_mod.f90";
$tex_hash{"calc_axis_scale"} =         "plot_mod.f90";
$tex_hash{"plot_line"} =               "plot_mod.f90";
$tex_hash{"percent_to_pix"} =          "plot_mod.f90";
$tex_hash{"plot_y_axis"} =             "plot_mod.f90";
$tex_hash{"plot_data_point"} =         "plot_mod.f90";
$tex_hash{"plot_set"} =                "plot_mod.f90";
$tex_hash{"plot_graph"} =              "plot_mod.f90";
$tex_hash{"plot_x_axis"} =             "plot_mod.f90";
$tex_hash{"plot_histogram"} =          "plot_mod.f90";
$tex_hash{"margin_set"} =              "plot_mod.f90";
$tex_hash{"axis_set"} =                "plot_mod.f90";
$tex_hash{"set_symbol_line"} =         "plot_mod.f90";
$tex_hash{"subgraph_set"} =            "plot_mod.f90";
$tex_hash{"data_to_pix"} =             "plot_mod.f90";
$tex_hash{"plot_title"} =              "plot_mod.f90";
$tex_hash{"calc_axis_params"} =        "plot_mod.f90";
$tex_hash{"plot_plot_boundary"} =      "plot_mod.f90";
$tex_hash{"plot_arc"} =                "plot_mod.f90";
$tex_hash{"plot_legend"} =             "plot_mod.f90";
$tex_hash{"plot_box"} =                "plot_mod.f90";
$tex_hash{"page_border_set"} =         "plot_mod.f90";
