...
\vn{delta_e} attribute can be used in place of \vn{gradiant} in a
primary lattice file as discussed in Section~\ref{s:dependent}.
\begin{example}
...
\end{example}
This is consistant with MAD but not with LIAR which uses
\begin{example}
  dE = voltage * cos(twopi * (phi0 - z * rf_frequency / c_light))
\end{example}
