...
section \ref{s:fields} for more details.
...
\vn{BeamBeam} element. Note that in \mad\ the attributes use to
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  y\_offset  = Real            & \ref{s:offset} & is\_on             & \ref{s:is_on}  & field\_calc = Switch        & \ref{s:integ} \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  gap      = Real       &                & is\_on             & \ref{s:is_on}  & field\_calc = Switch        & \ref{s:integ} \\ \hline
...
orientation attributes (\vn{x_offset}, etc.) give the orientation of
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  e1       = Real      &                & h1                 &                & y\_offset  = Real           & \ref{s:offset} \\ \hline
  e2       = Real      &                & h2                 &                & s\_offset  = Real           & \ref{s:offset} \\ \hline
  ...
  \multicolumn{6}{l}{\small $^*$Dependent attribute. \DAG May be a dependent attribute. \DDAG Settable dependent attribute. See Chapter~\ref{c:attrib}} \\
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  b\_gradient\DAG = Real &                & descrip = String   & \ref{s:string} & integration\_ord = Integer  & \ref{s:integ} \\ \hline
  x\_offset  = Real      & \ref{s:offset} & is\_on             & \ref{s:is_on}  & field\_calc = Switch        & \ref{s:integ} \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  b\_field\DAG = Real   &                & is\_on             & \ref{s:is_on}  & field\_calc = Switch        & \ref{s:integ} \\ \hline
  x\_offset  = Real     & \ref{s:offset} & x\_limit = Real    & \ref{s:limit}  & rel\_tol = Real             & \ref{s:integ} \\ \hline
  y\_offset  = Real     & \ref{s:offset} & y\_limit = Real    & \ref{s:limit}  & abs\_tol = Real             & \ref{s:integ} \\ \hline
  s\_offset  = Real     & \ref{s:offset} & aperture = Real    & \ref{s:limit}  & num\_steps = Integer        & \ref{s:integ} \\ \hline
  x\_pitch = Real       & \ref{s:offset} & hkick    = Real    & \ref{s:kick}   & a$n$, b$n$ = Real           & \ref{s:fields}\\ \hline
