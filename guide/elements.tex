...
Unlike a \mad \vn{multipole}, An \vn{AB_Multipole} never affects the reference orbit
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  symplectify = Logical & \ref{s:symp}    &  x\_limit = Real              & \ref{s:limit}  & tilt = Real        &  \ref{s:offset}  \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  rel\_tol = Real       & \ref{s:tol}     &  descrip = String             & \ref{s:string} & s\_offset  = Real  & \ref{s:offset}  \\ \hline
  abs\_tol = Real       & \ref{s:tol}     &  mat6\_calc\_method = Switch  & \ref{s:method} & tilt = Real        & \ref{s:offset}  \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  gap      = Real       &                 & mat6\_calc\_method = Switch  & \ref{s:method} & x\_pitch = Real    & \ref{s:offset}  \\ \hline
                                          & tracking\_method = Switch    & \ref{s:method} & y\_pitch = Real    & \ref{s:offset}  \\ \hline
  rel\_tol = Real       & \ref{s:tol}     & x\_limit = Real              & \ref{s:limit}  & tilt     = Real    & \ref{s:offset}  \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  tilt     = Real       & \ref{s:offset}  & descrip = String             & \ref{s:string} & aperture = Real       & \ref{s:limit}  \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  tilt     = Real       & \ref{s:offset}  & mat6\_calc\_method = Switch  & \ref{s:method} & rel\_tol = Real       & \ref{s:tol}    \\ \hline 
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  gradient      = Real  &                 & descrip = String             & \ref{s:string} & s\_offset  = Real  & \ref{s:offset}  \\ \hline
  phi0          = Real  &                 & mat6\_calc\_method = Switch  & \ref{s:method} & x\_pitch = Real    & \ref{s:offset}  \\ \hline
  e\_loss       = Real  &                 & tracking\_method = Switch    & \ref{s:method} & y\_pitch = Real    & \ref{s:offset}  \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  b\_gradient = Real    &                 & descrip = String             & \ref{s:string} & s\_offset  = Real  & \ref{s:offset}  \\ \hline
  hkick    = Real       & \ref{s:kick}    & mat6\_calc\_method = Switch  & \ref{s:method} & x\_pitch = Real    & \ref{s:offset}  \\ \hline
  vkick    = Real       & \ref{s:kick}    & tracking\_method = Switch    & \ref{s:method} & y\_pitch = Real    & \ref{s:offset}  \\ \hline
  rel\_tol = Real       & \ref{s:tol}     & x\_limit = Real              & \ref{s:limit}  & tilt     = Real    & \ref{s:offset}  \\ \hline
  abs\_tol = Real       & \ref{s:tol}     & y\_limit = Real              & \ref{s:limit}  & is\_on             & \ref{s:is_on}   \\ \hline
  num\_steps = Integer  & \ref{s:tol}     & aperture = Real              & \ref{s:limit}  & a$n$, b$n$         & \ref{s:ab}      \\ \hline
  symplectify = Logical & \ref{s:symp}    & integration\_ord = Integer   & \ref{s:int}    & radius             & \ref{s:ab}      \\ \hline
\end{tabular}
}
\end{table}
...
A \vn{Patch} offsets the reference orbit. This is a generalization 
of \mad's \vn{yrot} and \vn{srot} elements.
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  x\_pitch   = Real  &                &  mat6\_calc\_method = Switch  & \ref{s:xfer}   & is\_on = Logical & \ref{s:is_on} \\ \hline
  y\_pitch   = Real  &                &  tracking\_method = Switch    & \ref{s:tm}     &                  &               \\ \hline
  de\_offset = Real  &                &  tilt = Real                  & \ref{s:offset} &                  &               \\ \hline            
\end{tabular}
}
\end{table}
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  ...
  vkick    = Real       & \ref{s:kick}   & tracking\_method = Switch    & \ref{s:method} & y\_pitch = Real    & \ref{s:offset}  \\ \hline
  rel\_tol = Real       & \ref{s:tol}    & x\_limit = Real              & \ref{s:limit}  & tilt     = Real    & \ref{s:offset}  \\ \hline
  abx\_tol = Real       & \ref{s:tol}    & y\_limit = Real              & \ref{s:limit}  & is\_on             & \ref{s:is_on}   \\ \hline
  num\_steps = Integer  & \ref{s:tol}    & aperture = Real              & \ref{s:limit}  & a$n$, b$n$         & \ref{s:ab}      \\ \hline
  symplectify = Logical & \ref{s:symp}   & integration\_ord = Integer   & \ref{s:int}    & radius             & \ref{s:ab}      \\ \hline
\end{tabular}
}
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  {\sl Attribute} & {\sl Sec.}  & {\sl Attribute} & {\sl Sec.} & {\sl Attribute} & {\sl Sec.} \\ \hline
  l        = Real       & \ref{s:l}       & type = String                & \ref{s:string} & x\_offset  = Real  & \ref{s:offset}      \\ \hline
  l\_chord = Real       & \ref{s:l}       & alias = String               & \ref{s:string} & y\_offset  = Real  & \ref{s:offset}      \\ \hline
  g        = Real       &                 & descrip = String             & \ref{s:string} & s\_offset  = Real  & \ref{s:offset}      \\ \hline
  delta\_g = Real       &                 & mat6\_calc\_method = Switch  & \ref{s:method} & x\_pitch = Real    & \ref{s:offset}      \\ \hline
  e1       = Real       &                 & tracking\_method = Switch    & \ref{s:method} & y\_pitch = Real    & \ref{s:offset}      \\ \hline
  e2       = Real       &                 & x\_limit = Real              & \ref{s:limit}  & integration\_ord = Integer & \ref{s:int} \\ \hline
  b\_field = Real       &                 & y\_limit = Real              & \ref{s:limit}  & is\_on             & \ref{s:is_on}       \\ \hline
  rho      = Real       &                 & aperture = Real              & \ref{s:limit}  & a$n$, b$n$         & \ref{s:ab}          \\ \hline
  angle    = Real       &                 & symplectify = Logical        & \ref{s:symp}   & radius             & \ref{s:ab}          \\ \hline
  tilt     = Real       & \ref{s:offset}  & hkick    = Real              & \ref{s:kick}   & rel\_tol = Real    & \ref{s:tol}         \\ \hline
  roll     = Real       & \ref{s:offset}  & vkick    = Real              & \ref{s:kick}   & abs\_tol = Real    & \ref{s:tol}         \\ \hline
  k1       = Real       &                 & fint     = Real              &                & num\_steps = Integer& \ref{s:tol}        \\ \hline
  hgap     = Real       &                 & fintx    = Real              &                &                     &                    \\ \hline
  hgapx    = Real       &                 & fintx    = Real              &                &                     &                    \\ \hline
\end{tabular}
}
\end{table}
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  {\sl Attribute} & {\sl Sec.}  & {\sl Attribute} & {\sl Sec.} & {\sl Attribute} & {\sl Sec.} \\ \hline
  l        = Real       & \ref{s:l}       & type = String                & \ref{s:string} & x\_offset  = Real  & \ref{s:offset}  \\ \hline
  harmon   = Real       &                 & alias = String               & \ref{s:string} & y\_offset  = Real  & \ref{s:offset}  \\ \hline
  volt     = Real       &                 & descrip = String             & \ref{s:string} & s\_offset  = Real  & \ref{s:offset}  \\ \hline
  phi0          = Real  &                 & mat6\_calc\_method = Switch  & \ref{s:method} & x\_pitch = Real    & \ref{s:offset}  \\ \hline
  hkick         = Real  & \ref{s:kick}    & tracking\_method = Switch    & \ref{s:method} & y\_pitch = Real    & \ref{s:offset}  \\ \hline
  vkick         = Real  & \ref{s:kick}    & x\_limit = Real              & \ref{s:limit}  & is\_on             & \ref{s:is_on}   \\ \hline
  num\_steps = Integer  & \ref{s:tol}     & y\_limit = Real              & \ref{s:limit}  & integration\_ord = Integer & \ref{s:int} \\ \hline
  rel\_tol = Real       & \ref{s:tol}     & aperture = Real              & \ref{s:limit}  &                            &         \\ \hline
  abs\_tol = Real       & \ref{s:tol}     & symplectify = Logical        & \ref{s:symp}   &                         &            \\ \hline
\end{tabular}
}
\end{table}
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  {\sl Attribute} & {\sl Sec.}  & {\sl Attribute} & {\sl Sec.} & {\sl Attribute} & {\sl Sec.} \\ \hline
  \{out: coef, e1 e2 e3 e4 e5 e6 \} &     &  x\_limit = Real        & \ref{s:limit} \\ \hline  
                        &                 &  alias = String               & \ref{s:string} & y\_limit = Real        & \ref{s:limit} \\ \hline
  rel\_tol = Real       & \ref{s:tol}     &  descrip = String             & \ref{s:string} & aperture = Real        & \ref{s:limit} \\ \hline
  abs\_tol = Real       & \ref{s:tol}     &  mat6\_calc\_method = Switch  & \ref{s:method} & symplectify = Logical  & \ref{s:symp}  \\ \hline
  num\_steps = Integer  & \ref{s:tol}     &  tracking\_method = Switch    & \ref{s:method} & is\_on = Logical       & \ref{s:is_on} \\ \hline
...
\begin{tabular}{|l|l||l|l||l|l|} \hline
  {\sl Attribute} & {\sl Sec.}  & {\sl Attribute} & {\sl Sec.} & {\sl Attribute} & {\sl Sec.} \\ \hline
  l        = Real       & \ref{s:l}       & type = String                & \ref{s:string} & x\_offset  = Real  & \ref{s:offset}   \\ \hline
  b\_max   = Real       &                 & alias = String               & \ref{s:string} & y\_offset  = Real  & \ref{s:offset}   \\ \hline
  n\_pole  = Real       &                 & descrip = String             & \ref{s:string} & s\_offset  = Real  & \ref{s:offset}   \\ \hline
                        &                 & mat6\_calc\_method = Switch  & \ref{s:method} & x\_pitch = Real    & \ref{s:offset}   \\ \hline
  polarity = Real       &                 & tracking\_method = Switch    & \ref{s:method} & y\_pitch = Real    & \ref{s:offset}   \\ \hline
  term(i) = \{coef, kx, ky, kz, phi\_z\} && x\_limit = Real              & \ref{s:limit}  & tilt     = Real    & \ref{s:offset}   \\ \hline
  integration\_ord = Integer & \ref{s:int} & y\_limit = Real              & \ref{s:limit}  & is\_on             & \ref{s:is_on}   \\ \hline
  rel\_tol = Real       & \ref{s:tol}     & aperture = Real              & \ref{s:limit}  & a$n$, b$n$         & \ref{s:ab}       \\ \hline
  abs\_tol = Real       & \ref{s:tol}     & hkick    = Real              & \ref{s:kick}   & radius             & \ref{s:ab}       \\ \hline
  num\_steps = Integer  & \ref{s:tol}     & vkick    = Real              & \ref{s:kick}   & symplectify = Logical & \ref{s:symp}  \\ \hline
\end{tabular}
}
\end{table}
