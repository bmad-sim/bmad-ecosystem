...
\vn{END_SECTION} marking the division between sections.  Wakes can be
specified via a table of wake versus longitudinal position $z$ and/or
using a set of ``pseudo'' modes (\sref{s:wakefields}). The first
...
maximum longitudinal distance \vn{z_sr2_max} over which the pseudo
modes are valid.
