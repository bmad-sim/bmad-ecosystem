...
\begin{tabular}{|l|l||l|l|} \hline
  ...
  BeamBeam        & \ref{s:bbi}       &  Null\_Ele    & \ref{s:null_ele} \HH
  Bend\_Sol\_Quad & \ref{s:bsq}       &  Octupole     & \ref{s:oct}      \HH
  ...
  I\_Beam         & \ref{s:i_beam}    &  Sextupole    & \ref{s:sex}      \HH
  Instrument      & \ref{s:monitor}   &  Solenoid     & \ref{s:sol}      \HH
  Kicker          & \ref{s:kicker}    &  Sol\_Quad    & \ref{s:sq}       \HH
...
\index{G}\index{B_field}\index{g_err}\index{Angle}
