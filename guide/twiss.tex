...
Once the
starting Twiss parameters are set, \vnr{twiss_propagate_all} can be used
to propagate the Twiss parameters to the rest of the elements
\begin{example}
...
This routine multiplies the transfer matricies of the elments together to form
