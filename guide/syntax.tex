...
\end{example}
One point that is not covered in the documentation is that \vn{beam} and 
...
\begin{example}
  ...
  use, this_beta
\end{example}
Another point is that for a \vn{MATRIX} element, unlike MAD, the
...
\vn{bmad_standard}). The name ``method'' is used interchangeable with switch.
