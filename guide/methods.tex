...
\vni{Boris} and \vni{Runge_Kutta} methods integrate the equations of
...
is applicable to \vn{Boris}, \vni{Symp_Lie_Bmad}, and
...
step. It turns out that for wigglers, after adjusting \vn{num_steps}
...
independent of the setting of \vn{integration_order}.
