...
an element's \vn{tracking_method} and \vn{mat6_calc_method} attributes 
...
\bmad\ routine. \vn{Symp_Lie_Bmad} is about a factor of 10 faster 
then \vn{Symp_Lie_PTC}. However, \vn{Symp_lie_Bmad} is
...
\vn{integration_ord} = n where $n$ is allowed by Etienne's PTC software
