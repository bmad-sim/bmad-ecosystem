...
\vn{dcslib} library which comes with the CESR distribution. A quick
...
\vn{qp_set_symbol_attrib} and \vn{qp_set_line_attrib} on lines 44 and
...
affecting other plots the routines \vn{qp_save_state} and
\vn{qp_restore_state} on lines 43 and 47 are used. \vn{qp_save_state}
...
The second part speifies the reference object
\begin{example}
...
this is in lines 44 and 45 of Figrue~\ref{f:plot_example}. The
