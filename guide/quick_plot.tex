...
\vn{qp_open_page} determines the size of the \vn{page} if it is
...
edges of the page are set by \vn{qp_set_page_border}.  The box that
the graph falls into is set by \vn{qp_set_box}. The default is to have
no margins with 1 box covering the entire page. The \vn{qp_set_margin}
