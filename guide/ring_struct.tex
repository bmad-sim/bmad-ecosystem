...
type ring_struct
  ...
  type (coord_struct) bunch_start  ! Starting coordinates.
...
%----------------------------------------------------------------------------
\section{Param\_struct Component}
\index{Param_struct}

The \vn{%param} component within the \vn{ring_struct} is a
...
%----------------------------------------------------------------------------
\section{Bunch\_start Component}
\label{s:ring_bunch_start}

The \vn{%bunch_start} component within the \vn{ring_struct} is a
\vn{coord_struct} structure for holding the information obtained from
\vn{bunch_start} statements (\sref{s:bunch_start}) in a \bmad lattice
file. 
