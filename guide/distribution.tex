...
The five subsidiary libraries are: \vn{cesr_utils}, \vn{forest},
\vn{numerical_recipes}, \vn{pgplot}, and \vn{dcslib}.
\begin{description}
...
definitions will not be printed. The \vn{listf} command is useful if you
...
\vn{_struct} are inevitably part of Etienne's PTC package.
