...
\begin{Itemize}
\item 
\vnec{Group} lord elements are used to make variations in attributes. For example, to
...
\item
An \vnec{Overlay} lord is like a \vn{group} except that \vn{overlays}
...
\item
\vnec{I_Beam} elements mimic the effect of a support girder. This is
