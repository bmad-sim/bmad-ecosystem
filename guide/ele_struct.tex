...
%--------------------------------------------------------------------------
\section{Control\_type}
\index{control_type}
\label{s:control_type}

In a \vn{ring_struct} (\sref{c:ring_struct}), elements in the lattice
...
\item{multipass\_lord, multipass\_slave}
