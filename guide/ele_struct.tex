...
when \vn{make_mat6} is called to make transfer matrices.  Remember
that in general routines are allowed to assume that the dependent
variables are consistent with the independent variables. Thus if you
do not remake that transfer matrices after changing attribute values
you need to call \vn{attribute_bookkeeper}. \vn{getf
attribute_bookkeeper} will give you a list of dependent variables.
