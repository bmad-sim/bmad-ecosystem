...
the lattice and puts the infomation into the \vn{ring} variable. The
...
\vn{ring%ele_(n)} where \vn{n = ring%n_ele_ring}. The \vn{CLEO_SOL} element 
is put in the section of \vn{ring%ele_(n)} with \vn{n >
ring%n_ele_ring} since it is not an element to be tracked through. The
