...
\vn{test.f90}. \vn{test.f90} is in the \vn{bmad} code area in a
directory called \vn{bmad/simple_program}
...
Compiling and linking the program useing the \vn{gmake} command
(\sref{s:compile}) the executables are to be found at
\vn{../../bin/simple_program} and \vn{../../bin/simple_program_g}. 
