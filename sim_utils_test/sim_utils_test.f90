...
write (1, '(a, 3es10.2)') '"dRot0" ABS 1E-14 ', matmul(w_mat, vec3) - rotate_vec_given_quat(vec3, quat)
...
call axis_angle_to_w_mat(axis, angle, w_mat)
quat = w_mat_to_quat(w_mat)
write (1, '(a, 3es10.2)') '"dRot1" ABS 1E-14 ', matmul(w_mat, vec3) - rotate_vec_given_quat(vec3, quat)
...
call axis_angle_to_w_mat(axis, angle, w_mat)
quat = w_mat_to_quat(w_mat)
write (1, '(a, 3es10.2)') '"dRot2" ABS 1E-14 ', matmul(w_mat, vec3) - rotate_vec_given_quat(vec3, quat)
...
call axis_angle_to_w_mat(axis, angle, w_mat)
quat = w_mat_to_quat(w_mat)
write (1, '(a, 3es10.2)') '"dRot3" ABS 1E-14 ', matmul(w_mat, vec3) - rotate_vec_given_quat(vec3, quat)
