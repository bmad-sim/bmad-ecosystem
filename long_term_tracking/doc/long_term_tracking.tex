...
\vn{ltt%particle_output_every_n_turns} turns. See Section~\sref{s:part.out} for more details. 

If \vn{ltt%action_angle_output_file} is blank, no particle output file is created. See also the
parameter \vn{ltt%beam_binary_output_file} which will produce a portable binary file. Also see
...
pc, e_tot   -- Particle momentum and total energy
