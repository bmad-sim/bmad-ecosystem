...
If not blank, the program will read in the 1-turn map from \vn{input_map_file}. Also
see \vn{output_map_file}. The default value of \vn{input_map_file} is blank.
%
...
If not blank , the program will save the 1-turn map in \vn{output_map_file}. The saved map will be affected
by the setting of \vn{bmad_com%radiation_damping_on}. See \sref{s:track.modes} for more details.
The default value of \vn{output_map_file} is blank. Also see \vn{input_map_file}.
%
