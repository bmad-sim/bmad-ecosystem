...
\author{}
\date{David Sagan \\ December 3, 2022}
...
Ramper elements can be used to simulate noise. For example, RF phase noise or ground motion. The way to
do this is to use the \vn{gauss_ran()} or \vn{ran()} functions withing a slave control expression.
