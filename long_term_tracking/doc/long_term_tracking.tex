...
element. Restriction: Only those ramper elements that have \vn{time} as the first variable will be
used. See the Bmad manual for documentation on \vn{ramper} syntax.
...
occurs over many turns, calculating once per beam passage should be a good apporoximation.
...
\begin{code}
ltt%particle_output_file = "some-nonblank-name" 
ltt%particle_output_every_n_turns = 1
\end{code}
Use your favorate plotting program to plot the phase space trajectory. This will give a lot of information. For
