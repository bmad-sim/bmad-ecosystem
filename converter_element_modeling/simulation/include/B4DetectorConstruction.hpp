...
{
  public:
    B4DetectorConstruction(const std::string& target_material, double target_thickness);
    B4DetectorConstruction(const B4DetectorConstruction&) = default;
    B4DetectorConstruction& operator=(const B4DetectorConstruction&) = default;
