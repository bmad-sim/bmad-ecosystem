...
{
public:
  B4PrimaryGeneratorAction(double in_particle_energy);
  B4PrimaryGeneratorAction(const B4PrimaryGeneratorAction&) = default;
  B4PrimaryGeneratorAction& operator=(const B4PrimaryGeneratorAction&) = default;
