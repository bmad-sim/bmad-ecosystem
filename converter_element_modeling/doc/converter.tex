...
running on Linux.  You will also need \texttt{cmake} installed. Since \texttt{cmake} is a
requirement for a standard \bmad distribution, chances are that \texttt{cmake} is already present.
