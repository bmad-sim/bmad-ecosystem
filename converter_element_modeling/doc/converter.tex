...
The polarization of the incoming particles may be specified with \texttt{polarization_in}.
The incoming polarization should be given as a three component vector in the format \texttt{Sx, Sy, Sz}.
