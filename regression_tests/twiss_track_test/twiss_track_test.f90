...
call data_out (ele1%a%deta_ds - ele0%a%deta_ds, 1.0d-6, 'Dif:Etap_X')
call data_out (ele1%b%deta_ds - ele0%b%deta_ds, 1.0d-6, 'Dif:Etap_Y')
...
call data_out (ele%a%deta_ds,        1.0D-06, 'Lat1:Deta_a_Ds')
call data_out (ele%x%eta,            1.0D-06, 'Lat1:Eta_x')
call data_out (ele%x%etap,           1.0D-06, 'Lat1:Etap_x')
call data_out (ele%x%deta_ds,        1.0D-06, 'Lat1:Deta_x_Ds')
...
call data_out (ele%b%etap,           1.0D-06, 'Lat1:Etap_b')
call data_out (ele%b%deta_ds,        1.0D-06, 'Lat1:Deta_b_Ds')
call data_out (ele%y%eta,            1.0D-06, 'Lat1:Eta_y')
call data_out (ele%y%etap,           1.0D-06, 'Lat1:Etap_y')
call data_out (ele%y%deta_ds,        1.0D-06, 'Lat1:Deta_y_Ds')
...
call data_out (ele%a%deta_ds,        1.0D-05, 'Lat2:Deta_a_Ds')
call data_out (ele%x%eta,            1.0D-05, 'Lat2:Eta_x')
call data_out (ele%x%etap,           1.0D-05, 'Lat2:Etap_x')
call data_out (ele%x%deta_ds,        1.0D-05, 'Lat2:Deta_x_Ds')
...
call data_out (ele%b%deta_ds,        1.0D-05, 'Lat2:Deta_b_Ds')
call data_out (ele%y%eta,            1.0D-05, 'Lat2:Eta_y')
call data_out (ele%y%etap,           1.0D-05, 'Lat2:Etap_y')
call data_out (ele%y%deta_ds,        1.0D-05, 'Lat2:Deta_y_Ds')
