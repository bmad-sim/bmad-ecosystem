...
type (ele_struct), pointer :: ele_mode, ele_tab
type (bunch_struct), target :: bunch_mode, bunch_tab
type (coord_struct), pointer :: p

real(rp) :: zlist(5), p0c, q, dpz_mode(5), dpz_tab(5), diff(5)
integer :: i, n, nargs
...
print '(a)', ' '
print '(a)', '   i     z [m]        pseudomode dpz       z_long dpz          diff'
do i = 1, n
  print '(i4, es14.6, 3es20.10)', i, zlist(i), dpz_mode(i), dpz_tab(i), diff(i)
enddo
