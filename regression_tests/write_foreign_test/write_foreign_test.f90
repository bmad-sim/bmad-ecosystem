...
call write_lattice_foreign_format ('MAD-8', 'mad8.now', lat)
call write_lattice_foreign_format ('MAD-X', 'madx.now', lat)
call write_lattice_foreign_format ('SAD', 'sad.now', lat)
call write_lattice_foreign_format ('ELEGANT', 'lte.now', lat)
call write_lattice_foreign_format ('SCIBMAD', 'scibmad.now', lat)
call write_lattice_foreign_format ('PALS', 'pals.now', lat)
...
!call write_lattice_foreign_format ('OPAL-T', out_file, lat)
