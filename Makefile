...
#-----------------------------------------------------------------------------
LIB_SRC_DIRS := code
OBJ_SRC_DIRS := ring_ma test dynamic_aperture analyzer tune_plane_res_plot synrad synrad3d bbu plot_freq_map plot_sb_scan tune_scan plot_da find_quads ilc_lattice_list
CONFIG_DIRS  :=
LOCAL_INCS   := synrad3d
SRC_EXCLUDE  :=
