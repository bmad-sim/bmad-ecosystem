...
Refering to Figure~\ref{f:bend.exact}, at point 1 where the particle enters a sector bend, the angle
...
\end{equation}
where $\atantwo(y, x)$ is the standard two argument arctan function.
...
default), the field in a cavity is modeled by
\begin{align}
  E_z    &=           2 \, G \,      \sin(k \, s) \, \sin(\omega \, t + 2 \, \pi \, \phi_\text{ref}) \CRNO
  E_r    &=               -G \, k \, \cos(k \, s) \, \sin(\omega \, t + 2 \, \pi \, \phi_\text{ref}) \\
  B_\phi &= \frac{1}{c} \, G \, k \, \sin(k \, s) \, \cos(\omega \, t + 2 \, \pi \, \phi_\text{ref}) \nonumber
\end{align}
and with \vn{lognitudinal_mode} set to 1:
\begin{align}
  E_z    &=            2 \, G \,      \cos(k \, s) \, \cos(\omega \, t + 2 \, \pi \, \phi_\text{ref}) \CRNO
  E_r    &=            r \, G \, k \, \sin(k \, s) \, \cos(\omega \, t + 2 \, \pi \, \phi_\text{ref}) \\
  B_\phi &= -\frac{r}{c} \, G \, k \, \cos(k \, s) \, \sin(\omega \, t + 2 \, \pi \, \phi_\text{ref}) \nonumber
\end{align}

With \vn{cavity_type} set to \vn{standing_wave}, the field is given by
\begin{align}
  \theta &= \omega \, t - k \, s + 2 \, \pi \, \phi_\text{ref} \CRNO
  E_z    &=                      G \,      \cos(\theta) \CRNO
  E_r    &= -\frac{r}{2}      \, G \, k \, \sin(\theta) \\
  B_\phi &= -\frac{r}{2 \, c} \, G \, k \, \sin(\theta) \nonumber
\end{align}
...
Assuming cylindrical symmetry, the radial and asimuthal fields near the axis 
...
\end{align}
The integrated fields at the exit end are the negative of these quantities.
