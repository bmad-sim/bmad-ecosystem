...
Bmad includes precalculated first-order spin transfer quaternions for simple lattice elements. This
method is much faster than PTC integration, and its runtime does not increase proportionally to
element length. Currently, the supported lattice elements are bends (including bends with $k_1 \neq
0$), quadrupoles, and solenoids.
