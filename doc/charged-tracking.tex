...
The vector potential for the \vn{hyper-y} form of the \vn{x} \vn{family} is
\begin{alignat}{4}
  A_x &=  &C &\dfrac{k_z}{k_y^2}      & \sin(\kxx) \, \sinh(\kyy) \, \sin(\kzz) \CRNO
  A_y &=  &0 && \label{bf1} \\
  A_s &=  &C &\dfrac{k_x}{k_y^2}      & \cos(\kxx) \, \sinh(\kyy) \, \cos(\kzz) \nonumber
\end{alignat}
The vector potential for the \vn{hyper-xy} form of the \vn{x} \vn{family} is
\begin{alignat}{4}
  A_x &=  &C &\dfrac{1}{k_y}          & \sinh(\kxx) \, \sinh(\kyy) \, \sin(\kzz) \CRNO
  A_y &=  &0 && \label{bf3} \\
  A_s &=  &C &\dfrac{k_x}{k_y \, k_z} & \cosh(\kxx) \, \sinh(\kyy) \, \cos(\kzz) \nonumber
\end{alignat}
The vector potential for the \vn{hyper-x} form of the \vn{x} \vn{family} is
\begin{alignat}{4}
...
The vector potential for the \vn{hyper-y} form of the \vn{y} \vn{family} is
\begin{alignat}{4}
  A_x &=  &0 &&\CRNO
  A_y &= -&C &\dfrac{k_z}{k_x \, k_y} & \sin(\kxx) \, \sinh(\kyy) \, \sin(\kzz) \label{bf2} \\
  A_s &= -&C &\dfrac{1}{k_x}          & \sin(\kxx) \, \cosh(\kyy) \, \cos(\kzz) \nonumber
\end{alignat}
The vector potential for the \vn{hyper-xy} form of the \vn{y} \vn{family} is
\begin{alignat}{4}
  A_x &=  &0 &&\CRNO
  A_y &= -&C &\dfrac{1}{k_x}          & \sinh(\kxx) \, \sinh(\kyy) \, \sin(\kzz) \label{bf4} \\
  A_s &= -&C &\dfrac{k_y}{k_x \, k_z} & \sinh(\kxx) \, \cosh(\kyy) \, \cos(\kzz) \nonumber
\end{alignat}
The vector potential for the \vn{hyper-x} form of the \vn{y} \vn{family} is
\begin{alignat}{4}
  A_x &=  &0 &&\CRNO
