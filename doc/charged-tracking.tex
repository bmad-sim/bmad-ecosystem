...
\begin{alignat}{4}
  a_y &= -&C &\dfrac{k_z}{k_x \, k_y} & \sin(\kxx) \sinh(\kyy) \sin(\kzz) \label{af1} \CRNO
  a_s &= -&C &\dfrac{1}{k_x}          & \sin(\kxx) \cosh(\kyy) \cos(\kzz) 
\end{alignat}
The second form (cf.~\Eq{f2})
\begin{alignat}{4}
  a_y &= -&C &\dfrac{k_z}{k_x \, k_y} & \sinh(\kxx) \sinh(\kyy) \sin(\kzz) \label{af2} \CRNO
  a_s &= -&C &\dfrac{1}{k_x}          & \sinh(\kxx) \cosh(\kyy) \cos(\kzz) 
\end{alignat}
The third form (cf.~\Eq{f3})
\begin{alignat}{4}
  a_y &= -&C &\dfrac{k_z}{k_x \, k_y} & \sinh(\kxx) \sin(\kyy) \sin(\kzz) \label{af3} \CRNO
  a_s &= -&C &\dfrac{1}{k_x}          & \sinh(\kxx) \cos(\kyy) \cos(\kzz) 
\end{alignat}
