...
\begin{alignat}{4}
  A_y &= -&\wt C &\dfrac{k_z}{k_x \, k_y} & \sin(\kxx) \sinh(\kyy) \sin(\kzz) \label{bf1} \CRNO
  A_s &= -&\wt C &\dfrac{1}{k_x}          & \sin(\kxx) \cosh(\kyy) \cos(\kzz) 
\end{alignat}
The old style second form (cf.~\Eq{f2})
\begin{alignat}{4}
  A_y &= -&\wt C &\dfrac{k_z}{k_x \, k_y} & \sinh(\kxx) \sinh(\kyy) \sin(\kzz) \label{bf2} \CRNO
  A_s &= -&\wt C &\dfrac{1}{k_x}          & \sinh(\kxx) \cosh(\kyy) \cos(\kzz) 
\end{alignat}
The old style third form (cf.~\Eq{f3})
\begin{alignat}{4}
  A_y &= -&\wt C &\dfrac{k_z}{k_x \, k_y} & \sinh(\kxx) \sin(\kyy) \sin(\kzz) \label{bf3} \CRNO
