...
%---------------------------------------------------------------------------------
%---------------------------------------------------------------------------------
\section{Multipole (Non-Bend) Fringe Fields}
...
In many cases, this is a good enough approximation. 

%---------------------------------------------------------------------------------
\subsection{Multipole Hard Edge Fringe Map}

The multipole hard edge fringe field is modeled using the method shown in
Forest\cite{b:forest}. For the $m$\th order multipole the Lee transform 
is (Forest Eq.~(13.29):
\begin{align}
...
\begin{align}
  ...
  g_2 &= K_1 \, \text{fq2}
\end{align}
where $K_1$ is the quadrupole strength, and \vn{fq1} and \vn{fq2} are the fringe
