...
\end{alignat}
For the \vn{hyper-y} form group with \vn{plane} set to \vn{y} the vector potential is: 
\begin{alignat}{4}
  A_x &=  &0 &&\CRNO
...
\end{alignat}
For the \vn{hyper-xy} form group with \vn{plane} set to \vn{y} the vector potential is: 
\begin{alignat}{4}
  A_x &=  &0 &&\CRNO
...
\end{alignat}
For the \vn{hyper-x} form group with \vn{plane} set to \vn{y} the vector potential is: 
\begin{alignat}{4}
  A_x &=  &0 &&\CRNO
