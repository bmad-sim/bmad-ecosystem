...
\end{example}
\item[ele:param] \Newline\begin{example}
Element parameter
...
\end{example}
\item[lat_branch_list] \Newline\begin{example}
Lattice branch list
...
\end{example}
\item[ptc_com] \Newline\begin{example}
...
\end{example}
\item[ring_general] \Newline\begin{example}
