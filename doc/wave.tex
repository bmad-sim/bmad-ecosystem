...
\begin{figure}[t]
  \centering
  \includegraphics[width=4in]{wave.eps}
...
Figure~\ref{f:wave0}a shows the difference between \vn{model}
...
are given by Eq.~(42) of Sagan\ref{b:wave0} and 
\Begineq
...
there. The next three lines of the output are $\sigma_{\detal
k}/\delta k$, $\sigma_\phi$, and $\xi_C$, and are given by Eq.~(39),
(43), and (44) respectively of \ref{b:wave0}. The last three lines of
