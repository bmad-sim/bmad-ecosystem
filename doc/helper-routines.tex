...
with \bmad contains several. In particular, the routine \hyperref{routine!mrqmin}
...
sum of quadratic terms. Another routine, \hyperref{routine!frprmn}, which is an
...
is \hyperref{routine!opti_lmdif} which is Fortran90 version of the popular
\vn{lmdif} routine. Also available is \hyperref{routine!opti_de} which implements
