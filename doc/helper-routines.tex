...
with \bmad contains several. In particular, the routine \hyperref[r:mrqmin]{routine!mrqmin}
...
sum of quadratic terms. Another routine, \hyperref[r:frprmn]{routine!frprmn}, which is an
...
is \hyperref[r:opti.lmdif]{routine!opti_lmdif} which is Fortran90 version of the popular
\vn{lmdif} routine. Also available is \hyperref[r:opti.de]{routine!opti_de} which implements
