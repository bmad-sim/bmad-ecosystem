...
input lattice file using what are know as \vn{beam lines} and \vn{replacement
lists}. \vn{beam lines} are further subdivided into lines with and without
\vn{replacement arguments}. This essentially corresponds to the \mad
definition of lines and lists. There can be multiple \vn{beam lines} and
\vn{replacement lists} defined in a lattice file and lines and lists can be
...
Like the root lattice, \bmad always automatically creates an element
