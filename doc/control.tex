...
{With the \vn{reference_orbit} attribute set to
\vn{match_at_entrance}, the reference orbit through a bend will be
...
\begin{example}
  ...
  match_at_exit
\end{example}
A value of \vn{singe_ref} (the default) means that the same reference
