...
\vn{no_superimpose} command (\sref{s:no.superimpose}) can be used to
supress superposition.
...
\index{match_at_entrance}\index{match_at_exit}\index{match_global_cocords}
