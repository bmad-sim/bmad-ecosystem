...
\end{example}
With \vn{accordian_edge}, \vn{start_edge}, \vn{end_edge}, and
...
\vn{Group}, \vn{Overlay}, and \vn{I_Beam} control elements. A superimposed element that
