...
\begin{tabular}{|l|l|l|} \hline
  {\it Data\_Type}              & {\it Description}                  &          \\ \hline 
    alpha.x, alpha.y, alpha.z   & Projected Alpha Function           &          \\ \hline 
    alpha.a, alpha.b, alpha.c   & Normal-Mode Alpha Function         &          \\ \hline 
    beam\_energy                & Beam Kinetic Energy                &          \\ \hline
    beta.x, beta.y, beta.z      & Projected Beta Function            &          \\ \hline 
    beta.a, beta.b, beta.c      & Normal-Mode Beta Function          &          \\ \hline 
    bpm.x, bpm.y                & Transverse BPM reading             &          \\ \hline 
    eta.x, eta.y, eta.z         & Projected Dispersion               &          \\ \hline 
    eta.a, eta.b, eta.c         & Normal-Mode Dispersion             &          \\ \hline 
    etap.x, etap.y, etap.z      & Projected Dispersion derivative    &          \\ \hline 
    etap.a, etap.b, etap.c      & Normal-Mode Dispersion derivative  &          \\ \hline 
    ...
    \begin{tabular}{@{}l}  
      ...
      beam\_emittance.c \\
    \end{tabular} 
                          & Beam Emittance         &          \\ \hline 
    \begin{tabular}{@{}l}  
      norm\_beam\_emittance.x \\ 
      norm\_beam\_emittance.y \\
      norm\_beam\_emittance.z \\
      norm\_beam\_emittance.a \\
      norm\_beam\_emittance.b \\
      norm\_beam\_emittance.c \\
    \end{tabular} 
...
%   data type             & Single & Beam & Macroparticle
    ...
    \vni{e_tot}            &   L    &   L  &   L   \\ \hline  
    \vni{lat_emittance}    &   L    &   L  &   L   \\ \hline
