...
how data is organized in \tao while Section~\sref{c:data_init}
...
Figure~\ref{f:data_tree}.  For example, a \vn{d2_data} structure for
...
As explained in Section~\sref{s:data_anatomy}, each individual datum
