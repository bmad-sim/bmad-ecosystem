...
\vni{ele} and \vni{ele2}. The \vni{data_types} are divided into two
...
associated \vni{ele2} element then the \vn{model} value is dependent
upon the \vni{merit_type}. For example, with a \vn{beta:x} \vn{data_type} the
...
\begin{tabular}{|l|l|l|} \hline
  {\it Data\_Type}        & {\it Description}                 &          \\ \hline 
    ...
    phase_frac_diff       & Fractional phase difference (x-y) & relative \\ \hline
