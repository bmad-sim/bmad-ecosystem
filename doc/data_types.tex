...
circular lattice there is a single emittance number. \vn{emittance.a}
and \vn{emittance.b} are the standard normal mode emittances. With
...
\end{equation}
\vn{emittance.x} and \vn{emittance.y} are the projected emittances.
