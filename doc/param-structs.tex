...
\index{radiation_fluctuations_on}
...
\begin{example}
  type bmad_common_struct
    ...
    real(rp) :: rel_tolerance = 1e-6           ! Runge-Kutta: Relative tolerance.
...
\vn{spin_tracking_on} determines if spin tracking is performed or not.
