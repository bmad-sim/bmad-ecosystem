...
\begin{example}
  type bmad_common_struct
    ...
    logical high_energy_space_charge_on = F     ! High energy space charge calc toggle.
...
\begin{example}
  type ptc_common_struct
    ...
    exact_model    = False  ! PTC EXACT_MODEL.
...
(\sref{s:bmad.ptc.com}) must be set True to enable the CSR calculation. Additionally, tracking with
