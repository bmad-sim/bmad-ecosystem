...
(\Hyperref{r:make.mat6.from.tracking}{make_mat6_from_tracking}) tracks 12 particles at both plus and
...
Toggle to prevent non thread safe calculational optimizations from being done.
See Section~\sref{s:thread.safe} for more details.
