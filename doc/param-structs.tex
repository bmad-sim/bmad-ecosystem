...
from the bunch center the grid spacing for the particle-in-cell may become too course. To help remidy
...
\begin{equation}
  \frac{|dx|}{\sigma_x} + \frac{|dy|}{\sigma_y} + \frac{|dz|}{\sigma_z} > \text{particle_sigma_cutoff}
\end{equation}
%
