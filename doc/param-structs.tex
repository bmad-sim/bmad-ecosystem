...
\begin{example}
  type bmad_common_struct
    ...
    logical space_charge_on = F                 ! Ultra-relativistic space charge switch
...
Toggle to turn on or off the ultra-relativistice space charge effect in particle tracking
(\sref{s:space.charge}). Computationally, this is separate from the space charge component of
