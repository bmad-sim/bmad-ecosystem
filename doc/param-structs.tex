...
\index{auto_scale_field_phase_default}\index{auto_scale_field_amp_default}
...
\begin{example}
  type bmad_common_struct
    ...
    logical include_offsets_in_ele_taylor_maps = T           ! Enable bookkeeper to set
...
\item[\vn{\%include_offsets_in_ele_taylor_maps}] \Newline
...
\item[\vn{\%auto_scale_field_phase_default}] \Newline
Default setting to be applied to a lattice if \vn{auto_scale_field_phase}
...
\item[\vn{\%auto_scale_field_amp_default}] \Newline
Default setting to be applied to a lattice if \vn{auto_scale_field_amp}
(\sref{s:param}) is not specified in a lattice file. Additionally, if
an element that is not associated with a lattice is tracked, this
