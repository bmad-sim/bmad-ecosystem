...
\vn{%curved_ref_frame} is True. Notice that the \vn{masterParameter} attribute is not part of the
...
The correspondence between the \vn{gridGeometry} parameter and the \vn{%geometry} component of the
\vn{grid_field_struct} is \vspace{-1ex}
\begin{center}
\tt
\begin{tabular}{ll} \toprule
