...
default value of one) will be used to set \vn{%field_scale} and \vn{fieldScale} is ignored. If
\vn{masterParameter} is not present, \vn{componentFieldScale} is ignored and \vn{%field_scale} is
set from the value of \vn{fieldScale}.
