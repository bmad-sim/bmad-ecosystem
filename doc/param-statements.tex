...
\index{ptc_exact_calc}\index{ptc_exact_misalign}
...
\begin{example}
  ...
  parameter[ptc_exact_calc]         = <Logical>  ! PTC to do "exact" tracking?
...
\index{ptc_exact_calc}\index{ptc_exact_misalign}
The \vn{ptc_exact_calc} and \vn{ptc_exact_misalign} switches 
