...
\begin{example}
  ...
  parameter[particle]      = <particle_type> ! Reference particle. positron, antiproton, etc.
  ...
  parameter[rel_tracking_charge]    = <Real>     ! Charge of tracked particles relative to 
                                                 !   reference charge. Default is 1.
\end{example}
...
is 1. See Section~\sreffff{} for more details.
