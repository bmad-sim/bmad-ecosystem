...
the number of nuceons is not present, the mass is an average weighted by the isotopic
...
formula. The mass may to specified to hundridths of an AMU. The known molecules are:
\begin{example}
CO       CO2      
D2       D2O      
OH       O2      
...
%-----------------------------------------------------------------------------
\section{Beam_Start Statements} \label{s:beam.start}
...
The logitudinal direction of travel is set by \vn{beam_start[direction]}.  This can be set
