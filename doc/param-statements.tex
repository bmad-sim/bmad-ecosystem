...
\begin{example}
  ...
  parameter[default_rel_tracking_charge] 
                                    = <Real>     ! Charge/mass of default tracked particles 
                                                 !  relative to reference charge. Default is 1.
...
\index{default_rel_tracking_charge}
The \vn{default_rel_tracking_charge} establishes the default
charge-to-mass ratio of particles being tracked relative to the charge
of the reference particle (set by \vn{parameter[particle]}). The default is 1.
