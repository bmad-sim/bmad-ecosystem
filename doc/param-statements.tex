...
The \vn{parameter[particle]} switch sets the reference species. There are three groups
of particles. The first group are fundamental particles. These are:
\begin{example}
  electron,     positron,   
  muon,         antimuon,
  proton,       antiproton,
  ...
  deuteron
\end{example}
The second group are molecules. The list of known molecues is:
\begin{example}
\end{example}

\vn{deuteron} is the positively striped deuteron and \vn{deuteron_0}
