...
\end{example}
multiple \vn{-lat} arguments can be used to specify multiple lattices.
...
\vn{plot_page%text_height} sets the baseline height of the text that is drawn.
\vn{plot_page%main_title_text_scale} scales the height of the main title text
relative to this baseline. Similarly \vn{plot_page%graph_title_text_scale} scales
the height of the titles of any graph. The axis numbers and axis label are scalled
by \vn{plot_page%axis_number_text_scale} and \vn{plot_page%axis_label_text_scale}
respectively. \vn{plot_page%key_table_text_scale} scales the text in a \vn{key table}
and \vn{plot_page%legend_text_scale} scales the text in a \vn{lat layout} or 
a \vn{floor plan}.
