...
The \vn{space_charge_commandstruct} holds global variables for space charge, including coherent
...
\vn{bmad_common_struct} strucuture as well as individual lattice element parameters.  See the \bmad
