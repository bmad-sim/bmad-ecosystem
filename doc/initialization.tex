...
say, two bends have the name "bend_0" then a single variable will be
...
(\sref{s:curve}) to toggle the drawing of symbols.
...
True. Use the \vn{set curve} command (\sref{s:curve}) to toggle the
drawing of lines.
