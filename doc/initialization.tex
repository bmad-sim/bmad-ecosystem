...
\index{data!ele_name}\index{data!ele0_name}\index{data!merit_type}
...
The relative data types are noted in Tables~\ref{t:data.beam} and
\ref{t:data.lattice}. With
...
\index{data%weight}
\vn{data(:)%weight} gives the weight coefficient for a datum in the
...
ele_shape for a \vn{photon_branch} is present.
