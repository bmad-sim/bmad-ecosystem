...
\begin{example}
  ...
  /
\end{example}
where \vn{i} refers to the universe to be coupled. Either \vn{at_element} or
\vn{at_s} must be specified but not both. These refer to the location in the
...
named as such will be used.If \vn{ele_name = "end"} then the end of the injection lattice will be used as
...
the \vn{BEGINNING} element. This goes for the \vn{tao_beam_init} namestruct in
