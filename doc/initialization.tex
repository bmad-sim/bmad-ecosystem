...
Parameters \vn{n_angle}, \vn{min_angle}, and \vn{max_angle} can be set to indicate
the angle in the $x-y$ plane to scan about the closed orbit. %%% The points on the d
\etcetc
...
\vn{type} string prameters of that can be set in the lattice file for each individual element.
