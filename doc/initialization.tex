...
\begin{figure}
  \centering
  \subfloat[Horizontal phase space]{
  %\includegraphics[width=5in]{phase-space.pdf}
  \includegraphics[width=0.45\textwidth]{plot-color-xpx}
  }
  \subfloat[Longitudinal phase space]{
  \includegraphics[width=0.45\textwidth]{plot-color-zpz}
  }  
