...
\begin{example}
  &tao_beam_init
    ...
    beam_init%sig_e         = <number>    ! e_sigma in eV
    beam_init%sig_z         = <number>    ! Z sigma in m
    beam_init%sig_e_cut     = <number>    ! Energy cut in sigmas
    beam_init%sig_z_cut     = <number>    ! Z cut in sigmas
    beam_init%sig_trans_cut = <number>    ! transverse dimension cut
  ...
  /
\end{example}
\vn{ix_universe} refers to the universe index. See \bmad documentation on what the
