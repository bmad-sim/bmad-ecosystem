...
\begin{example}
  type tao_floor_plan_orbit_struct
    scale   = <real>              ! Scale for the orbit. Default = 0 => No orbit plot.
...
\end{example}
The \vn{scale} component scales from the orbit

This is done by setting
\vn{graph%floor_plan_orbit%scale} to something nonzero. A value of zero suppresses the drawing of
