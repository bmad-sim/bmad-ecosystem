...
\vn{Quick PLot} is an interface library developed for \bmad for graphics plotting. \vn{Quick Plot}
defines a number of structures to parameterize such things like line and symbol properties. The
structures that \tao uses are as follows.
...
\begin{example}
  White   (actually the background color)
  Black   (actually the foreground color)
  Red
  Green
  Blue
  Cyan
...
\begin{example}
  ...
  dotted                 Dotted line
  dash_dot3              Dash--dot--dot--dot line
\end{example}
