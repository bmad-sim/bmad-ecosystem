...
The \vn{-noplot} optional argument suppresses the opening of the plot window.
...
have the lattice specified by the line ``my_line'' from the lattice
``third.lat''.
...
array is in \vn{class::name} format as explained in \sref{s:class.name}.
...
\begin{example}
  ...
  "data"      ! Use data from a d1_data array.
