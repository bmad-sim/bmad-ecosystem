...
The \vn{-noplot} optional argument supresses the opening of the plot window.
...
type tao_global_struct
  ...
  logical optimizer_var_limit_warn = T  ! Warn when variabless reach a limit when
                                        !   optimizing.
end type
\end{example}
...
\begin{example}
  ...
  /
\end{example}
A figure is drawn for each lattice element in the lattice that matches a
...
the \vn{K1} focusing strength. Not all lattice elements can be used with a
\vn{var_height_box}.
