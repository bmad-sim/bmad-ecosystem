...
The \vn{common_base_lat} switch can be used when there is a baseline
...
steering magnet is varied. When \vn{common_base_lat} is set to True,
...
savings in memory. With \vn{common_base_lat}, the difference between
