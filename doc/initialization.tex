...
\begin{example}
  tao \{-init <tao_input_file>\} \{-beam_all <beam_file>\} \{-beam0 <beam_file>\} \{-lat <lattice_file>\}
\end{example}
...
\begin{example}
  &tao_beam_init
    ...
    beam0_file              = <string>       ! Particle initialization file used in place of beam_init
    beam_all_file           = <string>       ! Particle file used in place of beam tracking.
...
When there is no \vn{beam0_file} the twiss parameters 
