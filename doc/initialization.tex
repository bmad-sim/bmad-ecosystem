...
\vn{ele0_name} that is not a blank string. Thus, in the above example,
...
Certain data like the betatron \vn{phase} is measured with respect to 
a reference point and in the example above \vn{data(2)} is the phase 
