...
The optional arguments, which will always superceed equivalent parameters set in an initialization
file are:
\begin{description}
%
...
%
\item[beam_track_data_file] \Newline
...
%
\item[beam_track_start, beam_track_end] \Newline
...
The \vn{plot_page} structure has the following parameters:
\begin{description}
%
...
The \vn{plot_page%size} parameter sets the horizontal and vertical size of the plot
...
Other parameters set in the \vn{tao_plot_page} 
...
may not contain a dot ``.''.  The last four elements of the \vn{retion(i)} array correspond to
\vn{x1}, \vn{x2}, \vn{y1}, and \vn{y2} as discussed in \Sref{s:region.def}. There is no upper limit
to the number of regions that can be defined.
...
%
\item[graph\%x2] \Newline
%
\item[graph\%y] \Newline
%
\item[graph\%y2] \Newline
%
\item[graph\%y2_mirrors_y] \Newline
%
\end{description}
...
\begin{description}
%
\item[curve\%component] \Newline
%
\item[curve\%data_source] \Newline
%
\item[curve\%data_index] \Newline
%
\item[curve\%data_type] \Newline
%
\item[curve\%data_type_x] \Newline
%
\item[curve\%data_type_z] \Newline
%
\item[curve\%ele_ref_name] \Newline
%
\item[curve\%hist] \Newline
%
\item[curve\%ix_branch] \Newline
%
\item[curve\%ix_bunch] \Newline
%
\item[curve\%legend_text] \Newline
%
\item[curve\%line] \Newline
%
\item[curve\%name] \Newline
%
\item[curve\%orbit] \Newline
%
\item[curve\%scale] \Newline
%
\item[curve\%smooth_line_calc] \Newline
%
\item[curve\%symbol] \Newline
%
\item[curve\%units] \Newline
%
\item[curve\%y_axis_scale_factor] \Newline
%
\item[curve\%z_color] \Newline
%
\end{description}
