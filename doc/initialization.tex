...
To plot the results, an appropriate plot must be defined (\sref{s:dynamicapertureplot}) and
...
/
\end{example}
This produces the plot on Fig.~\ref{f:da-plot}.  Each curve represents a single momentum
...
from the second curve will be taken to define the $y$ coordinate of the parameteric curve. The plot
