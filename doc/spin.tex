...
perturbation in the single resonance model results in the suppression of all other linear resonances
...
\begin{equation}
  ...
  \qquad
  \Lambda_n = \sqrt{1 + 4 \, J \, \Left| \re(\bfn_k) \Right|^2}
  \label{nnav}
\end{equation}
...
$\xi_r$ in \Eq{x2dn} can be related to the $\bfG$ matrix (\Eq{mm0gd}). The corresponding equation
is\cite{b:spin.hoff}
\begin{equation}
  \xi_r = \frac{1}{2 \, \pi} \, \Left| \bfG \cdot \bfv_k \Right|
  \label{x1pg}
\end{equation}
As resonance is approached, $\delta$ goes to zero and $\bfn_k$ goes to infinity in \Eq{x2dn}. In
