...
version you are working with is controlled 

The precision \bmad uses for real number arithmatic is controlled by
...
recompiling all the libraries except PTC and PGPLOT.  You cannot mix
and match. Either you are using the single precision version or you
are using the double precision version.
