...
only used for \vn{sbend}, \vn{rbend}, and \vn{sad_mult} elements only. For \vn{sbend} and \vn{rbend}
elements, the fringe map is defined in terms of the \vn{fint}, \vn{fintx}, \vn{hgap}, and \vn{hgapx}
parameters. The field integrals $F_{H1}$ for the entrance end and $F_{H2}$ for the exit end given by
(see \Eq{fsbbb})
\begin{equation}
