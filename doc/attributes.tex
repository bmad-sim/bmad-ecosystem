...
\begin{example}
  wall = \{
    ...
    thickness = <real>                       ! Default thickness. Diffraction_plate only
    opaque_material = <material_type>        ! Default. Diffraction_plate only
    clear_material = <material_type>         ! Default. Diffraction_plate only
    section = \{ 
