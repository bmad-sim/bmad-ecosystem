...
\index{m}\index{field}\index{mode}\index{freq}\index{theta_t0}
\index{f_damp}\index{field_scale}\index{master_scale}\index{phi_0}
...
The phase \vn{theta_t0} of the fundamental mode is auto-scaled by Bmad
