...
bend curved coordinate system if the the \vn{curved_ref_frame} component of the field map is
set to \vn{True}. The setting of \vn{curved_ref_frame} is ignored for non-bend elements.
