...
\begin{align}
  {-z} &= \frac{x^2}{r+R} + \frac{x^4}{(r+R)^3} + \frac{2 \, x^6}{(r+R)^5} + 
         \frac{y^2}{r} + \frac{(4 \, r + R) \, y^4}{4 \, r^3 \, (r+R)} + \\
  & \qquad \frac{(16 \, r^2 + 5 \, r \, R + R^2) \, y^6}{8 \, r^5 \, (r + R)^2} +
         \frac{2 \, x^2 \, y^2}{r \, (r+R)^2} + \frac{6 \, x^4 \, y^2}{r \, (r + R)^4} + 
         \frac{(12 \, r + R) \, x^2 \, y^4}{2 \, r^3 \, (r + R)^3} \nonumber
\end{align}
...
A related is \vn{multipoles_on} (\sref{s:multip}.
