...
The \vn{fringe_type} switch is used to select how a fringe field is simulated.
For \vn{rbend} and \vn{sbend} elements, \vn{fringe_type} may be set to one of the following:
\begin{example}
  none              
  edge_focus_only
  basic_bend        ! Default 
  ...
  sad_full
\end{example}
For non-bend elements, \vn{fringe_type} may be set to one of:
\begin{example}
  none              ! Default 
  full_straight
  sad_linear
...
\vn{quadrupoles}, \vn{sextupoles}, etc. 
The \vn{basic_bend} setting,
...
order terms.  
The \vn{edge_focus_only} setting ignores these second order terms.
In some cases, for instance in a chicane,
