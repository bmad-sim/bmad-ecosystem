...
\begin{example}
  ...
  gen_grad_map        ! \sref{s:taylor.field}
\end{example}
...
\vn{gen_grad_map} type defines a set of Taylor maps. Each map defines the field in the
...
%-----------------------------------------------------------------
\subsection{Gen_Grad_Map Field Map}
\label{s:taylor.field}
\index{taylor field}

The \vn{gen_grad_map} field map is only used for DC fields. A \vn{gen_grad_map} is comprised
of a set of two dimensional Taylor maps.

The syntax for describing a \vn{gen_grad_map} is:
\begin{example}
  gen_grad_map = \{
    field_type       = <String>,    ! Type of field: Default = magnetic.
    field_scale      = <Real>,      ! Scale factor for the E & B fields.
