...
convoluted convention is avoid the calculational problems when the
reference momentum is zero. Specifically, the phase space momentum
would be infinity in this case (Cf.~\Eqs{ppp}).
