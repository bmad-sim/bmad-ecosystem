...
\begin{example}
  ...
  wall_end
\end{example}
\vn{wall_start} and \vn{wall_stop} sections must come in pairs. The
next section after a \vn{wall_stop} section (if this section is not
...
that section and the previous section (which must be a \vn{wall_stop}
