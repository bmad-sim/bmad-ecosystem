...
{A) The five wall sections that define a vacuum chamber wall
crotch. B) Layout of the crotch1, crotch2 and crotch wall sections.}
  \label{f:crotch}
\end{figure}
...
\begin{example}
  ...
  trunk
\end{example}
The geometry of a crotch is shown in \fig{f:crotch}. Two pipes, called
``leg1'' and ``leg2'', merge into one pipe called the ``trunk'' pipe.
The trunk pipe can be either upstream or downstream of the leg pipes.
To describe this situation, five sections are needed: One section in
each leg pipe which need to have their \vn{type} attribute to
