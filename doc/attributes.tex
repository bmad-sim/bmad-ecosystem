...
of an \vn{lcavity} or. \vn{e_gun}, an \vn{lcavity} or \vn{e_gun} has
the dependent attributes
\index{e_gun}\index{lcavity}
\begin{example}
  e_tot_start   and
  p0c_start
\end{example}
...
Electromagnetic fields can be specified using the \vn{field}
...
\vn{mode} has a frequency \vn{freq} which, if non-zero, identifies it
