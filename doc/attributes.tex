...
A surface can be broken up into rectangles. This is useful, for
example, in breaking up a \vn{detector} element into pixel photo
receptors or in simulating a rough serface for \vn{crystal}s and other
elements. The general

r0                  ! Optional. Default is (0, 0)
dr                  ! Required components must be positive
x_bounds, y_bounds  ! Required

Example:
\begin{example}
  ccd: detector, surface = {
          grid = {
            r0 = (0.0, 0.01), dr = (0.005, 0.005),
            x_bounds = (-57, 57), y_bounds = (-30, 10)
          } }
\end{example}
