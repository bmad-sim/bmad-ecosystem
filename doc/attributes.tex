...
in a bend) and for \vn{full_straight} the fringe_field is ...
...
\index{sad}
For SAD type fringes, the \vn{sad_linear} setting only uses the linear
part of the fringe, \vn{sad_nonlin_only} ignores the linear part of
the fringe, and \vn{sad_full} uses the full fringe.
