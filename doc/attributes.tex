...
\Begineq
  \theta_0 = 
  \begin{cases}
    \text{phi0_ref} + \dsfrac{f}{f_0} \, (\text{phi_ref} + \text{phi0_err}) & 
    \text{lcavity element} \\
    \text{phi0_ref} - \dsfrac{f}{f_0} \, \text{phi_ref} & 
    \text{rfcavity element}
  \end{cases}
\Endeq
where $f$ is the mode frequency and $f_0$ is the frequency of the fundamental.

The phase \vn{phi0_ref} of the fundamental mode is auto-scaled by Bmad
