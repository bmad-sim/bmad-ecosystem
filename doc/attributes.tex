...
\begin{example}
  ...
  full_straight
  linear_sad
  nonlin_only_sad   ! Default for sad_mult elements
  full_sad
\end{example}
...
\index{sad}
For SAD type fringes, the \vn{linear_sad} setting only uses the linear
part of the fringe, \vn{nonlin_only_sad} ignores the linear part of
the fringe, and \vn{full_sad} uses the full fringe.
