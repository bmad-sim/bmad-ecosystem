...
\begin{example}
  ! Pseudo Wake modes:
  !                      Amp       Damp          K      Phase  Polarization  Kick_Linear_In
  ...
  &short_range_modes
    ...
    .. etc ..
    transverse(1) =   4.23e14     2.23e3     5.62e3     0.789      X         Trailing
...
The \vn{kick_linear_in} parameter sets whether the wake kick
is linear in the offset of the leading or trailing particle.
Possible settings of this parameter are:
\begin{example}
  leading_offset  ! Default
  trailing_offset
\end{example}
The \vn{kick_linear_in} name may be abbreviated. Note: Due to the way
the wake file is parsed, if \vn{kick_linear_in} is specified for a
particular mode, \vn{polarization} must also be specified.
