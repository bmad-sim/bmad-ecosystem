...
\begin{example}
  ...
  roll     = <Real>
\end{example}
\index{patch}\index{branch}\index{photon_branch}
The exception here are the \vn{patch}, \vn{branch} and
\vn{photon_branch} elements which uses these attributes to modify the
