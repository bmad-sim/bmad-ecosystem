...
\vn{dphi} misalignment of \mad which rotate around the entrance
...
considered to have shifted the aperture boundary. The exception here
is that the default for \vn{rcollimator} and \vn{ecollimator} elements
is for \vn{offset_moves_aperture} to be \vn{True}.
...
The \vn{surface} setting for \vn{aperture_at} is only used for
...
frame of reference of the surface of the element.
