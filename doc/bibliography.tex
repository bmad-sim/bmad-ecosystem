...
\hfill\break
\hspace*{0.3in}
\url{www.classe.cornell.edu/~dcs/aml/}
...
The Bmad web site:
\hfill\break
\hspace*{0.3in} \url{www.classe.cornell.edu/bmad}
...
\bibitem[Duan15]{b:duan15} Zhe Duan, Mei Bai, Desmond P. Barber, Qing Qin, 
...
\hfill\break
\hspace*{0.3in}
\url{frs.web.cern.ch/frs/report/sl-2002-044.pdf}
...
Also see:
\hfill\break
\hspace*{0.3in} \url{acc-physics.kek.jp/SAD/}
...
\hfill\break
\hspace*{20pt} 
\url{link.aps.org/doi/10.1103/PhysRevSTAB.2.074001}
...
\hspace*{0.3in}
\url{www.classe.cornell.edu/~dcs/bmad/tao_entry_point.html}
...
Documentation at
\hfill\break
\hspace*{0.3in} \url{www-project.slac.stanford.edu/lc/ilc/TechNotes/LCCNotes/PDF/LCC-0060%20rev.1.pdf}
