...
\bibitem[SAD]{b:sad} Documentation on the SAD program for accelerator
simulation and design can be found at:
\hfill\break
\hspace*{0.3in}
\url{http://acc-physics.kek.jp/SAD/}
