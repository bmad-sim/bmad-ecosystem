...
\end{example}
Environmental variables in the file name will be expanded. \bmad will read the called file until a
...
where the attribute structure is given. The Environmental variables in the file name will be expanded.
Example:
\begin{example}
