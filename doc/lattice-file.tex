...
single element. If a marker element has been placed inbetween two element with the same name, the
...
\end{example}
In this case the finished line will will have a single \vn{q1} element whose length will be twi
...
tracking part of the lattice (\sref{s:lord.slave}). The \vn{BEGINNING} element of the branch
