...
\begin{tabular}{|l|l|l|l|} \hline
  ...
  m_electron      & $0.51099906 \pow{6}$   & eV/$c^2$   & Electron mass         \\
  m_muon          & $105.6583715 \pow{6}$  & eV/$c^2$   & Muon mass             \\
  m_pion_0        & $134.9766 \pow{6}$     & eV/$c^2$   & $\pi^0$ mass          \\
  m_pion_charged  & $139.57018 \pow{6}$    & eV/$c^2$   & $\pi^+$, $\pi^-$ mass \\
  m_proton        & $0.938271998 \pow{9}$  & eV/$c^2$   & Proton mass           \\
  ...
  emass           & $0.51099906 \pow{-3}$  & GeV/$c^2$  & Electron mass         \\
  pmass           & $0.938271998$          & GeV/$c^2$  & Proton mass           \\ \hline
\end{tabular}
