...
be independent of the universe it is in.
  ...
  \index{t.* tt.*} 
  \item{t.* tt.*} \Newline
The \vn{t} and \vn{tt} data types involve symplectic integration
...
\begin{tabular}{|l|l|l|} \hline
  ...
  eta.order2.x, eta.order2.y   & 2\Nd order lab frame dispersion            &          \\ \hline 
  etap.order2.x, etap.order2.y & 2\Nd order lab frame dispersion derivative &          \\ \hline 
  ...
  momentum\_compaction.order2  & 2\Nd order momentum compaction factor & relative \\ \hline
