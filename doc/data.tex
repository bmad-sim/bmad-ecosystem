...
Chromaticity and chromatic terms in the Taylor expansion with respect to $p_z$ as calculated from
Etienne Forest's PTC code. [See the \bmad manual for documentation on PTC.] $.a$ denotes the $a$
normal mode of oscillation and $.b$ denotes the $b$-mode. $N$ is an integer which gives the order of
the index in the Taylor expansion
\begin{equation}
  Q(p_z) = Q_0 + Q_1 \, p_z + Q_2 \, p_z^2 + \ldots
\end{equation}
$N = 0$, that is \vn{chrom_ptc.a.0} and \vn{chrom_ptc.b.0} are the chromaticities themselves, at
$p_z = 0$, etc.
...
\begin{longtable}{llll} 
  ...
  \begin{tabular}{@{}l}
    ...
    chrom_ptc.b.$N$
  \end{tabular} 
                $N = 0, 1, \ldots$    & Chromaticity Taylor terms                 & lat         & no  \\ \hline
  ...
  element_attrib.<attr_name>          & lattice element attribute                 & lat         & No  \\ \hline
  ...
  \begin{tabular}{@{}l}   
     t.$ijklm\ldots$, \\
     tt.$ijklm\ldots$ 
  \end{tabular} \hspace{-1em} $1 \le i,j,k,\ldots \le 6$  
                                      & \begin{tabular}{@{}l}
                                          Term in n\Th \\
                                          order transfer map
                                        \end{tabular}                             & lat         & No  \\ \hline 
  ...
  unstable.lattice                    & \begin{tabular}{@{}l}
                                          Positive if \\
                                          lattice is unstable
                                        \end{tabular}                             & lat         & No  \\ \hline
