...
Including \vn{unstable.orbit} in the merit function will thus tend to stabalize the lattice.
...
turn in a branch. This being the case, the geometry of the branch is not pertainent and the value of
\vn{unstable.orbit} is value as shown above for a single particle in an open branch but hereaveraged
...
the bunch tracking end point (which may not be the end of the branch).
  ...
  %----------------------
  \item[unstable.ring] \Newline \hlabel{unstable.ring}
...
\begin{longtable}{lllll} 
  ...
  \pref{r.ij}             & r.$ij$ \hspace{10pt} $1 \le i,j \le 6$ & Term in linear transfer map            & lat        & No  \\ \hline 
  ...
  \pref{unstable.orbit}   & unstable.orbit                      & \begin{tabular}{@{}l}   
                                                                    ...
                                                                    lost in tracking
                                                                  \end{tabular}                             & lat        & No  \\ \hline
  \pref{unstable.ring}    & unstable.ring                       & \begin{tabular}{@{}l}
                                                                    Deprecated!           \\
