...
\vn{data_source} (\sref{s:init.data}) and Tables~\ref{t:data.lattice1}
and \ref{t:data.lattice2} lists the predefined data types in \tao that
are valid for a \vn{"lattice"} \vn{data_source}.
...
\label{t:data.lattice1}
\caption{Part I. Predefined Data Types for \vn{"lattice"} data\_source. 
This list is continued on the next table.}
\end{table}
...
\label{t:data.lattice2}
\caption{Part II. Predefined Data Types for \vn{"lattice"} data\_source. 
This list is continued from the previous table.}
\end{table}
