...
an optimization to avoid unstable solutions (\sref{s:opt.main}). Also see
\vn{unstable.eigen}.
...
solutions (\sref{s:opt.main}). Also see \vn{unstable.eigen}.
...
\begin{longtable}{llll} 
  ...
  \end{tabular}
                                      & Periodic map Taylor terms                 & lat         & No  \\ \hline 
  ...
  phase_frac_diff                     & \begin{tabular}{@{}l}
                                          Phase difference \\
