...
\end{example}
When not specified, the current ``viewed'' universe (\sref{s:view}) is
assumed. The current \vn{viewed} universe can also be specified using
the number \vn{-1}. Examples:
\begin{example}
  2@orbit.x       ! The \vn{orbit.x} data in universe 2. 
  orbit.x         ! The \vn{orbit.x} data in the current viewd universe.
  -1@orbit.x      ! Same as above.
