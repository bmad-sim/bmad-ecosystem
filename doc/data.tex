...
Do not confuse the \vn{ele_ref_name} component (see preceeding paragraph) with the \vn{ref}
...
the measured orbit for the other measurement. This way orbit differences can be anlyzed.
...
Horizontal and vertical, dispesion derivative.
...
The value of \vn{unstable.lattice} will always be zero or positive.

For lattices with a closed geometry such as a storage ring: The value \vn{unstable.lattice} is zero
if the ring is stable and, if the ring is unstable, the value is set to the largest growth rate of
the transverse (but not longitudinal) normal modes of oscillation. \vn{unstable.lattice} is used in
an optimization to avoid unstable solutions (\sref{s:generalized.design}). Also see
\vn{unstable.eigen}.

For lattices with an open geometry: The value of \vn{unstable.lattice} will be non-zero if there is
a problem computing the reference energy. This can happen, for example, if the accelerating voltage of
an \vn{lcavity} is set large and negative such that the reference particle is cannot make it to the exit end.

Note: \vn{unstable.lattice} replaces \vn{unstable.ring}. 
...
Deprecated. Replaced by \vn{unstable.lattice}.
...
\begin{longtable}{llll} 
  ...
  {\it Data_Type}                    & {\it Description}   & {\it data_source} & \parbox{0.5in}{\begin{tabular}{@{}l}
                                                                              {\it Can use} \\
                                                                              {\it s_offset?}
  ...
  apparent_emit.x, .y                 & Apparent emittance                        & lat, beam   & No  \\ \hline

  beta.a, .b, .c                      & Normal-mode beta function                 & lat, beam   & Yes \\ \hline 
  beta.x, .y, .z                      & Projected beta function                   & lat, beam   & No  \\ \hline 
  \begin{tabular}{@{}l}   
    bpm_cbar.22a, .12a, \\
    \hspace{4em} .11b, .12b  
  ...
  emit.a, .b, .c                      & Emittance                                 & lat, beam   & No  \\ \hline
  emit.x, .y, .z                      & Projected emittance                       & lat, beam   & No  \\ \hline
  eta.x, .y, .z                       & Dispersion                                & lat, beam   & Yes \\ \hline 
  eta.a, .b                           & Normal-mode dispersion                    & lat, beam   & Yes \\ \hline 
  etap.x, .y                          & Dispersion derivative                     & lat, beam   & Yes \\ \hline 
  etap.a, .b                          & Normal-mode dispersion derivative         & lat, beam   & Yes \\ \hline 
  ...
  floor_orbit.x, .y, .z               & global position of orbit                  & lat, beam   & Yes \\ \hline 
  ...
  norm_apparent_emit.x, .y            & Normalized apparent emittance             & lat, beam   & No  \\ \hline
  norm_emit.a, .b, .c                 & Normalized beam emittance                 & lat, beam   & No  \\ \hline 
  norm_emit.x, .y, .z                 & Normalized projected emittance            & lat, beam   & No  \\ \hline 
  ...
  orbit.e_tot                         & Beam energy (eV)                          & lat, beam   & Yes \\ \hline
  orbit.x, .y, .z                     & Orbit position                            & lat, beam   & Yes \\ \hline 
  orbit.px, .py, .pz                  & Orbit Momenta                             & lat, beam   & Yes \\ \hline 
  ...
  photon.intensity                    & Photon total intensity                    & lat, beam   & No  \\ \hline 
  \begin{tabular}{@{}l}
    photon.intensity_x, \\
    \hspace{2em} .intensity_y
  \end{tabular}                       & Photon intensity components               & lat, beam   & No  \\ \hline
  photon.phase_x, .phase_y            & Photon phase                              & lat, beam   & No  \\ \hline

  \begin{tabular}{@{}l}
    ping_a.amp_x, .phase_x,                \\
    \hspace{2em} .amp_y, .phase_y,         \\
    \hspace{2em} .amp_sin_y, .amp_cos_y,   \\
    \hspace{2em} .amp_sin_rel_y,           \\
    \hspace{2em} .amp_cos_rel_y 
  \end{tabular}                       & Pinged beam $a$-mode response             & lat        & No  \\ \hline

  \begin{tabular}{@{}l}
    ping_b.amp_x, .phase_x,               \\
    \hspace{2em} .amp_y, .phase_y,        \\
    \hspace{2em} .amp_sin_x, .amp_cos_x,  \\
    \hspace{2em} .amp_sin_rel_x,          \\
    \hspace{2em} .amp_cos_rel_x 
  ...
  ref_time                            & Reference time                            & lat, beam   & Yes \\ \hline
  ...
  spin.x, .y, .z                      & Particle spin                             & lat, beam   & No  \\ \hline 
  ...
  time                                & Particle time (sec)                       & lat, beam   & Yes \\ \hline
  ...
  unstable.lattice                    & Positive if lattice is unstable           & lat         & No  \\ \hline
  unstable.orbit                      & \begin{tabular}{@{}l}   
                                          Nonzero if particles are \\
                                          lost in tracking
                                        \end{tabular}                             & lat         & No  \\ \hline
  unstable.ring                       & \begin{tabular}{@{}l}
                                          Deprecated!           \\
                                          Use unstable.lattice  
                                        \end{tabular}                             & lat         & No  \\ \hline
  velocity                            & Normalized velocity $v/c$                 & lat, beam   & Yes \\ \hline
  velocity.x, .y, .z                  & Normalized velocity component             & lat, beam   & Yes \\ \hline
