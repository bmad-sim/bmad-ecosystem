...
%%  \begin{description}
%%    \item[base] \Newline
%%  The value of the datum as calculated from the base lattice (\sref{s:universe}).
%%    \item[data_source] \Newline
%%  The \vn{data_source} component specifies where the data is 
%%  coming from (\sref{s:data.source}).
...
%%    \item[design] \Newline
%%  The value of the datum as calculated from the design lattice (\sref{s:universe}).
%%    \item[ele_name] \Newline
%%  Name of the associated lattice element where the datum is evaluated. Also see
%%  \vn{eval_point} and \vn{s_offset} components.
...
There is a similar multiplyer defined for the reference data. The values of these two
multiplyers are shown with the \vn{show data} command.
...
\begin{longtable}{lll} 
  ...
  \begin{tabular}{@{}l}
    ...
    ping_a.amp_y, ping_a.phase_y \\
  \end{tabular}                       & Phase and amplitude of $a$-mode response      & lat      \\ \hline

  \begin{tabular}{@{}l}
    ping_b.amp_x, ping_b.phase_x \\
    ping_b.amp_y, ping_b.phase_y \\
  \end{tabular}                       & Phase and amplitude of $b$-mode response      & lat      \\ \hline
