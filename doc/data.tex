...
Photon phases in the horizontal and vertical planes.
  ...
  \item[ping_a.amp_x, .phase_x, .amp_sin_y, .amp_cos_y, .amp_sin_rel_y, .amp_cos_rel_y] \Newline
...
coupling so that \vn{ping_a.amp_rel_x} and \vn{ping_a.phase_rel_x} can be directly related to the
...
multipliers are shown with the \vn{show data} command.
  ...
  \item[ping_b.amp_y, .phase_y, .amp_sin_x, .amp_cos_x, .amp_sin_rel_x, .amp_cos_rel_x] \Newline
