...
\begin{example}
  ...
  ele_start_name   ! Character: Name of starting lattice element when there is a range.
...
\vn{unstable_orbit} is used for linear lattices. For single particle
...
\begin{example}
  \{[<universe_range>]@\}dat:\{<source>\}:<datum_type>[\{<ix_ele_start>&<ix_ele>]\{|<component>\}
\end{example}
