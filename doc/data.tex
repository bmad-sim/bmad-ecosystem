...
\vn{data_source} is ignored.  For example:
\begin{example}
...
With the \vn{rad_int.xxx} datums, the integral if from \vn{ele_ref} to \vn{ele}.
\begin{example}
...
\begin{longtable}{llll} 
  ...
  bunch_max.x, .px, .y, .py, .z, .pz  & Max coordinate relative to bunch centroid     & beam        & No \\ \hline
  bunch_min.x, .px, .y, .py, .z, .pz  & Min coordinate relative to bunch centroid     & beam        & No \\ \hline
