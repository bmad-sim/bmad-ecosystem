...
\vn{"lattice"}. Some datum types, like the floor position of an element,
only make sense with a \vn{"lattice"} \vn{data_source}. Other types, like
\vn{dpx_dx}, only make sense with a \vn{"beam"} \vn{data_source}. There
is a third class of data types, like \vn{emit.a} that can take a
\vn{"lattice"} or \vn{"beam"} \vn{data_source}. It is important to keep
in mind that with this third case, such datums will have a different
value depending upon what \vn{data_source} is used.
...
\begin{tabular}{|l|l|l|} \hline
  ...
  monitor\_orbit.x, monitor\_orbit.y  & Measured orbit             &          \\ \hline
  monitor\_phase.a, monitor\_phase.b  & Measured betatron phase    &          \\ \hline
  monitor\_eta.x, monitor\_eta.y      & Measured dispersion        &          \\ \hline
\begin{tabular}{@{}l}
  monitor\_k.22a, monitor\_k.12a, \\
  monitor\_k.11b, monitor\_k12b
\end{tabular}
                              & Measured coupling                  &          \\ \hline
\begin{tabular}{@{}l}
  monitor\_cbar.22a, monitor\_cbar.12a, \\
  monitor\_cbar.11b, monitor\_cbar12b
\end{tabular}
                              & Measured coupling                  &          \\ \hline
...
\vn{beta.y} are beam prejected beta functions defined by
\begin{equation}
