...
\vn{data_source} (\sref{s:init.data}) and Table~\ref{t:data.lattice}
lists the predefined data types in \tao that are valid for a
\vn{"lattice"} \vn{data_source}.
...
The apparent emittances \vn{apparent_emit.x} is
\begin{equation}
...
and \vn{emit.b} are the standard normal mode emittances. \vn{emit.a}
and \vn{emit.b} are the \vn{projected emittances}:
\begin{equation}
...
\begin{tabular}{ll} \hline
  {\it Data\_Type}                & {\it Description}                       \\ \hline\hline
  ...
  emit.a, emit.b, emit.c          & Normal mode emittance                   \\ \hline
  emit.x, emit.y, emit.z          & Projected emittance                     \\ \hline
  ...
  norm\_emit.a, norm\_emit.b, norm\_emit.c 
                                  & Energy normalized normal-mode emittance \\ \hline 

  norm\_emit.x, norm\_emit.y, norm\_emit.z
                                  & Energy Normalized projected emittance   \\ \hline 
  ...
  photon.intensity_x, photon.intensity_y
                                  & Photon intensity                        \\ \hline
  photon.intensity                & Photon total intensity                  \\ \hline 
  photon.phase_x, photon.phase_y  & Photon phase                            \\ \hline
...
\begin{longtable}{ll} 
  ...
  apparent_emit.x, apparent_emit.y, apparent_emit.z 
                                 & Apparent emittance                 \\ \hline
  beta.a, beta.b                 & Normal-mode beta function          \\ \hline 
