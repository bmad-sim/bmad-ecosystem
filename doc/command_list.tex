...
\begin{example}
  ...
  output beam \{<file_name>\}              ! Write beam distribution data.
...
middle use the \vn{show lattice middle} command. To customize the output
use the command \vn{show lattice custom <file_name>}. The customization
file looks like:
\begin{example}
  &custom_show_lat
    column(1) = "index",   "i6",     6 
