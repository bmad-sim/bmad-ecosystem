...
\begin{tabular}{|l|l||l|l|} \hline
  ...
  change     & \sref{s:change}   & run          & \sref{s:run}      \\ \hline 
...
switch or by specifying a location range.  The \vn{-elements} switch
is used specify elements using a \vn{class:name} format
(\sref{s:class:name}). For example:
\begin{example}
