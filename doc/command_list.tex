...
curve} will produce two files: A file
...
\vn{<file_name>.particle_dat} may be produced if particle
...
only the particle positions at the given element are written. Otherwise
the positions at all elements will be written. In this case
the variable \vn{global%save_beam_everywhere = T} 
should be set in the initialization file to force the
saving of the bunch particle positions at the end of every element. 
The \vn{-binary} switch is for writing compressed binary files.
Note: This file
