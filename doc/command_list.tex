...
\begin{example}
  ...
  output bunch \{<file_name>\}              ! Write bunch distributsion data.
...
even if it has one. To see this map use the \vn{show taylor} command.
...
Format:
\begin{example}
  xy-scale \{<where>\} \{<bound1>\} \{<bound2>\} \{force\} ! sets horizontal and vertical axis bounds.
\end{example}
