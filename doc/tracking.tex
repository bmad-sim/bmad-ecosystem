...
tracking particles and a particle is characterized by its phase space coordinates.
...
Particle tracking can be divided into ``single particle'' trackig and ``beam''
