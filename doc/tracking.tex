...
\toprule
 ...
 \midrule
1: Forward  			& F &  \vn{x_plane\$}	& \vn{exit_end\$}  \\
2: Element kicks backwards & T &  \vn{z_plane\$} &\vn{live_reversed\$} \\
3: Hits interior wall & T &  \vn{x_plane\$} &\vn{between_ends\$} \\
4: Backwards & T &  \vn{z_plane\$} &\vn{live_reversed\$} \\
5: Backwards kicked forward & F &  \vn{z_plane\$} &\vn{exit_end\$} \\
\bottomrule
\end{tabular*}
\label{tab:}
\end{table}
