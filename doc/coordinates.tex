...
coordinates. Tracking from the the nominal upstream end to the actual upsteam face of the element
...
\end{equation}
The positions $x$, $y$, and $z$ are the same as with phase space
