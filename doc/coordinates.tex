...
shift in the reference coordinates from the entrance end to the exit end of the element is
...
and \eq{wws} with \Eqs{ltl} and \eq{lra1} with the substitution $\alpha_b \rightarrow (L/2
- s)/\rho$.
