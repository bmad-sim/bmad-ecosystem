...
L/2$. The second sub-transformation is given by \Eqs{swww} above.  The
...
and the bend position (\sref{ss:bend.orient}). The sub-transformation at
...
sub-transformation is given by \Eqs{lcmis}. The last sub-transformaion is from
