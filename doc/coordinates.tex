...
%-----------------------------------------------------------------------------
\subsection{Tracking in the Reversed Direction}

\bmad has the capability of tracking particles backwards in $S$ from the end of the
lattice to the beginning. In all cases, tracking is always forward in time. The canonical
...
$s_1$, the particle following the same transverse orbit backwards as forwards, the initial
