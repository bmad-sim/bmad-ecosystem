...
The geometry shown here is appropriate for a \vn{ref_tilt} angle of $\theta_t =
...
graze angle parameters and is independent of all other parameters such
...
user. For a crystal, the graze angles are calculated so that the
reference trajectory is in the middle of the Darwin curve. Calculation
of the graze angles for a crystal is given in
