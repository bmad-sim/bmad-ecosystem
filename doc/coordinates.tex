...
form a plane which is called the element's \vn{bend plane}.
...
\begin{align}
  ...
  \label{zbctt}
\end{align}
$t(s)$ is the time at which the particle is at position $s$, $t_0(s)$ is the
...
$\beta \, c \, t$ is just the path length. In this case, the change in
