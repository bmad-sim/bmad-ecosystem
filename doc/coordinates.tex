...
$theta_g$ is the graze angle of the incomming reference coordinates,
...
\Endeq
\index{y_pitch}
where $theta_x$ is the value of \vn{x_pitch}. Finally, the $\Bf S$
...
\Begineq
  ...
  \end{pmatrix}
\Endeq
where $theta_y$ is the value of \vn{y_pitch}. 
...
The phase space coordinates for a photon are the same as for a particle with $v = c$. 
