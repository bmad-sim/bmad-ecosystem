...
aperture [m]                     & fint                             & multipass_ref_energy             & taylor_field                     \\
...
b_field [T]                      & grid_field                       & p0c [eV]                         & wall                             \\
bl_hkick [T*m]                   & h1 [1/m]                         & ptc_canonical_coords             & wrap_superimpose                 \\
bl_vkick [T*m]                   & h2 [1/m]                         & ptc_fringe_geometry              & x1_limit [m]                     \\
cartesian_map                    & hgap [m]                         & ptc_integration_type             & x2_limit [m]                     \\
create_jumbo_slave               & hgapx [m]                        & r0_elec [m]                      & x_limit [m]                      \\
csr_ds_step [m]                  & higher_order_fringe_type         & r0_mag [m]                       & x_offset [m]                     \\
csr_method                       & hkick                            & ref_origin                       & x_offset_tot [m]                 \\
cylindrical_map                  & integrator_order                 & ref_tilt [rad]                   & x_pitch                          \\
db_field [T]                     & is_on                            & ref_tilt_tot [rad]               & x_pitch_tot                      \\
delta_ref_time [sec]             & k1 [1/m$^2$]                     & reference                        & y1_limit [m]                     \\
descrip                          & k2 [1/m$^3$]                     & rho [m]                          & y2_limit [m]                     \\
dg [1/m]                         & l [m]                            & roll [rad]                       & y_limit [m]                      \\
ds_step [m]                      & l_chord [m]                      & roll_tot [rad]                   & y_offset [m]                     \\
e1 [rad]                         & l_sagitta [m]                    & scale_multipoles                 & y_offset_tot [m]                 \\
e2 [rad]                         & lord_pad1 [m]                    & space_charge_method              & y_pitch                          \\
e_tot [eV]                       & lord_pad2 [m]                    & spin_fringe_on                   & y_pitch_tot                      \\
ele_origin                       & lr_freq_spread [Hz]              & spin_tracking_method             & z_offset [m]                     \\
exact_multipoles                 & lr_self_wake_on                  & sr_wake                          & z_offset_tot [m]                 \\
 \bottomrule
 \end{tabular}
 \vfill
