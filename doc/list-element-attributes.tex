...
b2_gradient [T/m$^2$]            & g_err [1/m]                      & offset_moves_aperture            & type                             \\
b_field [T]                      & grid_field                       & p0c [eV]                         & vkick                            \\
b_field_err [T]                  & h1 [1/m]                         & ptc_canonical_coords             & wall                             \\
...
hkick                            & py_aperture_center               & wall                             &                                  \\
 ...
 \begin{tabular}{llll} \toprule
alias                            & ele_origin                       & ref_origin                       & x_offset_tot [m]                 \\
alpha_a_out [???]                & eta_x_out [m]                    & reference                        & x_pitch                          \\
alpha_b_out [???]                & eta_y_out [m]                    & species_out [???]                & x_pitch_tot                      \\
angle_out_max [rad]              & etap_x_out                       & spin_tracking_method             & y1_limit [m]                     \\
aperture [m]                     & etap_y_out                       & superimpose                      & y2_limit [m]                     \\
aperture_at                      & is_on                            & tilt [rad]                       & y_limit [m]                      \\
aperture_type                    & l [m]                            & tilt_tot [rad]                   & y_offset [m]                     \\
beta_a_out [???]                 & mat6_calc_method                 & tracking_method                  & y_offset_tot [m]                 \\
beta_b_out [???]                 & offset [m]                       & type                             & y_pitch                          \\
create_jumbo_slave               & offset_moves_aperture            & wall                             & y_pitch_tot                      \\
delta_ref_time [sec]             & p0c [eV]                         & x1_limit [m]                     & z_offset [m]                     \\
descrip                          & pc_out_max [eV]                  & x2_limit [m]                     & z_offset_tot [m]                 \\
distribution [???]               & pc_out_min [eV]                  & x_limit [m]                      &                                  \\
e_tot [eV]                       & ptc_integration_type             & x_offset [m]                     &                                  \\
 \bottomrule
 \end{tabular}
 \vfill
...
l [m]                            & tilt [rad]                       & x_pitch_tot                      &                                  \\
 ...
 \begin{tabular}{llll} \toprule
alias                            & lr_self_wake_on                  & sr_wake_file                     & x_offset_tot [m]                 \\
aperture [m]                     & lr_wake                          & superimpose                      & x_pitch                          \\
aperture_at                      & lr_wake_file                     & tilt [rad]                       & x_pitch_tot                      \\
aperture_type                    & mat6_calc_method                 & tilt_calib [rad]                 & y1_limit [m]                     \\
create_jumbo_slave               & n_sample                         & tilt_tot [rad]                   & y2_limit [m]                     \\
crunch [rad]                     & noise                            & tracking_method                  & y_gain_calib [m]                 \\
crunch_calib [rad]               & offset [m]                       & type                             & y_gain_err [m]                   \\
de_eta_meas                      & offset_moves_aperture            & wall                             & y_limit [m]                      \\
delta_ref_time [sec]             & osc_amplitude [m]                & x1_limit [m]                     & y_offset [m]                     \\
descrip                          & p0c [eV]                         & x2_limit [m]                     & y_offset_calib [m]               \\
e_tot [eV]                       & ptc_integration_type             & x_gain_calib [m]                 & y_offset_tot [m]                 \\
ele_origin                       & ref_origin                       & x_gain_err [m]                   & y_pitch                          \\
is_on                            & reference                        & x_limit [m]                      & y_pitch_tot                      \\
l [m]                            & spin_tracking_method             & x_offset [m]                     & z_offset [m]                     \\
lr_freq_spread [Hz]              & sr_wake                          & x_offset_calib [m]               & z_offset_tot [m]                 \\
 \bottomrule
 \end{tabular}
 \vfill
