...
\Begineq
  ...
  \qquad \text{[forward_diffracted or bragg_diffracted]}
\Endeq
$\bfL$ is thus
\Begineq
  \bfL = \frac{t^2}{d\bfKbar \dotproduct \Bf t} \, d\bfKbar
\Endeq
...
reference orbit is following the \vn{forward diffracted} beam, the
