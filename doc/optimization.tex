...
should be chosen large enough so that round-off errors will not make
...
larger areas of variable space but the trade off is that this will make
it harder to find minimum in the locally. One good strategy is to vary
...
the \vn{lm} optimizer. For this reason, and to facilitate changing
