...
\Begineq
  D = 
    ...
    \end{cases}
\Endeq
The equation used to cacluate \vn{delta} is determined by two global logicals called
...
(\vn{CBL}) analysis. To do a CBL analysis, the \vn{common_base_lat}
...
parmeters. A single variable will control that particular parameter in
...
sets, hense the number of universes, can be very large), \tao does
...
sense when applield to the data in the common universe, The
...
it is assumed that the structure of the data arrrays is identical from
