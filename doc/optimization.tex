...
and the average is evaluated assuming linear vaiation between points.
%
...
integral is evaluated assuming linear vaiation between points.
%
...
and the RMS is evaluated assuming linear vaiation between points.
\end{description}
