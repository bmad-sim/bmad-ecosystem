...
\vn{data_types} are given in table~\ref{t:cons}. Macroparticle specific data
types are only applicable if tracking macroparticles.
\begin{table}[h] 
\centering 
{\tt
\begin{tabular}{|l|l|l|} \hline
...
\end{tabular}
    ...
    t:$ijk$           & 
\begin{tabular}{l}
  Term in 2nd order transfer map \\
   $1 \le i,j,k \le 6$
\end{tabular} 
                                                              & relative \\ \hline 
...
\begin{tabular}{@{}l}     norm\_emittance:x \\ 
                          norm\_emittance:y \end{tabular} 
                      & Macroparticle normalized emittance    &          \\ \hline 
\begin{tabular}{@{}l}     bunch\_alpha:x, bunch\_beta:x \\ 
                          bunch\_alpha:y, bunch\_beta:y \\
                                            \end{tabular} 
                      & Macroparticle bunch twiss parameters &          \\ \hline 
\begin{tabular}{@{}l}     bunch\_sigma:x, bunch\_sigma:p\_x \\ 
                          bunch\_sigma:y, bunch\_sigma:p\_y \\
                          bunch\_sigma:z, bunch\_sigma:p\_z \\
                                            \end{tabular} 
                      & Macroparticle bunch size              &          \\ \hline 
\end{tabular}
} 
