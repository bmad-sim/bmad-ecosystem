...
\vn{cycles} must be greater than the number of variables. Again, like \vn{lm}, this method will only
find local minimum.
  \index{de optimizer}
  \item{\vn{de}} \Newline
...
should be checked to make sure that the \vn{step} is not too small so that round-off is a problem
