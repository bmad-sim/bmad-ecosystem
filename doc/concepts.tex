...
\vn{<param_name>} will be a datum type from
Tables~\ref{t:data.lattice1} and \ref{t:data.lattice2} with a \vn{lat}
source and Table~\ref{t:data.beam} for a \vn{beam} source. Element
list format (\sref{s:ele.list.format}) is used for the
