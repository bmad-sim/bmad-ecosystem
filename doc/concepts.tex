...
Besides physical elements, there are \vn{controller} elements
...
lattice may contain \vn{controller elements} (\sref{s:lattice} which
...
simulate forking beam lines (\sref{s:branching}) such as a connections
