...
\vn{minor_slave} elements are elements that are not \vn{slice_slave}s and do not have a
\vn{major} lord. Major lords are \vn{super_lord}s and \vn{multipass_lord}s. \vn{minor_slave}s
will have at least one \vn{overlay_lord}, \vn{group_lord}, or \vn{girder_lord}.
  \item[free]\Newline
