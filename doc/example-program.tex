...
\begin{figure}[htp]
\Hyperref{r:bmad.parser}{bmad_parser}
\Hyperref{r:twiss.at.start}{twiss_at_start}
\Hyperref{r:twiss.propagate.all}{twiss_propagate_all}
\Hyperref{r:lat.ele.locator}{lat_ele_locator}
\Hyperref{r:type.ele}{type_ele}
\index{ele_struct}
\index{lat_struct}
