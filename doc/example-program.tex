...
in line 22 is needed for \bmad to correctly do the necessary lattice
bookkeeping (\sref{s:lat.bookkeeping}). The call to
...
Making \vn{examples} the working directory, the \vn{mk} command will
compiling and link the program.  The executable,
\vn{simple_bmad_program} is to be found in \vn{../productionbin/}
directory. Go to the \vn{simple_bmad_program} directory and run the
program with the command
\vn{../../production/bin/simple_bmad_program}.  This gives the output
as shown in \fig{f:output}.
