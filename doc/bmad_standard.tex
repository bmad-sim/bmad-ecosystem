...
beam of particles moving in the opposite direction. The opposing beam, called the
``strong'' beam, is assumed to be Gaussian in shape. In the \vn{bmad_standard}
calculation, the kick on the tracked particle is computed using the
