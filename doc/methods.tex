...
\begin{sideways}\vn{Runge_Kutta$^d$}\end{sideways} &
...
\begin{sideways}\vn{Time_Runge_Kutta$^d$}\end{sideways}
\\ \midrule
%                               BS   C   L   M   RK    SLB   SLP    T   TRK
  ...
  \vn{wiggler} (periodic type) & D & X & X &   &X$^b$&X$^b$&X$^b$&D$^b$&    \\ 
  \bottomrule
  ...
  \multicolumn{10}{l}{$^d$Includes fixed step versions.}                    \\
\end{tabular}
}
...
order 1~GeV to 10~GeV and with damping times on the order of 10,000 turns, The \vn{bmad_standard}
