...
\index{runge_kutta!tracking method}
\item[\vn{runge_kutta}]
...
\index{symp_lie_Bmad!tracking method}
...
\index{time_runge_kutta!tracking method}
\item[\vn{Symp_Map}]
...
\\ \midrule
%                               AB  BS   B   C   L   M   RK    SLB   SLP   SM     T   TRK
  \vn{ab_multipole}            &   & D &   & X & X &   &     &     &  X  &  X  &  X  &    \\  
  \vn{beambeam}                &   & D &   & X & X &   &     &     &     &     &     &    \\  
  \vn{bend_sol_quad}           &   &   &   & X &   &   &     &  D  &     &     &     &    \\  
  \vn{capillary}               &   & D &   & X &   &   &     &     &     &     &     &    \\  
  \vn{crystal}                 &   & D &   & X &   &   &     &     &     &     &     &    \\  
  \vn{custom}                  & X &   & X & D & X &   &  X  &     &     &     &     & X  \\  
  \vn{drift}                   & X & D & X & X & X & X &  X  &     &  X  &  X  &  X  & X  \\  
  \vn{e_gun}                   & X &   & X & X &   &   &  D  &     &     &     &     & X  \\  
  \vn{ecollimator}             & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\  
  \vn{elseparator}             & X & D & X & X & X & X &  X  &     &  X  &  X  &  X  & X  \\  
  \vn{em_field}                & X &   & X & X &   &   &  D  &     &     &     &     & X  \\  
  \vn{hkicker}                 & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\  
  \vn{instrument}              & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\  
  \vn{kicker}                  & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\  
  \vn{lcavity}                 & X & D & X & X & X &   &  X  &  X  &     &     &  *  & X  \\  
  \vn{marker}                  &   & D &   & X & X &   &     &     &  X  &  X  &  X  &    \\  
  \vn{match}                   &   & D &   & X &   &   &     &     &     &     &  *  &    \\ 
  \vn{monitor}                 & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\  
  \vn{mirror}                  &   & D &   & X &   &   &     &     &     &     &     &    \\  
  \vn{multipole}               &   & D &   & X & X &   &     &     &  X  &  X  &  X  &    \\  
  \vn{multilayer}              &   & D &   & X &   &   &     &     &     &     &     &    \\  
  \vn{octupole}                & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\ 
  \vn{patch}                   &   & D &   & X &   &   &     &     &     &     &  *  &    \\ 
  \vn{quadrupole}              & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X  & X  \\ 
  \vn{rbend}                   &   & D &   & X & X & X &     &     &  X  &  X  &  X  &    \\ 
  \vn{rcollimator}             & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\ 
  \vn{rfcavity}                & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X  & X  \\ 
  \vn{sbend}                   &   & D &   & X & X & X &     &     &  X  &  X  &  X  &    \\ 
  \vn{sextupole}               & X & D & X & X & X & X &  X  &     &  X  &  X  &  X  & X  \\ 
  \vn{solenoid}                & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X  & X  \\ 
  \vn{sol_quad}                & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X  & X  \\ 
  \vn{taylor}                  &   & D &   & X & X &   &     &     &     &     &     &    \\ 
  \vn{vkicker}                 & X & D & X & X & X &   &  X  &     &  X  &  X  &  X  & X  \\ 
  \vn{wiggler} (map type)      & X & D & X & X & X &   &  X  &  X  &  X  &  X  &  X  & X  \\ 
...
\index{custom!transfer map method}
\item[\vn{Custom}]
...
\index{MAD!transfer map method}
\item[\vn{MAD}]
This uses the MAD 2nd transfer map. Thanks must be given
to CERN and Frank Schmidt for permission to use the MAD tracking code
within \bmad.

\index{static!transfer map method}
\item[\vn{Static}]
