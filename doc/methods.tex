...
%                               AB  BS   B   C   L   M   RK    SLB   SLP   SM     T  
  ...
  \vn{patch}                   &   & D &   & X &   &   &     &     &     &     &  *   \\ 
  \vn{quadrupole}              & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X   \\ 
  \vn{rbend}                   &   & D &   & X & X & X &     &     &  X  &  X  &  X   \\ 
  \vn{rcollimator}             & X & D & X & X & X &   &  X  &     &  X  &  X  &  X   \\ 
  \vn{rfcavity}                & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X   \\ 
  \vn{sbend}                   &   & D &   & X & X & X &     &     &  X  &  X  &  X   \\ 
  \vn{sextupole}               & X & D & X & X & X & X &  X  &     &  X  &  X  &  X   \\ 
  \vn{solenoid}                & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X   \\ 
  \vn{sol_quad}                & X & D & X & X & X & X &  X  &  X  &  X  &  X  &  X   \\ 
  \vn{taylor}                  &   & D &   & X & X &   &     &     &     &     &      \\ 
