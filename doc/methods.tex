...
If the element \vn{static_mat6} parameter is set to \vn{True} (the default is \vn{False}, this
prevents the transfer matrix from being recomputed. For example, if a steering is changed which
shifts the reference orbit, the transfer matrix will, in general, vary but having \vn{static_mat6}
set to \vn{True} will prevent this variation.
