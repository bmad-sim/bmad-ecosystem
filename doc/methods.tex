...
Note: Taylor maps for \vn{match}, and
...
\vn{tracking_method}. If \vn{tracking_method} is set to \vn{boris},
\vn{runge_kutta}, or \vn{symp_lie_ptc}, the spin will be tracked along
with the phase space particle coordinates using the local fields. For
all other \vn{tracking_method}s, the spin will be tracked using the
