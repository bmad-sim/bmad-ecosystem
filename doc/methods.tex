...
%                               AB  BS   B   C   L   M   RK    SLB   SLP   SM     T  
  ...
  \vn{wiggler} (periodic type) &   & D &   & X & X &   &X$^a$&X$^a$&X$^a$&X$^a$&X$^a$ \\ \bottomrule
   \multicolumn{12}{l}{$^a$See \sref{s:wiggler.periodic.std} for more details} \\
\end{tabular}
} 
...
%                               BS   C   M   N   SLB   SLP   Tlr  Trk 
  ...
  \multicolumn{9}{l}{$^a$See \sref{s:wiggler.periodic.std} for more details} \\
\end{tabular}
}
