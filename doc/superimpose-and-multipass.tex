...
\begin{example}
  Q: quad, l = 4
  D: drift, l = 12
  S: solenoid, l = 8, superimpose, ref = Q, ele_beginning
...
determined by three factors: A reference point on the superimposed
element, a reference point on the reference element, and an offset between
...
lengths of element involved in superposition: The rule is that the
