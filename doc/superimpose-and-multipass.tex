...
\end{example}
\vn{center} is the default setting. \vn{Offset} is the longitudinal offset along the local reference
orbit (\sref{s:ref}) between the origin points. The default offset is zero.
