...
taken to be the top line $L_n$. The \vn{signature} of the elment is the list of (line, position)
pairs $(L_0, n_0)$, ..., $(L_m, n_m)$ and two elements have the same signature if this list is the
same for both. Elements that have the same signaturethe same physical element and are slaved
