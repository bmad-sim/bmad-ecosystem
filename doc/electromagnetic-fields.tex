...
fields using normal $b_{en}$ and skew $a_{en}$ components. In 
terms of these componenents, the electric field for the $n$\Th order
multipole is
\Begineq
...
The kick given a particle due to the electric field is
\begin{align}
  \frac{dp_x}{ds} &= \frac{q \, E_x}{P0}
  \etcetc
\end{align}
