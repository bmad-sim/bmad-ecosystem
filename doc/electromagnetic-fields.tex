...
%-----------------------------------------------------------------
\section{Magnetc and Electric Static Fields: Mode Decomposition}
\label{s:field.mode}
...
\begin{example}
  ...
  y
\end{example}
There are six possible forms that $\bfB_i$ can take. These six are
divided into three groups. Each group has two different forms
specified by plane. Basically, a seeting of \vn{plane} of \vn{x} means
...
The first group of forms is called ``\vn{hyper-y}'' since the vertical
dependence of the field is hyperbolic in nature. For \vn{plane} set to \vn{x}
the form is:
\begin{alignat}{4}
...
\end{alignat}
and for \vn{plane} set to \vn{y} the \vn{hyper-y} form is
\begin{alignat}{4}
...
\end{alignat}
and for \vn{plane} set to \vn{y} the \vn{hyper-xy} form is
\begin{alignat}{4}
...
The \vn{hyper-x} form for \vn{plane} set to \vn{x} is
\begin{alignat}{4}
...
\end{alignat}
and for \vn{plane} set to \vn{y} the \vn{hyper-x} form is
\begin{alignat}{4}
...
Maxwell's equations are satisfied. Notice that which form group,
\vn{hyper-y}, \vn{hyper-xy}, and \vn{hyper-x} a particular $\bfB_i$
belongs to can be computed by \bmad by seeing which relationship
between $k_x$, $k_y$, and $k_z$ is satisfied.
