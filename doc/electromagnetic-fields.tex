...
the regions to either side are treated as field free.
...
\begin{align}
  ...
  \label{egot3}
\end{align}
where $J_0$ and $J_1$ are Bessel functions. Note that with this mode alternating cells would
alternate between acceleration and deceleration. This being the case the number of cells in
this case is restricted by Bmad to one.
