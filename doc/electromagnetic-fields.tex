...
\begin{alignat}{4}
  ...
  B_s &= -&C \, &\dfrac{k_z}{k_y} & \cos(\kxx) \, \sinh(\kyy) \, \sin(\kzz) \label{cm1} \\
...
\begin{alignat}{4}
  ...
  B_s &= -&C \, &                 & \cosh(\kxx) \, \sinh(\kyy) \, \sin(\kzz) \label{cm2} \\
...
\begin{alignat}{4}
  ...
  B_s &= -&C \, &\dfrac{k_z}{k_x} & \cosh(\kxx) \, \sin(\kyy) \, \sin(\kzz) \label{cm3} \\
...
first form (remember, $k_y^2 = k_x^2 + k_z^2$ for this form and not
all $k$s can be zero), and $k_z$ must be non-zero for the second form,
and $k_x$ must be nonzero for the third form, The magnetic field is
always well defined even if one of the $k$s is zero.
