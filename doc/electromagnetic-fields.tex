...
generalized gradient field model is specified using the \vn{gen_grad_field} attribute as explained
in Sec.~\sref{s:gen.grad.field}.
...
\begin{equation}
  \psi_{m,\alpha} = \sum_{n = 0}^\infty \frac{-(-1)^n m!}{4^n \, n! \, (n+m)!} 
