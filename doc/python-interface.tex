...
\vn{global%force_plot_data_calc} set to True, to prevent unneeded computation, the
...
template plot with index 3. Similarly, the displayed plots that are associated with plot regions can be
referred to using the syntax ``\vn{@Rnnn}''.
