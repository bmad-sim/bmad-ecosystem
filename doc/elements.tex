...
\begin{figure}[tb]
  \centering
  \includegraphics[width=5in]{x-branch.pdf}
  \caption[Example showing X-ray lines branches.]
  {
Example use of \vn{photon_branch} elements showing four X-ray lines
branching from a machine.
  }
  \label{f:x.branch}
\end{figure}
...
Collectively \vn{branch} and \vn{photon_branch} elements are called
branching elements. An example geometry is shown in \fig{f:x.branch}.
...
\begin{example}
  ...
  br_ele: branch, to_line = ring            ! Branch elementto ring
  ring: line = (..., x_br, ..., x_br, ...)  ! Define the ring
  x_br: photon_branch, to_line = x_line     ! Branch element to x-ray line
