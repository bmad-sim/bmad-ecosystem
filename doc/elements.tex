...
determined by the setting of the \vn{interpolate} paramter which may be one of
\begin{example}
...
mode is 1, the wall radius is infinite and in this case \vn{wall_radius} is set to zero.
