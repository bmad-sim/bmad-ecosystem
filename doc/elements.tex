...
of the field was somewhat different. The old definition assumed
horizontal and vertical symmetry with an on-axis vertical magnetic
field. And there were only three different forms instead of the
present six. The old style \vn{hyper-y} form was
\begin{alignat}{5}
...
\Eqs{f1}, \eq{f2}, and \eq{f3} with \Eqs{cm2}, \eq{cm4}, and \eq{cm6}. In
...
\begin{example}
  term(1) = \{0.03*4/5, 3.00, 4.00, 5.00, 0.63, y\}    ! Old style
\end{example}
is equivalent to:
\begin{example}
