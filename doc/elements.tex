...
\end{example}
with similar equations for \vn{py}, \vn{z}, and \vn{pz}. For \vn{ecollimator}s, if \vn{px_aperture_width2}
and \vn{py_aperture_width2} are both nonzero, particles are collimated if
\begin{example}
...
same as for an \vn{rcollimator}. A similar situation occures for \vn{z} and \vn{pz}. 
