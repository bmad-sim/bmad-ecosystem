...
\sref{s:rf.time} and $t_0$ is the value of the \vn{t_offset} attribute.
...
\end{example}
where \vn{q_rel} is the charge of the particle relative to the charge of the reference particle.
\index{multipass}
