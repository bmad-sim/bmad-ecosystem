...
$\CalO_A$ is the reference coordinates at the upstream end of element
\vn{A}, $\CalO_C$ is the reference coordinates at the downsream end of
element \vn{C}, and $\CalO_G$ is the default reference coordinates of
the girder.
...
give the orientation of the element with respect to the
\vn{girder}. An example will make this clear:
\begin{example}
  q1: quad, l = 2
