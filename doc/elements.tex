...
the lattice. In the lattice, the elements \vn{<ele1>}, \vn{<ele2>},
etc. have to be consecutive. 
...
\end{example}
\begin{example}
  phi_particle = -z * rf_frequency / velocity  ! With relative time tracking (\sref{rf.time})
