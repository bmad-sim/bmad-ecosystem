...
\begin{example}
  ...
  l(internal) = 2 * arcsin(l_chord * g / 2) / g
...
\begin{example}
  l_ch = 0.54
  g_in = 1.52
  coef = asin(l_ch * g_in / 2) / g_in
  my_bend: rbend, l = l_ch, g = g_in
  my_overlay: overlay = {my_bend, my_bend[e1]/coef, my_bend[e2]/coef}, g = g_in
\end{example}
...
See Section \sref{s:lcav_phys} for more details.
