...
The \vn{include_fringe} switch toggles whether the fringe  fields are taken into account.
This is only used if the tracking method involves PTC (\sref{c:methods}).
