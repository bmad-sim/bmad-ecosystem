...
to \vn{match_end}. This attribute is not settable by the user and is used to reconstruct
the \vn{match_end} setting if a program creates a \bmad lattice file based upon the
original lattice plus any modifications the program makes.
...
When a lattice is read in, the \vn{match_end_orbit_input} attribute is set by \bmad to be equal
to \vn{match_end_orbit}. This attribute is not settable by the user and is used to reconstruct
the \vn{match_end_orbit} setting if a program creates a \bmad lattice file based upon the
original lattice plus any modifications the program makes.
