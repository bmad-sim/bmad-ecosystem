...
\begin{example}
  ...
  phi_a           = <Real>      ! Output a-mode phase.
  phi_b           = <Real>      ! Output b-mode phase.
...
\vn{electron}s are the reference particles. Additionally, the reference momentum of the
\vn{post_linac} line is set. It is not manditory for the reference particle of the branch containing
the \vn{converter} to be the same as the \vn{species_out} parameter of the converter itself though
typically this will be what is wanted.
