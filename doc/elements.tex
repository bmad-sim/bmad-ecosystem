...
addition, couplers (\sref{s:rf.couplers}) and HOM wakes
(\sref{s:rf.wakes} can be modeled.

If a field map is specified (\sref{s:rf.fields}), tracking using  
an integrator is possible.
...
Couplers (\sref{s:rf.couplers}) and HOM wakes (\sref{s:rf.wakes} can
