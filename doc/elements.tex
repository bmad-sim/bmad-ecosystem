...
\begin{tabular}{llll} \toprule
  ...
  a$n$, b$n$ multipoles      & \ref{s:multip}  & Offsets \& tilt            & \ref{s:offset}  \\
  Aperture limits            & \ref{s:limit}   & Length                     & \ref{s:l}       \\
  Chamber wall               & \ref{s:wall}    & Is_on                      & \ref{s:is.on}   \\ 
  Description strings        & \ref{s:alias}   & Tracking \& transfer map   & \ref{c:methods} \\
  Reference energy           & \ref{s:energy}  &                            &                 \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section           & {\sl Attribute Class}      & Section         \\ \midrule
  Mag \& Elec multipoles     & \ref{s:multip}    & Integration settings       & \ref{s:integ}   \\
  ...
  Field table or map         & \ref{s:em.fields} & Reference energy           & \ref{s:energy}  \\ 
  Fringe fields              & \ref{s:fringe}    & Symplectify                & \ref{s:symp}    \\
  Hkick \& Vkick             & \ref{s:kick}      & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}  & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Description strings    & \ref{s:alias}   & Capillary Wall         & \ref{s:wall}        \\
  Reference energy       & \ref{s:energy}  & Offsets, Pitches \& Tilt   & \ref{s:offset}  \\ 
  Aperture limits        & \ref{s:limit}   & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Aperture limits        & \ref{s:limit}   & Length                     & \ref{s:l}       \\
  Symplectify            & \ref{s:symp}    & Integration settings       & \ref{s:integ}   \\
  Hkick \& Vkick         & \ref{s:kick}    & Chamber wall               & \ref{s:wall}    \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Surface Properties         & \ref{s:s.curve} &                            &                 \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Field table or map     & \ref{s:em.fields} & Reference energy           & \ref{s:energy}  \\ 
  Fringe fields          & \ref{s:fringe}    & Symplectify                & \ref{s:symp}    \\
  Integration settings   & \ref{s:integ}     & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Chamber Wall               & \ref{s:wall}    & Detector Geometry          & \ref{s:surf.grid} \\
  Description strings        & \ref{s:alias}   & Tracking \& transfer map   & \ref{c:methods}   \\
  Offsets, pitches \& tilt   & \ref{s:offset}  &                            &                   \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Aperture limits            & \ref{s:limit}   & Mask geometry              & \ref{s:wall}    \\
...
\begin{tabular}{llll} \toprule
  ...
  Length                 & \ref{s:l}       & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}  & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Symplectify            & \ref{s:symp}    & Offsets, pitches \& tilt   & \ref{s:offset}  \\
  Description strings    & \ref{s:alias}   & Is_on                      & \ref{s:is.on}   \\ 
  Reference energy       & \ref{s:energy}  & Tracking \& transfer map   & \ref{c:methods} \\
  Aperture limits        & \ref{s:limit}   & Length                     & \ref{s:l}       \\
  Hkick \& Vkick         & \ref{s:kick}    & Mag \& Elec multipoles      & \ref{s:multip}  \\
  Integration settings   & \ref{s:integ}   & Chamber wall               & \ref{s:wall}    \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\index{autoscale_phase}\index{autoscale_amplitude}
\begin{example}
  autoscale_phase     = <Logical>  ! Automatic phase scaling (\sref{s:autoscale}).
  autoscale_amplitude = <Logical>  ! Automatic amplitude scaling (\sref{s:autoscale}).
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}  & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Aperture limits        & \ref{s:limit}   & Reference energy           & \ref{s:energy}  \\
  Description strings    & \ref{s:alias}   & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Aperture limits            & \ref{s:limit}   & Length                     & \ref{s:l}       \\
  Chamber wall               & \ref{s:wall}    & Tracking \& transfer map   & \ref{c:methods} \\
  Description strings        & \ref{s:alias}   & Is_on                      & \ref{s:is.on}   \\ 
  Reference energy           & \ref{s:energy}  &                            &                 \\ \bottomrule
\end{tabular}
\end{center}
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Description strings        & \ref{s:alias}   & Length                     & \ref{s:l}       \\
  Is_on                      & \ref{s:is.on}   & Offsets, pitches \& tilt   & \ref{s:offset}  \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\end{example}
A \vn{girder} element will be created for each section of the lattice where there is a
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}  & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Description strings    & \ref{s:alias}   &                            &                 \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Aperture limits        & \ref{s:limit}       & Length                     & \ref{s:l}       \\
  Description strings    & \ref{s:alias}       & Is_on                      & \ref{s:is.on}   \\ 
  Integration settings   & \ref{s:integ}       & Hkick \& Vkick             & \ref{s:kick}    \\
  Instrumental variables & \ref{s:meas.attrib} & Chamber wall               & \ref{s:wall}    \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Description strings        & \ref{s:alias}     & Reference energy           & \ref{s:energy}     \\ 
  Field table or map         & \ref{s:em.fields} & RF Couplers                & \ref{s:rf.coupler} \\
  Fringe Fields              & \ref{s:fringe}    & Wakes                      & \ref{s:wakes}      \\
  Hkick \& Vkick             & \ref{s:kick}      & Symplectify                & \ref{s:symp}       \\
  Integration settings       & \ref{s:integ}     & Tracking \& transfer map   & \ref{c:methods}    \\
  Is_on                      & \ref{s:is.on}     &                            &                    \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
(\sref{s:autoscale}). The default value for \vn{field_factor} is 1.
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section             & {\sl Attribute Class}      & Section         \\ \midrule
  Aperture limits            & \ref{s:limit}       & Instrumental variables     & \ref{s:meas.attrib} \\
  Chamber wall               & \ref{s:wall}        & Is_on                      & \ref{s:is.on}   \\ 
  Description strings        & \ref{s:alias}       & Offsets \& tilt            & \ref{s:offset}  \\
  Reference energy           & \ref{s:energy}      & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Aperture limits        & \ref{s:limit}   & Length                     & \ref{s:l}       \\
  Description strings    & \ref{s:alias}   & Is_on                      & \ref{s:is.on}   \\ 
  Reference energy       & \ref{s:energy}  & Integration settings       & \ref{s:integ}   \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Offsets, pitches \& tilt   & \ref{s:offset}  & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Chamber wall               & \ref{s:wall}    & Is_on                      & \ref{s:is.on}   \\ 
  Description strings        & \ref{s:alias}   & Offsets, pitches \& tilt   & \ref{s:offset}  \\
  K$n$L, T$n$ multipoles     & \ref{s:multip}  & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section           & {\sl Attribute Class}      & Section         \\ \midrule
  Magnetic multipoles        & \ref{s:multip}    & Integration settings       & \ref{s:integ}   \\
  Aperture limits            & \ref{s:limit}     & Length                     & \ref{s:l}       \\
  Chamber wall               & \ref{s:wall}      & Offsets, pitches \& tilt   & \ref{s:offset}  \\
  Description strings        & \ref{s:alias}     & Reference energy           & \ref{s:energy}  \\ 
  Fringe Fields              & \ref{s:fringe}    & Tracking \& transfer map   & \ref{c:methods} \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Reference energy       & \ref{s:energy}  & Offsets \& tilt            & \ref{s:offset}  \\ \bottomrule
\end{tabular}
\end{center}
\toffset
...
\vn{<coef>} from \vn{<e1>}, while the second form uses a vertical bar
``|'' to separate \vn{<coef>} from \vn{<n1>}.

A Taylor term has a corfficient \vn{<coef>} which is a real number,
...
A \vn{taylor} element that is ``turned off'' (\vn{is_on} attribute set
to False), is considered to be like a \vn{marker} element. That is,
the orbit and twiss parameters are unchanged when tracking through
a \vn{taylor} element that is turned off.
...
decomposition of Sec.~\sref{s:cart.mode}. 
...
A \vn{\{<Wig_Term>\}} has the form (see \Eqs{cm1} through \eq{cm6}):
\Begineq
  \{ C, k_x, k_y, k_z, x_0, y_0, \phi_z, \text{plane} \}
\Endeq
...
\vn{Note:} When the wiggler model was first developed, the definition
of the field was somewhat different. The old definition used only the three forms
with \vn{plane} set to \vn{y} and there was a different normalization convention.
The old style \vn{hyper-y} form was
\begin{alignat}{5}
...
\Eqs{f1}, \eq{f2}, and \eq{f3} with \Eqs{cm4}, \eq{cm5}, and \eq{cm6}. In
a lattice file, the old field definition will be used if a
\vn{\{<Wig_Term>\}} has just 5 numbers:
\Begineq
  \text{term(i)} = \{ \wt C, k_x, k_y, k_z, \phi_z \}
\Endeq
