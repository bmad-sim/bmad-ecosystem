...
\begin{tabular}{|l|l||l|l|} \hline
  ...
  Diffraction_Plate  & \ref{s:diff_plate}    &  Mirror             & \ref{s:mirror}     \HH
...
\label{s:diffraction_plate
\index{diffraction_plate|hyperbf}

\begin{figure}[tb]
  \centering
  \includegraphics[width=5in]{diffraction_plate.pdf}
...
\fig{f:section.ele}B where the section is not star shapped since a
