...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section           & {\sl Attribute Class}      & Section         \\ \midrule
  Mag \& Elec multipoles     & \ref{s:multip}    & Is_on                      & \ref{s:is.on}   \\
  ...
  Field customization        & \ref{s:em.fields} & Symplectify                & \ref{s:symp}    \\
  Fringe fields              & \ref{s:fringe}    & Tracking \& transfer map   & \ref{c:methods} \\ 
  Hkick \& Vkick             & \ref{s:kick}      &                            &                 \\
  \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Field customization        & \ref{s:em.fields} & Reference energy           & \ref{s:energy}  \\ 
...
\begin{tabular}{llll} \toprule
  ...
  Chamber wall               & \ref{s:wall}      & Offsets, pitches \& tilt   & \ref{s:offset}  \\
  Description strings        & \ref{s:alias}     & Reference energy           & \ref{s:energy}  \\ 
  Field customization        & \ref{s:em.fields} & Superposition              & \ref{s:super}   \\
  Fringe fields              & \ref{s:fringe}    & Symplectify                & \ref{s:symp}    \\
  Is_on                      & \ref{s:is.on}     & Tracking \& transfer map   & \ref{c:methods} \\ 
  \bottomrule
\end{tabular}
...
\begin{tabular}{llll} \toprule
  ...
  Chamber Wall               & \ref{s:wall}      & Reference energy           & \ref{s:energy}  \\
  Description strings        & \ref{s:alias}     & Superposition              & \ref{s:super}   \\
  Detector Geometry          & \ref{s:surf.grid} & Tracking \& transfer map   & \ref{c:methods} \\
...
\begin{tabular}{llll} \toprule
  {\sl Attribute Class}      & Section         & {\sl Attribute Class}      & Section         \\ \midrule
  Aperture limits            & \ref{s:limit}   & Superposition              & \ref{s:super}   \\
...
\begin{tabular}{llll} \toprule
  ...
  Is_on                      & \ref{s:is.on}   & Offsets, pitches \& tilt   & \ref{s:offset}  \\ 
  \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Field customization        & \ref{s:em.fields} & Superposition              & \ref{s:super}      \\
  Fringe Fields              & \ref{s:fringe}    & Symplectify                & \ref{s:symp}       \\
  Hkick \& Vkick             & \ref{s:kick}      & Wakes                      & \ref{s:wakes}      \\
  Is_on                      & \ref{s:is.on}     & Tracking \& transfer map   & \ref{c:methods}    \\
  Length                     & \ref{s:l}         &                            &                    \\
  \bottomrule
\end{tabular}
...
\begin{tabular}{llll} \toprule
  ...
  Aperture limits            & \ref{s:limit}   & Offsets, pitches \& tilt   & \ref{s:offset}  \\
  Description strings        & \ref{s:alias}   & Reference energy           & \ref{s:energy}  \\
  Is_on                      & \ref{s:is.on}   & Superposition              & \ref{s:super}   \\
  Mask geometry              & \ref{s:wall}    & Tracking \& transfer map   & \ref{c:methods} \\
  \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Description strings        & \ref{s:alias}   & Offsets, pitches \& tilt   & \ref{s:offset}  \\
  K$n$L, T$n$ multipoles     & \ref{s:multip}  & Tracking \& transfer map   & \ref{c:methods} \\ 
  \bottomrule
\end{tabular}
\end{center}
\toffset
...
\begin{tabular}{llll} \toprule
  ...
  Aperture limits            & \ref{s:limit}   & Symplectify                & \ref{s:symp}    \\
  Description strings        & \ref{s:alias}   & Offsets, pitches \& tilt   & \ref{s:offset}  \\
  Reference energy           & \ref{s:energy}  & Superposition              & \ref{s:super}   \\
  Surface Properties         & \ref{s:s.curve} & Tracking \& transfer map   & \ref{c:methods} \\
  \bottomrule
\end{tabular}
\end{center}
\toffset
...
global parameter \vn{bmad_com[sad_eps_scale]} (\sref{s:bmad.params}) may be set.
...
A \vn{\{<Wig_Term>\}} has the form (see \Eqs{cm1} through \eq{bsq}):
\Begineq
  \{ A, k_x, k_y, k_z, x_0, y_0, \phi_z, \text{family} \}
\Endeq
...
with \vn{family} set to \vn{y} and there was a different normalization convention.
...
In a lattice file, the old field definition will be used if a
