...
$\bfhat n$ and $\bH$ are all coplainer. The element reference coordinates
where $\bfhat x$ is parallel to the surface normal establishes the coordinates
for specifying a rotation of $\bH$ around the surface normal and specifying
a curveature of the surface.}
  \label{f:bend}
\end{figure}
