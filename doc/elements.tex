...
{Crystal element geometry. The geometry shown is appropriate for zero
...
\Endeq
and $\alpha_H$
(\vn{alpha_angle}) is the angle of the reciprical lattice $\bH$ vector
with respect to the surface normal as shown in Fig.~\ref{f:crystal}.
If 
