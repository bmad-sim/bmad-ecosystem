...
\begin{example}
  ...
  exact_multipole = <Logical>  ! Curved coordinate correction? Default False.
...
The \vn{exact_multipoles} logical determines if the multipole fields, both magnetic and
electric, and including \vn{k1} and\vn{k2}, are corrected for the finite curvature of the
reference orbit in a bend.  Default is \vn{False}.
