...
corresponding parameters used in the SAD program \cite{b:sad} is:
\begin{example}
...
\end{center}
\toffset
See \sref{s:list.crab_cavity} for a full list of element attributes.
...
The Hamiltonian  $H_{\text{crab}}$ for a thin crab cavity is
\Begineq
...
\Begineq
  k = \frac{2 \, \pi \, f_{rf}}{c}
\Endeq
Which give kicks \begin{align} \Delta p_x &= -\frac{\partial H_{\text{crab}}}{\partial x} =
\frac{q_{rel} \, V \, x}{P_0} \, \sin(k \, z + \phi_0) \CRNO \Delta p_z &= -\frac{\partial
H_{\text{crab}}}{\partial z} = \frac{q_{rel} \, V \, \, k \, x}{P_0} \, \cos(k \, z +
\phi_0) \end{align} Note: The sign of $H_{\text{crab}}$ used by Authors in the literature is not
