...
\etcetc.
When a lattice is read in, no\vn{ramper} slave parameters are not 
elements are ignored . To apply the ramper elements during\
lattice parsing, the \vn{apply_rampers} command (\sref{s:apply.ramp}) can be used.
