...
and \vn{yma}. \vn{x_pitch} and \vn{y_pitch} gives the beam--beam interaction a crossing
angle. \vn{x_pitch}, \vn{y_pitch} or some combination of the two should be set to the crossing angle
of the strong beam with respect to the reference orbit of the weak beam. To curve the strong beam controid to simulate crabbing, the following parameters can be used:
\begin{example}
  crab_x1,    crab_x2
  crab_x3,    crab_tilt
\end{example}
...
\end{equation}
With a finite \vn{crab_tilt}, the curvature is rotated around the $z$ axis as shown in
figure~\ref{f:tilt}.
