...
\begin{example}
  ...
  theta_origin    = <Real>    ! Absolute Reference orientation angle.
  phi_origin      = <Real>    ! Absolute Reference orientation angle.
  psi_origin      = <Real>    ! Absolute Reference orientation angle.
...
is specified, the absolute reference position attributes
