...
\vn{Group} elments are a type of \vn{control} element
(\sref{s:lord.slave}) used to make variations in the attributes of
other elements. For example, to simulate the action of a control room
knob that changes the beam tune in a storage ring, a \vn{Group} can be
used to vary the strength of selected quads in a specified
...
elements make changes to attribute values.
...
\begin{example}
  name: GROUP = \{ele1[attrib1]:coef1, ele2[attrib2]:coef2, ...\}, default_attrib = init_value
\end{example}
...
\vn{Overlay} elments are a type of \vn{control} element
(\sref{s:lord.slave}) used to make variations in the attributes of
other elements. For example, to simulate the action of a magnet power
supply that controls a string of magnets. Also see \vn{group}
...
\begin{example}
  name: OVERLAY = \{ele1[attrib1]:coef1, ele2[attrib2]:coef2, ...\}, default_attrib = init_value
\end{example}
...
as a \vn{grooup} element or for an \vn{overlay} element to control a
\vn{dependent} attribute (\sref{s:depend}).
