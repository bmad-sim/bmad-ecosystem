...
point and ending points are at the \vn{beambeam} element. For example, with \vn{n_slice} = 2 the
...
\begin{example}
  ...
  2. Propagate backwards to the center of the first slice.
  3. Apply the beam--beam kick due to the first slice.
  4. Propagate forwards to the center of the second slice.
  5. Apply the beam--beam kick due to the second slice.
  6. Propagate backwards to the body coordinate longitudinal center.
  7. Offsets, pitches and tilt are applied to convert from element body to 
       laboratory coordinates.
\end{example}
The \vn{ks} or \vn{bs_field} parameters can be used to set the field strength. If the beambeam
element is superimposed on top of a solenoid, the beambeam element will inherit the solenoid field.
