...
\begin{example}
  name: OVERLAY = \{ele1[attrib1]:coef1, ele2[attrib2]:coef2, ...\}, 
                                                       DEFAULT_ATTRIB = attrib_name
\end{example}
where \vn{ele1}[\vn{attrib1}], \vn{ele2}[\vn{attrib2}], etc. specify the slave attributes and
\vn{exp1}, \vn{exp2}, etc. are the arithmetical expressions, that are functions of \vn{var1},
\vn{var2}, etc., and are used to determine a value for the slave attributes. The \vn{default_attrib}
parameter, if present, sets the default attribute of a slave element if the attribute is not given.
...
\begin{example}
  name: RAMPER = \{ele1[attrib1]:coef1, ele2[attrib2]:coef2, ...\}, 
                                  VAR = \{var1\}, DEFAULT_ATTRIB = attrib_name
\end{example}
...
and are used to determine a value for the slave attributes. The \vn{default_attrib} parameter, if
present, sets the default attribute of a slave element if the attribute is not given.
