...
which output variable the Taylor term is associated with. \vn{<Out>}
is an integer in the range 1 to 6 for orbital phase space variables
(\vn{<out>} = 1 for $x$, etc.), and if the term is associated with
spin, \vn{<out>} is a two character string with each character being
