...
The geometry of the plate is defined using the ``wall'' attribute of
the element. Example:
\begin{example}
...
For computational reasons, All sections must be ``star shaped'' with
...
\fig{f:diff.plate}B where the section is not star shaped since a
...
it is not possible to make a section star shaped by moving the
