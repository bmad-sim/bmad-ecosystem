...
\begin{example}
    ...
    velocity_distribution = <Switch>  ! GAUSSIAN, SHPERICAL, or UNIFORM. 
    sig_x                 = <Real>
    sig_y                 = <Real>
    sig_z                 = <Real>
    sig_vx                = <Real>
    ...
    dE_center             = <Real>    ! Initial photon energy shift (eV).
    dE_relative_to_ref    = <Real>    ! dE_center relative to reference E?
