...
When specifying the time dependent using a set of frequencies, it is generally advisible to use
...
\begin{equation}
  H_{\text{crab}} = -q_{rel} \, V\, x \, \sin(k \, t + 2 \, \pi \, \phi_0)
\end{equation}
...
\begin{align} 
  \Delta p_x &= -\frac{1}{c \, P_0} \, \frac{\partial H_{\text{crab}}}{\partial x} = 
    \frac{q_{rel} \, V}{c \, P_0} \, \sin(k \, t + 2 \, \pi \, \phi_0) \CRNO 
  \Delta E &= -\frac{\partial H_{\text{crab}}}{\partial t} = 
    q_{rel} \, V \, \, k \, x \, \cos(k \, t + 2 \, \pi \, \phi_0) 
\end{align} 
