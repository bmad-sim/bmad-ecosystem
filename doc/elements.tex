...
There are two types of \vn{group} elements: \vn{Function} based and \vn{spline} based.
The general syntax for a \vn{function} based \vn{group} element is
\begin{example}
...
Example of a \vn{function} based \vn{group} element:
\begin{example}
...
together. A \vn{hybrid} is essentially the same as s \vn{taylor} element.
...
There are two types of \vn{overlay} elements: \vn{Function} based and \vn{spline} based.
The general syntax for a \vn{function} based \vn{overlay} element is
\begin{example}
