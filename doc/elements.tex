...
\begin{example}
  ...
  integration = <switch>                                   ! linear or spline (default).
\end{example}
...
For example, a term in a Taylor map that was
\Begineq
  p_y(\Out) = 2.73 \cdot \delta y^2(\In) \, \delta p_z(\In) + \ldots
\Endeq
would be written as
\begin{example}
  \{4: 2.73, 0 0 2 0 0 1\}
...
example, the term of the above example would be written using the second form as
\begin{example}
  \{4: 2.73 | 336\}
\end{example}
...
\begin{example}
  tt<out><n1><n2>...  = <Coef>                      ! Taylor term. Third form.
\end{example}
For example, the term of the above examples would be written using the third form as:
\begin{example}
  tt4336 = 2.73
\end{example}
