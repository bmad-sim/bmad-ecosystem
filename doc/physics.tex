...
\begin{align}
  \Delta {\Bf p}_\perp &= 
    ...
    \bfhatr \cos m\theta - {\bf\hat\theta} \sin m\theta \right) \\
  &= -C \, I_m \, W_m(t) \, m \, r^{m-1} \, \left( 
    \bfhatx \cos [(m-1) \theta] - 
    \bfhaty \sin [(m-1)\theta] \right) \CRNO
...
\Begineq
  ...
  {\pmb\Omega}_{BMT} (\mathbf{r,P},s) - \bfg \times \bfhatz \right\} \times \mathbf{S}
\Endeq
...
$v$ is the velocity, $\bfhatz$ is the unit vector in the
$z$-direction, and
\Begineq
