...
\begin{align}
  E_\rho(\bfr) &= \sum_{n=-N/2+1}^{N/2} -e^{i \, n \, z / dz} \, 
    e_0(n) \, \frac{i \, k_{zn} \, I_1(\kappa_n \, \rho)}{\kappa_n} \CRNO
  E_\phi(\bfr) &= 0 \\
  E_z(\bfr) &= \sum_{n=-N/2+1}^{N/2}e^{i \, n \, z / dz} \, 
...
\begin{align}
  ...
  E_\phi(\bfr) &= \sum_{n=-N/2+1}^{N/2}e^{i \, n \, z / dz} \, 
...
\begin{align}
  \frac{d}{d\rho} I_m(\kappa \, \rho) = \begin{cases}
    ...
    \kappa \, I_{m-1}(\kappa \, \rho) - \frac{m}{\rho} \, I_m(\kappa \, \rho)
  \end{cases}
\end{align}
