...
macroparticles placed in the middle of each region.  
...
The weight of a macroparticle is determined by the total weight of the region 
...
\end{align}
To represent the distribution with macroparticles of equal weight, 
