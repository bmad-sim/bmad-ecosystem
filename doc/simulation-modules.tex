...
\begin{alignat}{1}
  x_0     &= x_{\text{err}} - x_{\text{cal}} \CRNO
  y_0     &= y_{\text{err}} - y_{\text{cal}} \CRNO
  \psi   &= \psi_{\text{err}}   - \psi_{\text{cal}} \CRNO
  \theta &= \theta_{\text{err}} - \theta_{\text{cal}} \\
  dg_x     &= dg_{x,\text{err}} - dg_{x,\text{cal}} \CRNO
  dg_y     &= dg_{y,\text{err}} - dg_{y,\text{cal}} \nonumber
\end{alignat}
