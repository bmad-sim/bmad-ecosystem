...
refered to as `\vn{lm}', and Differential Evolution, or `\vn{de}'. This example
...
better. But becuase `\vn{lm}' typically converges much faster (for functions it
