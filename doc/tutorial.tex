...
command
\begin{example}
  \$CESR_EXE/tao \{-init <tao_input_file>\} \{-beam <beam_input_file>\} 
                                                  \{-lat <lattice_file>\}
\end{example}
...
\vn{<beam_input_file>} is for reading in data generated from beam
tracking (\sref{s:command_line}). The \vn{<lattice_file>} is used to
