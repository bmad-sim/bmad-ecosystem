...
generated from beam tracking (\sref{s:command.line}). The \vn{-beam0}
...
\end{example}
There are five data types defined in the initialization file. 
For the first four data types there are two
