...
definition file and it is undesireable to put a \vn{call} statement in one file to reference the
...
Since parsing can be slow, once the \vn{bmad_parser} routine has transfered the information from a
