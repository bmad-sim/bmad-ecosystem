...
\begin{example}
  type beam_init_struct
    ...
    character(16) :: random_engine            ! Engine to use: "pseudo" (default) or "quasi". 
    character(16) :: random_gauss_converter   ! "exact" (default) or "limited". 
    real(rp) :: random_sigma_cutoff = 4.0     ! Cut-off in sigmas. Used with "limited" converter. 
...
\end{example}
Currently, if a random distribution is used, it must be used in all 2D
phase spaces. Since the Kapchinsky-Vladimirsky distribution is for a 4D
