...
\index{intensity_x}\index{intensity_y}\index{phase_x}\index{phase_y}
...
\begin{example}
  ...
  beam_start[intensity_x] = <Real>   ! Photon beam intensity along x-axis
  beam_start[intensity_y] = <Real>   ! Photon beam intensity along y-axis
