...
Tutorial (\sref{s:tutorial}). Additionally, there are a number of exmples in the directory
\begin{example}
  \$ACC_ROOT_DIR/tao/examples/
\end{example}
where \vn{\$ACC_ROOT_DIR} is the base directory of your local \bmad Distribution or Release (a full description
