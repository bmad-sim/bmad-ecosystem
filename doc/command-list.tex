...
\begin{example}
  ...
  show symbolic_numbers \{-fundamental_constants\}                      ! \sref{s:show.symbolic}
...
Note: To set the number of top contributors shown, use the command \vn{set global n_top10_merit}
...
\vn{-fundamental_constants} switch is present, the predefined fundamental constants (like \vn{pi}
and \vn{c_light} are displayed instead.
