...
\begin{example}
  ...
  change beam_start 2@x @0.001      ! set beginning x position in universe 2 to 1 mm.
\end{example}
...
tracking. \vn{show particle <particle_index> \{<element_index>\}}
shows information on the particle with the given beam index at the
exit end of the element given by \vn{<element_index>}. The default
\vn{<element_index>} is 0 (the starting position).  Also see \vn{show
beam}.
