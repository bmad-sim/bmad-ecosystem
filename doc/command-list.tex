...
The \vn{-orbit} switch, if present,t will show the particle reference
...
lattices with an open geometry. Use \vn{set beam_start} to vary the
...
The \vn{-tracking_elements} switch can be used to show all the elements
in the tracking part of the lattice. The
\vn{<element_list>} is optional but if it is present it must be at the
end of the command line.

If neither \vn{-tracking_elements}, nor a range is given,
