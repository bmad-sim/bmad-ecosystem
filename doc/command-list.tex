...
The \vn{cut_ring} command is used to switch the geometry of the viewed \vn{model} lattice
from \vn{closed} to \vn{open}.
...
Syntax:
\begin{example}
  show chromaticity \{-taylor\} \{-universe <universe>\} 
\end{example}
