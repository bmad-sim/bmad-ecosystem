...
\begin{example}
  ...
  twiss_and_orbit ...   ! Show Twiss and orbit info at given position \sref{s:show.twiss}.
...
Set the format for the Beta and Alpha functions of the two ransverse normal modes. The default, if
...
\vn{<s_position>}. Also see \vn{show track}.
