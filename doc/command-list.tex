...
If \vn{component} is set, the \vn{<value>} is stored in the graphs of the plot since the
\vn{component} attribute is associated with individual graphs and not the plot as a
whole. Also see the commands:
\begin{example}
  plot                    ! \sref{s:plot}
