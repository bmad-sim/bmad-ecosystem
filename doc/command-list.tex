...
\begin{example}
  &custom_show_list
    ...
    column(3) = "lat::#[name]",          "a",      0
    column(4) = "lat::#[key]",           "a16",   16
    column(5) = "lat::#[s]",             "f10.3", 10
    column(6) = "lat::#[beta_a]",        "f7.2",   7
    column(7) = "1e3 * lat::#[orbit_x]   "f8.3",   8, "Orbit_x| (mm)" 
  /
\end{example}
...
(\sref{s:arithmetic}). Note: Use of \vn{lat::} and \vn{beam::}, etc
...
\begin{example}
  ...
  lat::#[name]                ! Name of element.
  lat::#[key]                 ! Type of element (``quadrupole'', etc.)
  lat::#[slave_status]        ! Slave type (``super_slave'', etc.)
  lat::#[lord_status]         ! Slave type (``multipass_lord'', etc.)
  lat::#[type]                ! Element type string (see \bmad manual).
\end{example}
...
width of 0, which can only be used for an \vn{lat::\#[name]} column,
