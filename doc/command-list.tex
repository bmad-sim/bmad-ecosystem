...
template plot of the same name is ignored. If it is desired to set the graph(s) in the template
plot, add a ``\vn{T::}'' prefix to the plot name.
...
If \vn{<plot_or_region>} is a plot name, and there are visible plots, any template plot of the same
name is ignored. If it is desired to set the template plot, add a ``\vn{T::}'' to the plot name.
