...
\begin{example}
  ...
  show hom
  show key_bindings
  show lattice \{-all} \{-0undef\} \{-branch <branch>\} \{-custom <file_name>\} 
         \{-elements <name>\} \{-lords\} \{-middle\} \{-no_header\} \{-s\} \{<location_range>\} 
  show optimizer
...
\item[\protect\parbox{6in}{
  show lattice \{-all} \{-0undef\} \{-branch <branch>\} \{-custom <file\_name>\} \\
  \hspace*{0.35in} \{-elements <name>\} \{-lords\} \{-middle\} \{-no\_header\} \{-s\} \{<location\_range>\} }] \Newline
...
\end{example}
The \vn{-all} switch can be used to show all the elements. The
