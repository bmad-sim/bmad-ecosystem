...
\item[\protect\parbox{6in}{
        show particle \{<bunch\_index>.\}<particle\_index> \{<element\_index>\} \\
        show particle -lost \{bunch_index\}}] \Newline
...
\vn{global%bunch_to_plot}. The default \vn{<element_index>} is 0 (the
