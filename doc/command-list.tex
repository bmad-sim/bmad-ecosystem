...
\begin{example}
  ...
  control ...           ! Show lords and slaves of a given lattice element \sref{s:show.control}.
  ...
  dynamic_aperture      ! Show DA info \sref{s:show.da}.
  ...
  lattice ...           ! Lattice element-by-element table \sref{s:show.lattice}.
  ...
  spin                  ! Show information on spin simulations \sref{s:show.spin}.
  string ...            ! Print a string \vn{s:show.string}.
...
a binary file is to be created where \vn{\#} is replaced by the universe number.
...
The \vn{-binary} switch will cause secondary lattice files which are created, for example, for
fieldmaps, to be written in a binary format. This will speed up the reading of the lattice at the
