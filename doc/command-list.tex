...
Shows the transfer matrix for the \vn{model} lattice of the currently
\vn{view}ed universe. This command is equivalent to \vn{show
...
currently \vn{view}ed universe. See also \vn{show matrix}.
