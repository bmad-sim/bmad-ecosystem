...
is manditory. Appropriate values for \vn{<name>}, \vn{<locations>},
...
Binds a custom key in single mode to a command string. 
This will override the default behavior of the key.
