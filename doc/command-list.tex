...
over the \vn{show} command comes from the fact that the output syntax of \vn{show} commands can
(and does) change.
...
%
\item[-rms] \Newline
When the \vn{-rms} switch is present, three additional lines will be added to the output showing the
mean and rms values for columns that had floating point numbers. Only valid values will be included 
in the calculation.
%
