...
The \vn{python} command can be used to pass information to an external
process when \tao is run as a subprocess withing within the process.
The external process may be any scripting program like Python, Perl,
