...
\begin{tabular}{ll|ll} \toprule
  ...
  ls            & \sref{s:ls}       & use           & \sref{s:use}      \\ 
  misalign      & \sref{s:misalign} & veto          & \sref{s:veto}     \\ 
...
\vn{y} and \vn{y2} components of the graph. See \vn{s:line.symb} for more details. The \vn{-exact}
...
\begin{example}
  ...
  set graph beta y%bounds = "zero_at_end"       ! \sref{s:line.symb}.
\end{example}
