...
\begin{description}
  ...
  \item[set curve <curve> <component> = <value>]
...
%% set data --------------------------------------------------------------
  ...
  \item[set data <data\_name>|<component> = <value>]
...
%% set global --------------------------------------------------------------
  ...
  \item[set global <component> = <value>]
...
%% set graph --------------------------------------------------------------
  ...
  \item[set graph <graph> <component> = <value>]
...
%% set lattice --------------------------------------------------------------
  ...
  \item[set lattice <component> = <value>]
...
%% set plot --------------------------------------------------------------
  ...
  \item[set plot\_page <component> = <value1> \{<value2>\}]
...
%% set universe --------------------------------------------------------------
  ...
  \item[set universe <what\_universe> on/off \\
...
%% set var --------------------------------------------------------------
  ...
  \item[set var <var\_name>|<component> = <value>]
...
\vn{show -write} command will first erase the conents of the output
...
%% show curve --------------------------------------------------------------
  ...
  \item[show curve \{-symbol\} \{-line\} <curve\_name>]
...
%% show derivative --------------------------------------------------------------
  ...
  \item[show derivative <data\_name(s)> <var\_name(s)>]
...
%% show element --------------------------------------------------------------
  ...
  \item[show element \{-taylor\} \{-wig\_terms\} <name>]
...
the \vn{-wig_terms} switch to display any associated wiggler terms for
a \vn{map_type} \vn{wiggler} element.
...
%% show lattice --------------------------------------------------------------
  ...
  \item[show lattice \{-no\_header\} \{-middle\} \{-custom <file\_name>\} \\ 
        \hspace*{2in} \{-s\} \{-elements <name>\} \{<location\_range>\}]
...
%% show particle --------------------------------------------------------------
  ...
  \item[show particle <particle\_index>]
...
%% show universe --------------------------------------------------------------
  ...
  \item[show universe \{universe\_number\}]
...
%% show variable --------------------------------------------------------------
  ...
  \item[show variable \{<var\_name> <locations>\} \\
