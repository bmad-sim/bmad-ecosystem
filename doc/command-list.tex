...
\begin{example}
  <ele_shape_name>::<ele_shape_component>
...
\begin{example}
  ...
  set lat_layout beam_chamber_scale = 0.5
\end{example}
...
\begin{example}
   ...
   element \{-all_attributes\} \{-cross_section\} \{-base\} \{-design\}
         \{-data\} \{-no_slaves\} \{-taylor\} \{-field\} <ele_name>
   ...
   optimizer
   particle \{-bunch <bunch_index>\} \{-particle <particle_index> \{-element <element_name_or_index>\} \{-lost\} \{-all\}
...
\item[\protect\parbox{6in}{
  show element \{-all\_attributes\} \{-cross_section\} \{-base\} \{-design\} \\
  \hspace*{0.35in} \{-data\} \{-no_slaves\} \{-taylor\} \{-field\} <ele\_name> }] \Newline
...
\item[show particle \{-bunch <bunch\_index>\} \{-particle <particle\_index> \{-element <element\_name\_or\_index>\} \{-lost\} \{-all\}]
  \Newline 
...
Examples:
\begin{example}
  show part -bun 3 -part 47 -ele 8 ! Shows information on particle #47 of bunch #3 at 
                                   !   lattice element #8.
...
\item[plot \{-floor_plan\} \{-lat_layout \} \{<plot_region_name>\} \{<template_plot_name>\} \Newline
...
\item[twiss\_and\_orbit \{-base\} \{-branch <name>\} \{-design\} \{-universe <ix\_uni>\} <s\_position>] \Newline
