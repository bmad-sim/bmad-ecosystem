...
argument to the \vn{-at} switch. The \vn{-ascii} switch is for writing text files. See the \vn{Beam
Initialization} chapter in the \bmad manual for a discussion of the syntax. The default is to write
with a compressed binary format. Note: Beam files can be used to initialize \tao
(\sref{s:command.line}). Example
\begin{example}
