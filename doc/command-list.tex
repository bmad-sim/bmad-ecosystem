...
\begin{tabular}{|l|l||l|l|} \hline
  ...
  plot          & \sref{s:plot}     & x_axis        & \sref{s:x.axis}   \\ \hline 
...
\vskip 0.2in \vn{x_scale} sets the lower and upper bounds for the
...
\vskip 0.2in \vn{xy_scale} sets the lower and upper bounds for both
