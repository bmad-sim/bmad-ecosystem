...
\begin{example}
  ...
  lattice \{-0undef\} \{-all_tracking\} \{-base\} \{-blank_replacement <string>\} 
        ...
        \{-middle\} \{-no_label_lines\} \{-no_tail_lines\} \{-orbit\} \{-radiation_integrals\}
...
If \vn{-branch <branch>} is present, more detailed info on the given branch
will be given. Here \vn{<branch>} can be either the branch name or index.
...
\item[\protect\parbox{6in}{
  ...
  \hspace*{0.35in} \{-branch <branch>\} \{-custom <file\_name>\} \{-design\} \{-floor_coords\} \{-lords\} \\
...
The \vn{write ptc} command writes a PTC flat file of the lattice.
The default is to write a ``new style'' format version. The \vn{-old} switch
will generate an ``old style'' version. This command can only be used
