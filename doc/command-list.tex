...
\begin{example}
   ...
   element \{-all_attributes\} \{-cross_section\} \{-base\} \{-design\}
         \{-data\} \{-no_slaves\} \{-taylor\} \{-em_field\} <ele_name>
...
\item[\protect\parbox{6in}{
  ...
  \hspace*{0.35in} \{-data\} \{-no_slaves\} \{-taylor\} \{-em\_field\} <ele\_name> }] \Newline
...
If the \vn{-em_field} switch is present, any associated 
