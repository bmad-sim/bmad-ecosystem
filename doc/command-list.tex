...
\item[\protect\parbox{6in}{
  ...
  \hspace*{0.35in} \{-no\_label\_lines\} \{-no\_tail\_lines\} \{-no\_slaves\} \{-orbit\} \{-radiation_integrals\} \\
  \hspace*{0.35in} \{-remove_line_if_zero <column \#>\} \{-s <s1>:<s2>\} \{-tracking\_elements\} \\
  \hspace*{0.35in} \{<element_list>\} }] \Newline
...
\vskip 0.1 in
\item[show plot \{-floor_plan\} \{-lat_layout \} \{<plot_or_template_name>\}] \Newline
\vskip -0.1in
