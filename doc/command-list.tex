...
\end{example}
The \vn{set particle_start} command sets the starting centroid coordinates for beam tracking as well
...
For lattices with an open geometry, \vn{set particle_start <coordinate> <number>} can be used to vary
...
Also see the commands: \vn{set beam} and \vn{set beam_init}.
