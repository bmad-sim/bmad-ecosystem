...
\begin{example}
  ...
  ------------------             ------------------
  write 3d_floor_plan            3d_floor_plan.py
...
The \vn{write 3d_floor_plan} creates a python script which can then be
run externally to \tao. This script will create a 3D display of the
currently viewed (\sref{s:view}) lattice lattice. The suffix '.py'
will be appended if the given file name does not have it.
