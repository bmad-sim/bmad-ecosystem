...
\begin{example}
  ...
  show element \{-attributes\} \{-base\} \{-data\} \{-design\} \{-all\} \{-field\} 
        ...
        \{-wall\} \{-xfer_mat\} <ele_name>                                  ! \sref{s:show.element}
  ...
  show lattice \{-0undef\} \{-all\} \{-attribute <attrib>\} \{-base\} 
        ...
        \{-spin\} \{-tracking_elements\} \{-undef0\} \{<elements>\}           ! \sref{s:show.lattice}
  show matrix \{-s\} \{loc1 \{loc2\}\}                                      ! \sref{s:show.matrix}
  show merit \{-derivative\} \{-merit_only\}                              ! \sref{s:show.merit}
  ...
  show symbolic_numbers \{-physical_constants\}                         ! \sref{s:show.symbolic}
  show taylor_map \{-order <n_order>\} \{-s\} \{loc1 \{loc2\}\}               ! \sref{s:show.taylor}
  show track \{-b_field \{fmt\}\} \{-e_field \{fmt\}\} \{-energy \{fmt\}\}
...
Show the symbolic constants created using the \vn{set symbolic_number} command. If the
\vn{-physical_constants} switch is present, the predefined physical constants (like \vn{c_light})
along with predefined mathematical constants (like \vn{pi}) are displayed instead (Also see the \bmad
