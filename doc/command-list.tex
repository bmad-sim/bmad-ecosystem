...
\begin{example}
  ...
  show hom
  show key_bindings
  show lattice \{-0undef\} \{-branch <branch>\} \{-custom <file_name>\} \{-elements <name>\} 
               \{-lords\} \{-middle\} \{-no_header\} \{-s\} \{<location_range>\}
  show optimizer
...
\item[\protect\parbox{6in}{
  show lattice \{-0undef\} \{-branch <branch>\} \{-custom <file_name>\} \{-elements <name>\} \\
  \hspace*{2in} \{-lords\} \{-middle\} \{-no_header\} \{-s\} \{<location_range>\} }] \Newline
...
\vn{ix_ele0}). If \vn{<where>} is \vn{*} then all plots are set.
