...
\begin{example}
   ...
   element \{-all_attributes\} \{-cross_section\} \{-base\} \{-design\}
         \{-data\} \{-no_slaves\} \{-taylor\} \{-field_coefs\} <ele_name>
   ...
   optimizer
   particle \{-bunch <bunch\_index>\} \{-particle <particle\_index> \{-element <element\_name\_or\_index>\} \{-lost\} \{-all\}
   plot
...
If the \vn{-field_coefs} switch is present, any associated wiggler
terms for a \vn{map_type} \vn{wiggler} element is printed. Additionally,
RF field coefficients for \vn{lcavity} and \vn{rfcavity} elements are printed.
