...
%% set data --------------------------------------------------------------
  ...
  \item[set data <data_name>|<component> = <value>]
...
%% set plot --------------------------------------------------------------
  ...
  \item[set plot_page <component> = <value1> \{<value2>\}]
...
%% set universe --------------------------------------------------------------
  ...
  \item[set universe <what_universe> on/off \\
        set universe <what_universe> recalculate]
...
%% set var --------------------------------------------------------------
  ...
  \item[set var <var_name>|<component> = <value>]
...
%% show curve --------------------------------------------------------------
  ...
  \item[show curve \{-symbol\} \{-line\} <curve_name>]
...
%% show particle --------------------------------------------------------------
  ...
  \item[show particle <particle_index>]
...
%% show universe --------------------------------------------------------------
  ...
  \item[show universe \{universe_number\}]
...
%% show variable --------------------------------------------------------------
  ...
  \item[show variable \{<var_name> <locations>\} \\
        show variable <universe_number>@]
