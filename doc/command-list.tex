...
\begin{example}
  ...
  show spin -ele S1 S1  ! 1-turn analysis at downstream end of S1 
...
\begin{example}
  ...
  write nameli...                 ! \sref{s:write.namelist}
  write opal ...                  ! \sref{s:write.opal}
  write ps ...                    ! \sref{s:write.ps}  
  write ps-l ...                  ! \sref{s:write.ps}
...
is writen. If \vn{-combined} is present, both the element matrices and the matrices from the start
of the branch are writen. The default is to write the element matrices.
