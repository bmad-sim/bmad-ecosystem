...
Syntax:
\begin{example}
  show emittance \{-element <ele_id>\} \{-matrix\} \{-universe <uni_index>\}
\end{example}
...
If the \vn{-matrix\} switch is present, instead of showing emittances, the damping and stochastic
kick matrices used for particle tracking are displayed for the element given by the \vn{-element}
switch.
