...
\begin{example}
  ...
  show element \{-all_attributes\} \{-data\} \{-no_slaves\} \{-taylor\} \{-wig_terms\} <ele_name>
...
\item[show element \{-all\_attributes\} \{-data\} \{-no_slaves\} 
...
When using wildcards in the element name, if the \vn{-no_slaves}
