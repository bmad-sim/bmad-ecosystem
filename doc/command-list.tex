...
Also see the commands: \vn{set beam_init} and \vn{set beam_start}.
...
Also see the commands: \vn{set beam} and \vn{set beam_start}.
...
\end{example}
The \vn{set beam_start} command sets the starting centroid coordinates for beam tracking as well
...
Same as \vn{set beam_start}. See section~\sref{s:set.beam.start} for more details.
