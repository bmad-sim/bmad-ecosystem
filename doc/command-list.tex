...
Examples:
\begin{example}
  show transfer -order 1 q10e q10w  ! 0th and 1st order map from element q10e to q10w
  show transfer 45                  ! Transfer map from element \# 0 to \# 45
\end{example} 
...
\item[\protect\parbox{6in}{
        ...
        show variable \{-bmad\_format\} ] \Newline
Shows variable information. If \vn{<var_name>} \vn{<locations>} is not
present shown is a list of \vn{v1_var} classes.  To show variables
associated with the \vn{n}th universe use the syntax: \vn{show var
n@}.

If \vn{-bmad_format} is present then the Bmad lattice parameters that
