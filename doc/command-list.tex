...
\item[set key <key> = <command>] \Newline
...
The \vn{set universe <what_universe> mat6_recalc} and \vn{set universe
<what_universe> mat6_recalc} commands will set whether the 6x6
...
compute the Twiss parameters). Use the \vn{show universe} command to
...
\begin{example}
  ...
  hom
  key_bindings
  lattice \{-0undef\} \{-all\} \{-attribute <attrib>\} \{-base\} 
        ...
        \{-remove_line_if_zero <column \#>\} \{-s <s1>:<s2>\} \{-tracking_elements\} \{<elements>\} 
  matrix \{-s\} \{loc1 \{loc2\}\}
...
\item[\protect\parbox{6in}{
  ...
  \hspace*{0.35in} \{-remove_line_if_zero <column \#>\} \{-s <s1>:<s2>\} \{-tracking\_elements\} \{<element_list>\}  }] \Newline
...
\item[show plot \{-floor_plan\} \{-lat_layout \} \{<plot_or_template_name>\}]
\Newline
