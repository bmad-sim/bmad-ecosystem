...
\begin{example}
  ...
  show lattice \{-all_tracking} \{-0undef\} \{-branch <branch>\} \{-custom <file_name>\} 
         \{-elements <name>\} \{-lords\} \{-middle\} \{-no_label_lines\} 
         \{-no_tail_lines\} \{-s\} \{<location_range>\} 
  show optimizer
...
\item[\protect\parbox{6in}{
  ...
  \hspace*{0.35in} \{-elements <name>\} \{-lords\} \{-middle\} \{-no\_label_lines\} \\
  \hspace*{0.35in} \{-no_tail_lines\} \{-s\} \{<location\_range>\} }] \Newline
