...
Additionally, if \vn{<component>} is set to \vn{beginning}, and \vn{<value>} is set to the name
or index of a lattice element where particle positions of the tracked beam has been stored, the initial
...
\begin{example}
  ...
  set beam not_saved_at = Q10W   ! Do not save beam parameters at element "Q10W".
