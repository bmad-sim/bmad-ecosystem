...
\begin{figure}
\Hyperref{r:qp.open.page}{qp_open_page}
\Hyperref{r:qp.close.page}{qp_close_page}
\Hyperref{r:qp.read.data}{qp_read_data}
\Hyperref{r:qp.calc.and.set.axis}{qp_calc_and_set_axis}
\Hyperref{r:qp.draw.text}{qp_draw_text}
\Hyperref{r:qp.draw.axes}{qp_draw_axes}
\Hyperref{r:qp.draw.data}{qp_draw_data}
\Hyperref{r:qp.save.state}{qp_save_state}
\Hyperref{r:qp.restore.state}{qp_restore_state}
\Hyperref{r:qp.set.page.border}{qp_set_page_border}
\Hyperref{r:qp.set.margin}{qp_set_margin}
\Hyperref{r:qp.set.line.attrib}{qp_set_line_attrib}
\Hyperref{r:qp.set.box}{qp_set_box}
\Hyperref{r:qp.set.graph.attrib}{qp_set_graph_attrib}
\Hyperref{r:qp.set.symbol.attrib}{qp_set_symbol_attrib}
\Hyperref{r:qp.set.axis}{qp_set_axis}
\footnotesize
\begin{listing}{1}
...
sets where the graph is going to be placed.  \Hyperref{r:qp.set.box}{qp_set_box}\vn{(1,
...
\Hyperref{r:qp.calc.and.set.axis}{qp_calc_and_set_axis} on lines 38 and 39 are used to scale the
