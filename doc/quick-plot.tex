...
\vn{PLPLOT}\cite{plplot} plotting libraries. Whether \vn{PGPLOT} or \vn{PLPLOT} is used depends upon
...
\end{example}
Note: For displays with a resolution of 72 pixes / inch, \vn{POINTS} corresponds to pixels but
