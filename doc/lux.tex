...
\date{Revision 1.5 \\ August 11, 2018}
...
\begin{example}
  &params
    ...
    lux_param%histogram_variable = 'x_angle'       ! "x_angle", "y_angle", "energy", etc.
...
is only relevant when the lattice element at which the photon positions
