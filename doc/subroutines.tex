...
\item[bend_edge_kick (orb, ele, param, particle_at, in_to_out, mat6)] \Newline 
...
\item[mat_symp_error (mat, p0_ratio) result (error)] \Newline
...
\item[ibs_lifetime(lat,tau_a,maxratio,lifetime,formula,granularity,clog_to_use)] \Newline 
...
\item[vec_bmad_to_ptc (vec_bmad, beta0, vec_ptc, mat6)] \Newline
Routine to convert from Bmad to PTC coordinates. 

\index[routine]{vec_ptc_to_bmad}
\label{r:vec.ptc.to.bmad}
\item[vec_ptc_to_bmad (vec_ptc, beta0, vec_bmad, mat6)] \Newline
...
\item[\protect\parbox{6in}{
    offset_particle (ele, coord, param, set, set_canonical, set_tilt, \\
...
\item[offset_photon (ele, orbit, set, offset_position_only)] \Newline 
Routine to effectively offset an element by instead offsetting
...
\item[track1_custom2 (start, ele, param, end, track, err_flag)] \Newline
Dummy routine for custom tracking.
...
\label{r:chrom.calc}
\item[chrom_calc (lat, delta_e, chrom_x, chrom_y, err_flag, low_E_lat, high_E_lat, low_E_orb, high_E_orb)] \Newline
