...
\item[calc_emittances_and_twiss_from_sigma_matrix(sigma_mat, gamma, bunch_params, error, print_err)] \Newline 
...
\item[track1_bunch_hook (bunch_start, ele, bunch_end, err, centroid, direction, finished)] \Newline 
