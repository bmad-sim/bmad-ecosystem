...
\label{r:skip.header}
\item[skip_header (unit, error_flag)] \Newline 
...
Routine to retrun True or False depending upon the state of an 
optional string.
...
Routine to trim a string of leading delimitors and also to return the
length of the first word.
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{2in} ptr_array, err_flag, err_print_flag, ix_eles, ix_attrib)} ] \Newline 
...
\label{r:init.ele}
\item[init_ele (ele, ix_ele, ix_branch)] \Newline
...
\item[\protect\parbox{6in}{bmad_to_mad_or_xsif (out_type, old_file_name, lat, use_matrix_model, \\
...
\label{r:qp.set.axis}
\item[\protect\parbox{6in}{qp_set_axis (axis, a_min, a_max, div, places, label, draw_label, \\
...
\label{r:qp.get.axis}
\item[\protect\parbox{6in}{
  qp_get_axis (axis, a_min, a_max, div,  places, label, \\
...
Routine to set the color taking into accout that GIF
...
\item[\protect\parbox{6in}{
  ...
  \hspace*{2in} track_exit, orbit_start, orbit_end, ele_start, ele_end, err) }] \Newline 
...
\item[twiss_from_tracking (lat, closed_orb, d_orb, error)] \Newline
...
\item[mad_tmfoc (el, sk1, c, s, d, f)] \Newline 
     Routine to compute the linear focussing functions.  
...
\item[radiation_integrals (lat, orb, mode)] \Newline
...
\label{r:set.tune}
\item[set_tune (phi_x_set, phi_y_set, dk1, lat, orb, ok)] \Newline
