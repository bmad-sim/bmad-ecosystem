...
\item[csr_bin_particles (ele, particle, bin)] \Newline 
...
\item[time_runge_kutta_periodic_kick_hook (orbit, dt_ref, ele, param, stop_time, init_needed)] \Newline 
Custom routine to add a kick to a particle at periodic times.

\index[routine]{track1_bunch_hook}
\label{r:track1.bunch.hook}
\item[track1_bunch_hook (bunch_start, lat, ele, bunch_end, err, centroid, direction, finished)] \Newline 
...
\item[pmd_write_int_to_pseudo_dataset(root_id, dataset_name, bmad_name, unit, value, v_shape, error)] \Newline 
...
\item[pmd_write_real_to_pseudo_dataset (root_id, dataset_name, bmad_name, unit, value, v_shape, error)] \Newline 
...
\index[routine]{find_indexx0}
\label{r:find.indexx0}
\item[find_indexx0 (name, var_str_index, ix_match, ix2_match, add_to_list, n_match, has_been_added)] \Newline 
Subroutine to find a matching name in a list of names.
This name is overloaded by find_indexx.

\index[routine]{find_indexx1}
\item[find_indexx1 (name, nametable, ix_match, ix2_match, add_to_list, n_match, has_been_added)] \Newline 
Subroutine to find a matching name in a list of names.
This name is overloaded by find_indexx.

\index[routine]{find_indexx2}
\label{r:find.indexx2}
\item[find_indexx2 (name, names, an_indexx, n_max, ix_match, ix2_match, add_to_list, n_match, has_been_added)] \Newline 
Subroutine to find a matching name in a list of names.
This name is overloaded by find_indexx.

\index[routine]{find_indexx3}
\label{r:find.indexx3}
\item[find_indexx3 (name, names, n_min, an_indexx, n_max, ix_match, ix2_match, add_to_list, n_match, has_been_added)] \Newline 
Subroutine to find a matching name in a list of names.
This name is overloaded by find_indexx.

\index[routine]{indexx_str}
\label{r:indexx.str}
\item[indexx_str (str_arr, indx_arr)] \Newline 
Subroutine to sort a character array.
This subroutine is used to overload the generic name indexx.

\index[routine]{indexx_var_str}
\label{r:indexx.var.str}
\item[indexx_var_str (str_arr, indx_arr)] \Newline 
Subroutine to sort a character array.
This subroutine is used to overload the generic name indexx.

\index[routine]{init_str_indexx_struct}
\label{r:init.str.indexx.struct}
\item[init_str_indexx_struct(var_str_indexx, n_min)] \Newline 
...
\item[parse_fortran_format (format_str, multiplyer, power, code, width, digits)] \Newline 
...
\label{r:real.str}
\item[real_str(r_num, n_signif) result (str)] \Newline 
...
\index[routine]{str_find_first_in_set}
\label{r:str.find.first.in.set}
\item[str_find_first_in_set (line, set)] \Newline 
Function to locate the first character in "line" that matches
a character in "set". If no match is found, function returns 0.

\index[routine]{str_find_first_not_in_set}
\label{r:str.find.first.not.in.set}
\item[str_find_first_not_in_set (line, set)] \Newline 
Function to locate the first character in "line" that
does not match a character in "set". If all characters match,

\index[routine]{str_find_last_in_set}
\label{r:str.find.last.in.set}
\item[str_find_last_in_set (line, set)] \Newline 
Function to locate the last character in "line" that matches
a character in "set". If no match is found, function returns 0.

\index[routine]{str_find_last_not_in_set}
\label{r:str.find.last.not.in.set}
\item[str_find_last_not_in_set (line, set)] \Newline 
...
\index[routine]{coords_element_frame_to_local}
\label{r:coords.element.frame.to.local}
\item[coords_element_frame_to_local (body_position, ele, w_mat, calculate_angles) result (local_position)] \Newline 
...
\item[multipole_ele_to_ab (ele, use_ele_tilt, ix_pole_max, a, b, pole_type, include_kicks, b1)] \Newline
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{1in} for_layout, track_particle) }] \Newline
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{1in} init_complex, force_init) }] \Newline
...
\item[dynamic_aperture1 (branch, orb0, theta_xy, S_xy, aperture_param, aperture, check_xy_init)] \Newline
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{1in} mat6, make_matrix, init_to_edge)}] \Newline
...
\item[track1_time_runge_kutta(start_orb, ele, param, end_orb, err_flag, track, t_end, dt_step)] \Newline 
