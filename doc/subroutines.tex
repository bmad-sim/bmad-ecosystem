...
{\em Routine Type} & {\em Section} \\ \hline
  Beam: Beam-Beam Interaction                 & \ref{r:lrbbi}          \\ \hline
...
%------------------------------------------------------------------------
\section{Beam: Beam-Beam Interaction}
\label{r:bbi}    

\begin{description}

\index{Routine!init_lrbbi}
...
\index{Routine!number_to_file_name}
\item[number_to_file_name (number, who, file_name, num_out, err, print_err)] \Newline 
Routine to form the file name for a phase, orbit, eta, or ac_dispersion
data file. 

\index{Routine!number_to_true_number}
\item[number_to_true_number (num_in, who, num_out, err, print_err)] \Newline 
Routine to form the file name for a phase, orbit, eta, or ac_dispersion
data file. 
