...
\index[routine]{apply_element_edge_kick}
...
\label{r:ele.at.s}
\item[ele_at_s (lat, s, ix_ele, ix_branch, err_flag, s_eff)] \Newline 
...
\item[twiss_and_track_at_s (lat, s, ele, orb, orb_at_s, ix_branch, err, use_saved_data)] \Newline
