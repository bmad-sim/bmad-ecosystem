...
\hspace*{1in} type_cross_section, nunit)}] \Newline
...
\hspace*{1in}  line, symbol, text, draw_line, draw_symbol, draw_text) }] \Newline
...
\item[track_from_s_to_s (lat, s_start, s_end, orbit_start, orbit_end, ix_branch)] \Newline
