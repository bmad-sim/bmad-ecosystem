...
\item[element_at_s (lat, s, choose_max, ix_branch, err_flag, s_eff) result (ix_ele)] \Newline 
...
\item[ele_to_fibre (ele, fiber, particle, use_offsets, integ_order, steps, for_layout)] \Newline
...
\item[track1_boris (start, ele, param, end, err_flag, track, s_start, s_end)] \Newline
