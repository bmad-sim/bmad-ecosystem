...
\item[\protect\parbox{6in}{
    em_field_calc (ele, param, s_pos, orbit, local_ref_frame, field, \\
...
\item[check_aperture_limit (orb, ele, particle_at, param, orb_old, check_momentum)] \Newline
Routine to check if an orbit is outside an element's aperture. 
...
\item[\protect\parbox{6in}{
    offset_particle (ele, param, set, coord, set_tilt, set_multipoles, \\
