...
\item[\protect\parbox{6in}{write_lattice_in_foreign_format (out_type, out_file_name, lat, \\
  \hspace*{1in} use_matrix_model, ix_start, ix_end, ix_branch, converted_lat, err)}] \Newline 
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{1in} entry_pt, finished, radiation_included)} ] \Newline
