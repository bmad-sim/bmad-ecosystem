...
\item[time_runge_kutta_periodic_kick_hook (orbit, z_phase, ele, param, stop_time, init_needed)] \Newline 
...
\index[routine]{hdf5_write_attribute_int_rank_0}
...
\index[routine]{hdf5_write_attribute_int_rank_1}
...
\index[routine]{hdf5_write_attribute_real_rank_0}
...
\index[routine]{hdf5_write_attribute_real_rank_1}
...
\item[hdf5_read_beam (file_name, beam, error, pmd_header)] \Newline 
...
\item[hdf5_read_grid_field (file_name, ele, g_field, err_flag, pmd_header)] \Newline 
...
\index[routine]{mat_pseudoinverse}
...
\item[dynamic_aperture1 (lat, orb0, theta_xy, Sxy, aperture_param, aperture, check_xy_init)] \Newline
