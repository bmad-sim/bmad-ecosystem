...
\label{r:track1.beam}
\item[track1_beam (beam_start, lat, ele, beam_end, err, centroid)] \Newline 
...
\item[track1_bunch (bunch_start, lat, ele, bunch_end, err, centroid)] \Newline 
...
\label{r:track.beam}
\item[track_beam (lat, beam, ele1, ele2, err, centroid)] \Newline 
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{1in} calc_dfield, err_flag, potential, use_overlap, grid_allow_s_out_of_bounds) }] \Newline 
...
\item[add_lattice_control_structs (ele, n_add_slave, n_add_lord, n_add_slave_field, n_add_lord_field, add_at_end)] \Newline 
...
\item[coords_local_curvilinear_to_floor (local_position, ele, in_ele_frame, w_mat, calculate_angles) result (global_position)] \Newline 
...
\item[taylor_to_real_8 (bmad_taylor, v0, beta0, beta1, y8, use_ref0)] \Newline
...
\item[quaternion_track (a_quat, spin)] \Newline
Subroutine to track the spin with the Euler four-vector quaternion a.

\index[routine]{spin_omega}
\label{r:spin.omega}
\item[spin_omega (field, coord, phase_space_coords), result (omega)] \Newline 
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{1in} set_multipoles, set_hvkicks, set_z_offset, ds_pos, set_spin)} ] \Newline
...
\item[track1_bunch_csr (bunch_start, ele, bunch_end, err, s_start, s_end, centroid)] \Newline 
