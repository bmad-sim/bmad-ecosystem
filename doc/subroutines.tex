...
\item[create_overlay (lord, contl, err, err_print_flag)] \Newline
...
\item[\protect\parbox{6in}{write_lattice_in_foreign_format (out_type, out_file_name, lat, ref_orbit, \\
  \hspace*{1in} dr12_drift_max, ix_start, ix_end, ix_branch, converted_lat, err)}] \Newline 
...
\item[dynamic_aperture (lat, orb0, theta_xy, aperture_param, aperture, check_xy_init)] \Newline
