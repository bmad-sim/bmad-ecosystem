...
\item[check_lat_controls (lat, err_flag)] \Newline
...
\label{r:init.ele}
\item[init_ele (ele, key, sub_key, ix_ele, ix_branch, lat)] \Newline
...
\item[mat6_from_s_to_s (lat, mat6, vec0, s1, s2, orbit, ix_branch, one_turn, unit_start, err_flag)] \Newline 
...
\item[ele_to_fibre (ele, fiber, particle, use_offsets, integ_order, steps)] \Newline
