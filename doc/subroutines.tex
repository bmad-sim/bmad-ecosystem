...
\item[multipole_ele_to_ab (ele, particle, use_ele_tilt, has_nonzero_pole, a, b)] \Newline
...
\item[multipole_ele_to_kt (ele, particle, use_ele_tilt, has_nonzero_pole, knl, tilt)] \Newline
...
\item[ele_to_fibre (ele, ptc_fibre, particle, use_offsets, integ_order, steps, for_layout)] \Newline
...
\item[\protect\parbox{6in}{
    offset_particle (ele, coord, particle, set, set_canonical, set_tilt, \\
...
\item[particle_is_moving_forward (orbit, particle) result (is_moving_forward)] \Newline 
...
\item[track_a_drift (orb, ele, species, length)] \Newline
...
\item[make_mad_map (ele, particle, energy, map)] \Newline 
