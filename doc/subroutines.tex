...
\item[autoscale_phase_and_amp(ele, param, err_flag, scale_amp, scale_phase)] \Newline 
...
\item[create_overlay (lord, attrib_name, contl, err, err_print_flag)] \Newline
...
\item[\protect\parbox{6in}{write_lattice_in_foreign_format (out_type, out_file_name, lat, ref_orbit, \\
  \hspace*{1in} use_matrix_model, include_apertures, ix_start, ix_end, ix_branch, converted_lat, err)}] \Newline 
...
\item[ele_to_fibre (ele, ptc_fibre, param, use_offsets, integ_order, steps, for_layout, tracking_species)] \Newline
...
\label{r:track1.custom}
    track1_custom (start_orb, ele, param, end_orb, err_flag, finished, track)] \Newline
...
\item[normal_mode3_calc (t6, tune, B, HV, counter_rotating_z)] \Newline 
