...
\item[set_status_flags (status_block, stat, n_modify)] \Newline 
...
\item[closed_orbit_calc (lat, closed_orb, i_dim, direction, err_flag)] \Newline 
...
\item[\protect\parbox{6in}{
    offset_particle (ele, coord, set, set_canonical, set_tilt, \\
...
\item[offset_photon (ele, param, coord, set, offset_position_only)] \Newline 
Routine to effectively offset an element by instead offsetting
