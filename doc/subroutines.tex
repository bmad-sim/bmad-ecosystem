...
\item[ele_geometry (floor0, ele, floor, len_scale)] \Newline 
...
\item[multipole_ele_to_ab (ele, use_ele_tilt, has_nonzero_pole, a, b)] \Newline
...
\item[multipole_ele_to_kt (ele, use_ele_tilt, has_nonzero_pole, knl, tilt)] \Newline
...
\item[ele_to_fibre (ele, ptc_fibre, param, use_offsets, integ_order, steps, for_layout, rel_charge)] \Newline
...
\item[track1_radiation (orb_start, ele, param, orb_end, edge)] \Newline
