...
\index[routine]{lat_compute_reference_energy}
...
\label{r:make.mat6}
\item[make_mat6 (ele, param, start_orb, end_orb, end_in, err)] \Newline
...
\item[check_aperture_limit_custom (orb, ele, at, param)] \Newline
Routine to check if an orbit is outside an element's aperture.
