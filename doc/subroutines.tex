...
\item[bend_edge_kick (orb, ele, param, stream_end, in_to_out, mat6)] \Newline 
...
\item[\protect\parbox{6in}{
  em_field_custom(ele, param, s_rel, t_rel, orb, local_ref_frame, field, calc_dfield, \\
...
\item[check_aperture_limit (orb, ele, edge_at, param, check_momentum)] \Newline
