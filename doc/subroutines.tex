...
\item[calc_bunch_params (bunch, ele, param, bunch_params, plane, slice_center, slice_spread, err, print_err)] \Newline 
...
\label{r:set.ptc}
\item[set_ptc (e_tot, particle, taylor_order, integ_order, n_step, no_cavity, exact_calc, exact_misalign)] \Newline
...
\item[qp_set_parameters (text_scale, default_draw_units, default_set_units, default_axis_slop_factor)] \Newline 
...
\item[qp_get_parameters (text_scale, default_draw_units, default_set_units, default_axis_slop_factor)] \Newline 
...
\item[qp_open_page_basic (page_type, x_len, y_len, plot_file, x_page, y_page, i_chan, page_scale)] \Newline 
Routine to Initialize a page (window) for plotting.
...
\item[twiss_and_track_partial (ele0, ele_track, param, del_s, ele_end, orb_start, orb_end, body_only, err)] \Newline
...
\label{r:odeint.bmad}
\item[odeint_bmad (start, ele, param, end, s1, s2, rel_tol, abs_tol, h1, h_min, local_ref_frame, track)] \Newline
