...
\item[\protect\parbox{6in}{
  apply_element_edge_kick_hook (orb, fringe_info, t_rel, track_ele, param, \\
  \hspace*{1in} finished, mat6, make_matrix) }] \Newline 
...
\item[\protect\parbox{6in}{
    ...
    \hspace*{1in} calc_dfield, err_flag, potential, use_overlap, \\
    \hspace*{1in} grid_allow_s_out_of_bounds) }] \Newline 
...
\item[ab_multipole_kick (a, b, n, coord, kx, ky, dk, pole_type, scale)] \Newline 
...
\item[multipole_ele_to_ab (ele, use_ele_tilt, has_nonzero_pole, a, b, pole_type, include_kicks)] \Newline
...
\item[make_mat6_bmad (ele, param, orb_in, orb_out, end_in, err)] \Newline
Routine to make the 6x6 transfer matrix for an element
...
\item[track_a_drift (orb, length, mat6, make_matrix)] \Newline
