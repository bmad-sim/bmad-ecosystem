...
scale for each graph. the axis type can be either \vn{index} or \vn{s} which
...
Single particle tracking is used by default. See the Section~\ref{s:macros} for details on
