...
One current area of development for \bmad is X-ray simulation. To that end, new element classes have
been defined including a \vn{mirror} element and a \vn{crystal} element for simulations of crystal
