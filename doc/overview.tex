...
\vn{n@} signifies the n\th universe. For example
\begin{example}
  2@orbit.x
\end{example}
...
See chapter \sec{c:data_types} for more details.  Use the \vn{show
...
name of a \vn{v1_var} then the 5\th variable of this block of
