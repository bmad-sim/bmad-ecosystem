...
by default. See Section~\ref{s:bunch-init}~or~\ref{s:macro_init} for details on
...
transfer matrices and twiss parameters are recalculated for every element. Any
specified data types will also be calculated at each element specified in the
...
the standard \tao data types are calculated.
  \item 
Any user specified data post-processing is performed (BPM alignment errors, etc...) 
  \item 
