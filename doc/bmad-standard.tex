...
For Laue diffraction the coordinate transformations when the
non-diffracted beam is tracked is \etcetc.
...
given in \sref{ss:crystal.trans.el}. The transformation $\Bf\Sigma_1$
