...
\begin{align}
  dz &= \frac{\partial H_{e}}{\partial p_z} = 
    \frac{G}{4 \, P_0} \, \frac{d\beta}{dp_z} \, (x^2 + y^2) \\
  dp_z &= \frac{-\partial H_{e}}{\partial z} = 
    \frac{-\beta}{4 \, P_0} \, \frac{dG}{dz} \, (x^2 + y^2)
\end{align}
where
\begin{align}
  \frac{d\beta}{dp_z} &= \frac{m^2 \, P_0}{E^3} \\
  \frac{dG}{dz} &= G_{\mbox{max}} \, \frac{d\cos(\Delta\phi)}{dz} 
    = \frac{2 \, \pi \, G_{\mbox{max}} \, \sin(\Delta\phi) \, f_\mss{rf}}{\beta}
\end{align}
where $m$ is the particle mass, $E$ is the particle energy,
$G_{\mbox{max}}$ is the maximum accelerating gradiant at phase
$\Delta\phi = 0$, and $f_\mss{rf}$ is the RF frequency.
