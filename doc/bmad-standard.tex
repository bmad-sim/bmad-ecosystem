...
\begin{align}
  x_2    &=  \cos(\theta_t) \, x_1    + \sin(\theta_t) \, y_1    \CRNO
  p_{x2} &=  \cos(\theta_t) \, p_{x1} + \sin(\theta_t) \, p_{y1} \CRNO
...
Apply any tilt $\theta_t$
\begin{align}
  x_1    &=  \cos(\theta_t) \, x_0    - \sin(\theta_t) \, y_0    \CRNO
  p_{x1} &=  \cos(\theta_t) \, p_{x0} - \sin(\theta_t) \, p_{y0} \CRNO
