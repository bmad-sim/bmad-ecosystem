...
\begin{align}
  ...
  \frac{dG}{dz} &= G_{\mss{max}} \, \frac{d\cos(\Delta\phi)}{dz} 
    = \frac{2 \, \pi \, G_{\mss{max}} \, \sin(\Delta\phi) \, f_\mss{rf}}{\beta}
\end{align}
where $m$ is the particle mass, $E$ is the particle energy,
$G_{\mss{max}}$ is the maximum accelerating gradiant at phase
