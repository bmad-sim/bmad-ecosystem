...
coordinates.
\end{enumerate}
The \Hyperref{r:offset_particle}{offset_particle} routine is used to
...
$\wt\psi$ are the normalized vector and scaler potentials:
\Begineq
...
\begin{align}
  ...
  \label{ids2}
\end{align}
With an analogus expression for $I_{y/2}$.

\index{quadrupole}\index{sextupole}\index{wiggler}
For magnetic elements that do not have longitudianl fields
