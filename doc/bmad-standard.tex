...
consequence of the convention that, with no \vn{ref_tilt}, the bend is about
...
\Begineq
  ...
  \label{k1lst}
\Endeq
Where, as shown in \fig{f:crystal.diffraction}, $\theta_{B,in}$,
...
\Begineq
  ...
  + \frac{1}{d}
  \begin{pmatrix} 
    \what{H}_x \\ \what{H}_y \\ \what{H}_z 
  \end{pmatrix}
  \label{1l1dk}
\Endeq
Taking the length of both sides of \Eq{1l1dk} and using \Eq{kk1l2} gives for 
$\theta_0$ 
\Begineq
  \sin \theta_0 = \frac{-\beta \, \what{H}_x + \what{H}_z \, \sqrt{\what{H}_x^2 + \what{H}_z^2 - \beta^2}}
  {\what{H}_x^2 + \what{H}_z^2}
\Endeq
where
\Begineq
...
\Begineq
  ...
  \label{kkqn2}
\Endeq
Using \Eqs{kk1l1}, \eq{1l1dk}, and \eq{kkqn2} gives for Bragg diffraction
\begin{align}
  \kbar_{H,x} &= -\sqrt{\frac{1}{\lambda^2} - \kbar_{H,y}^2 - \kbar_{H,z}^2} \CRNO
  \kbar_{H,y} &= \Kbar_{H,y} = \frac{1}{d} \, \what{H}_y 
  \qquad \qquad [\mbox{Bragg}] 
  \label{k1dapb} \\
  \kbar_{H,z} &= \Kbar_{H,z} = \frac{1}{d} \, \what{H}_z + 
    \frac{1}{\lambda \, (1 + \delta)} \, \cos\theta_0 \nonumber
\end{align}
and for Laue diffraction the corresponding equations arep
\begin{align}
  \kbar_{H,x} &= \Kbar_{H,z} = \frac{1}{d} \, \what{H}_x + 
