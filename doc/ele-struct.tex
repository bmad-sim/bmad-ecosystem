...
\begin{example}
  ...
  call makeup_super_slave1 (sliced_ele, ele, l_start, param, include_entrance, include_exit)
\end{example}
See the documentation on \vn{makeup_super_slave1} for more details (sref{s:getf}).