...
at the exit end of the element. See \cref{c:normal.modes} for more details.
...
\Hyperref{r:type.ele}{type_ele} routine to print the custom information. To setup the
association between a string and a custom attribute from within a
program, the \Hyperref{r:set.attribute.alias}{set_attribute_alias} routine is used
\begin{example}
  type (lat_struct) lat
  logical err_flag
  ...
