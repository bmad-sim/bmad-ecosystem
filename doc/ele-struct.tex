...
type of a given attribute, use the function \zzz{attribute_type}. See the
...
the functions \zzz{is_true(param)}
or \zzz{is_false(param)} should be used.
...
switch which, as explained in \sef{s:fringe}, may have one of four values.
...
the routine\zzz{switch_attrib_value_name} can be used.
