...
type ele_struct
  ...
  type (genfield), pointer :: ptc_genfield ! For symp_map tracking
  type (fibre), pointer :: ptc_fiber       ! For PTC analysis.
  ...
  type (ele_struct), pointer :: lord      ! Pointer to slice lord.
