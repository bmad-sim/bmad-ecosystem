...
Figure~\ref{f:lat.struct}. Note: To denote a component of a
\vn{lat_struct} in this chapter the convention ``\vn{%<component>}''
will be used where \vn{<component>} is a \vn{lat_struct} component.
...
Figure~\ref{f:lat.struct}. The array \vn{%ele(:)} holds the elements
