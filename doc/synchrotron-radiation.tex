...
calculate the referece orbit. If the lattice has a closed geometry, the reference orbit is the
closed orbit calculated with radiation damping included in the tracking. If the lattice has an open
geometry, the reference orbit is the orbit with radiation damping starting from the initial
particle position given by the user.

After the reference orbit has been calculated, The 
