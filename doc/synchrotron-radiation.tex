...
\begin{equation}
  \frac{\Delta E}{E_0} = -k_E \, (1 + p_z) = -(k_d + k_f \, \xi) \, (1 + p_z) 
\end{equation}
...
\begin{align}
  k_d &= \frac{2 \, r_e}{3} \, \gamma_0^3 \, \ave{g_0^2} \, L_p \,  (1 + p_z)
    \label{k2r3g} \\
  k_f &= \left( \frac{55 \, r_e \, \hbar}{24 \, \sqrt{3} \, m_e \, c} \, 
    L_p \, \gamma_0^5 \ave{g_0^3} \right)^{1/2} \, (1 + p_z)
    \label{k55rh}
\end{align}
...
\begin{align}
  ...
  \Delta p_y &= -k_E \, p_y 
  \Delta p_z &\approx \frac{\Delta E}{E_0} = -k_E \, (1 + p_z) \nonumber
\end{align}
