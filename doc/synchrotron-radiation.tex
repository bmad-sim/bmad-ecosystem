...
\begin{equation}
  \frac{\Delta E}{E_0} = -k_E \, (1 + p_z)^2 = -(k_d + k_f \, \xi) \, (1 + p_z)^2
\end{equation}
...
emittsion. The deterministic and stochastic parts of the emission can be included or excluded from a
...
\begin{example}
  ...
  bmad_com[radiation_zero_average]    = True or False  ! Make average radiation kick zero.
\end{example}
...
coordinates
\begin{align}
  \Delta p_x &= -k_E \, p_x \, (1 + p_z) \CRNO
  \Delta p_y &= -k_E \, p_y \, (1 + p_z) \\
  \Delta p_z &\approx \frac{\Delta E}{E_0} = -k_E \, (1 + p_z)^2 \nonumber
\end{align}
