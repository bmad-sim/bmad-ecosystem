...
designed to use the custom attributes. Currently, up to three custom
...
\begin{example}
  parameter[custom_attribute1] = "quadrupole::error"
  parameter[custom_attribute2] = "mag_id"
\end{example}
The first example assigns a custom attribute name of \vn{error} to all
quadrupoles.  The second example assigns a custom attributge name of
