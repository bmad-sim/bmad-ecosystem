...
\author{}
\date{David Sagan and Chris Mayes \\ November 18, 2021}
\begin{document}
...
files in the \vn{bmad-sim/tao_examples/} directory.
%
\vspace{-0.4 ex}
\item[util] \Newline
...
\item
\label{s:opt.ex1}
Start with the files in \vn{bmad-sim/tutorial_bmad_tao/lattice_files/lattice_optimization}. Change
