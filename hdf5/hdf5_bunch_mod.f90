...
unit_si = hdf5_get_attribute_real(obj_id, 'unitSI', error, .true.);  if (error) return
...
!
  ...
  value = hdf5_get_attribute_int(obj_id, 'value', error, .true.)
...
!
  ...
  value = hdf5_get_attribute_real(obj_id, 'value', error, .true.)
