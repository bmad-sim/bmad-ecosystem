...
case ('global')
  ...
  if (print_global) then
    ...
    call write_this_arg (nl, lines, '-init', s%com%init_arg)
    call write_this_arg (nl, lines, '-lat', s%com%lat_arg)
    ...
    call write_this_arg (nl, lines, '-plot', s%com%plot_arg)
    ...
    call write_this_arg (nl, lines, '-startup', s%com%startup_arg)
    call write_this_arg (nl, lines, '-var', s%com%var_arg)
  endif
