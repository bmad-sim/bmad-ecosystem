...
type tao_common_struct
  ...
  character(200) :: init_arg_path = ''           ! Path part of init_tao_file
  character(200) :: lat_arg = ''                 ! -lat               command line argument.
  ...
  character(200) :: var_arg = ''                 ! -var               command line argument.
  character(200) :: building_wall_arg = ''       ! -building_wall     command line argument.
