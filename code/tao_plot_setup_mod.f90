...
case ('scatter')
  call tao_scatter_graph_setup(plot, graph)
end select
...
subroutine tao_data_section_graph_setup (plot, graph)
...
character(40) :: r_name = 'tao_scatter_graph_setup'
...
end subroutine tao_scatter_graph_setup
