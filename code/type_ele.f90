...
character(40), parameter :: att_name(51) = [character(40):: 'X_PITCH', 'Y_PITCH', 'X_OFFSET', &
                ...
                'X_DISPERSION_CALIB', 'K1X']

character(40), parameter :: att2_name(51) = [character(40):: 'X_PITCH_TOT', 'Y_PITCH_TOT', 'X_OFFSET_TOT', &
