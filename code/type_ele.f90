...
character(40), parameter :: att_name(75) = [character(40):: 'X_PITCH', 'Y_PITCH', 'X_OFFSET', &
                ...
                'MATCH_END_ORBIT_INPUT', 'C11_MAT0', 'C12_MAT0', 'C21_MAT0', 'C22_MAT0']

character(40), parameter :: att2_name(75) = [character(40):: 'X_PITCH_TOT', 'Y_PITCH_TOT', 'X_OFFSET_TOT', &
                ...
                'MATCH_END_ORBIT', 'C11_MAT1', 'C12_MAT1', 'C21_MAT1', 'C22_MAT1']
