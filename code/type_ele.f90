...
character(40), parameter :: att_name(54) = [character(40):: 'X_PITCH', 'Y_PITCH', 'X_OFFSET', &
...
character(40), parameter :: att2_name(54) = [character(40):: 'X_PITCH_TOT', 'Y_PITCH_TOT', 'X_OFFSET_TOT', &
