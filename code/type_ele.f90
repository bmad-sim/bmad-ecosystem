...
do ia = 1, num_ele_attrib$
  ...
  select case (a_name)
  case ('RF_FREQUENCY');    if (ele%value(ia) /= 0) attrib2 = ele_attribute_struct('RF_WAVELENGTH', dependent$, is_real$, 'm', -1, &
                                                                            c_light * ele%value(p0c$) / (ele%value(ia) * ele%value(e_tot$)))
  case ('P0C')
...
character(40), parameter :: att_name(48) = [character(40):: 'X_PITCH', 'Y_PITCH', 'X_OFFSET', &
                ...
                'PZ_APERTURE_WIDTH2', 'Z_APERTURE_WIDTH2', 'CMAT_11', 'CMAT_21']

character(40), parameter :: att2_name(48) = [character(40):: 'X_PITCH_TOT', 'Y_PITCH_TOT', 'X_OFFSET_TOT', &
                ...
                'PZ_APERTURE_CENTER', 'Z_APERTURE_CENTER', 'CMAT_12', 'CMAT_22']
