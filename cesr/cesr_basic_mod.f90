...
! Rule: Trust ele%type spec over a name match...
...
ele_loop: do i = 1, lat%n_ele_max
  ...
  if (ele%type /= '') then
    ...
    if (ele%type(1:12) == 'CSR QADD CUR') then
      read (ele%type(13:16), *) ix
      call insert_info (cesr%quad(100+ix), ele, i)
      cycle ele_loop
    endif

    if (ele%type(1:12) == 'SCIR QUADCUR') then
      read (ele%type(13:16), *) ix
      call insert_info (cesr%quad(110+ix), ele, i)
      cycle ele_loop
    endif

    if (ele%type(1:12) == 'CSR SQEWQUAD') then
      read (ele%type(13:16), *) ix
      call insert_info (cesr%skew_quad(ix), ele, i)
      cycle ele_loop
    endif

    if (ele%type(1:12) == 'SCIR SKQUCUR') then
      read (ele%type(13:16), *) ix
      call insert_info (cesr%skew_quad(110+ix), ele, i)
      cycle ele_loop
    endif
    ...
    if (ele%type(1:12) == 'CSR SQEWSEXT') then
      read (ele%type(13:16), *) ix
      call insert_info (cesr%skew_sex(ix), ele, i)
      cycle ele_loop
    endif
    ...
    if (ele%type(1:12) == 'CSR OCTU CUR') then
      read (ele%type(13:16), *) ix
      call insert_info (cesr%oct(ix), ele, i)
      cycle ele_loop
    endif
    ...
    if (ele%type(1:12) == 'BPM DETECTOR') then
      read (ele%type(13:16), *) ix
      call insert_info (cesr%det(ix), ele, i)
      cycle ele_loop
    endif
