...
call test1_f_direction_tile1(ok); if (.not. ok) all_ok = .false.
call test1_f_direction_tile(ok); if (.not. ok) all_ok = .false.
...
call test1_f_target_rectangle(ok); if (.not. ok) all_ok = .false.
