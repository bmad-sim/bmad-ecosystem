...
call test1_f_controller_var(ok); if (.not. ok) all_ok = .false.
...
call test1_f_em_field_cartesian_map_term(ok); if (.not. ok) all_ok = .false.
call test1_f_em_field_cartesian_map(ok); if (.not. ok) all_ok = .false.
call test1_f_em_field_cylindrical_map_term(ok); if (.not. ok) all_ok = .false.
call test1_f_em_field_cylindrical_map(ok); if (.not. ok) all_ok = .false.
call test1_f_em_field_taylor(ok); if (.not. ok) all_ok = .false.
