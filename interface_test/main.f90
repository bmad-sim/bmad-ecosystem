...
call test1_f_taylor_field_plane1(ok); if (.not. ok) all_ok = .false.
call test1_f_taylor_field_plane(ok); if (.not. ok) all_ok = .false.
call test1_f_taylor_field(ok); if (.not. ok) all_ok = .false.
...
call test1_f_rad1_mat(ok); if (.not. ok) all_ok = .false.
...
call test1_f_pixel_grid_pt(ok); if (.not. ok) all_ok = .false.
call test1_f_pixel_grid(ok); if (.not. ok) all_ok = .false.
...
call test1_f_controller_var1(ok); if (.not. ok) all_ok = .false.
