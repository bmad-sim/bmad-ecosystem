...
namespace Bmad {
  ...
  const int PIPE = 44, CAPILLARY = 45;
  const int N_KEY = 45;
  ...
  const int       CRITICAL_ANGLE = 7, B_PARAM = 7;
  ...
  const int FINT=10, POLARITY=10, GRADIENT=10, CRUNCH_CALIB=10, ALPHA_ANGLE=10;
  const int FINTX=11, Z_PATCH=11, PHI0=11, X_OFFSET_CALIB=11, D_SPACING=11;
  const int RHO=12, S_CENTER=12, P0C_START=12, Y_OFFSET_CALIB=12, V_UNITCELL=12;
  const int HGAP=13, E_TOT_START=13, TILT_CALIB=13, F0_RE=13;
  const int COEF=14, CURRENT=14, HGAPX=14, DELTA_E=14, L_POLE=14;
  const int       DE_ETA_MEAS=14, F0_IM=14;
  const int ROLL=15, QUAD_TILT=15, LR_FREQ_SPREAD=15, X_RAY_LINE_LEN=15;
  const int N_SAMPLE=15, FH_RE=15;
  const int L_ORIGINAL=16, L_CHORD=16, BEND_TILT=16, FH_IM=16;
  const int L_START=17, H1=17, X_QUAD=17, G_GRAZE=17;
  ...
  const int POLE_RADIUS = 28, COUPLER_AT = 28;
  const int BS_FIELD=29, REF_WAVELENGTH=29, COUPLER_STRENGTH = 29, E_TOT_OFFSET = 29;
  const int B_FIELD=30, E_FIELD=30, COUPLER_PHASE = 30, NX_OUT = 30;
  const int B_GRADIENT=31, E_GRADIENT=31, COUPLER_ANGLE = 31, NY_OUT = 31;
  const int B1_GRADIENT=32, E1_GRADIENT=32, NZ_OUT = 32;
  ...
  const int N_REF_PASS=45;
  const int P0C=46;
  const int E_TOT=47;
  const int INTEGRATOR_ORDER = 48;
