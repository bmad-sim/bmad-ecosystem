...
namespace Bmad {
  const int BMAD_INC_VERSION = 103;
  ...
  const int COEF=14, CURRENT=14, HGAPX=14, DELTA_E=14, L_POLE=14, DPHI0_MAX=14;
  ...
  const int H1=17, X_QUAD=17, REF_POLARIZATION=17, DPHI0_REF = 17;
  const int H2=18, Y_QUAD=18, NEGATIVE_GRAZE_ANGLE = 18, FIELD_SCALE = 18;
  ...
  const int L_Z = 58;
  const int SCRATCH = 59, DS_FIELD_OFFSET = 59;
  ...
  const int SYMP_LIE_BMAD = 10, STATIC = 11;
  ...
  const int NO_END = 4, CONTINUOUS = 5, BETWEEN_ENDS = 6, ALIVE = 7;
  const int LOST = 10;
