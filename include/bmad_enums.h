...
namespace Bmad {
  const int BMAD_INC_VERSION = 115;
  ...
  const int E_FIELD_X_PHOTON = 10,  E_FIELD_Y_PHOTON = 11;
  const int PHASE_X_PHOTON = 12, PHASE_Y_PHOTON = 13;
  const int L=1;
  ...
  const int PHI0=13, TILT_CALIB=13, F0_RE=13, F0_RE1=13, S_MAX=13;
  ...
  const int DPHI0=15, N_SAMPLE=15, FH_RE=15, F0_RE2=15;
  const int DPHI0_REF = 16, FH_IM=16, F0_IM2=16, X_LENGTH=16, X_ORIGIN= 16;
  const int DPHI0_MAX=17, REF_POLARIZATION=17, Y_LENGTH=17, Y_ORIGIN = 17;
  const int NEGATIVE_GRAZE_ANGLE = 18, Z_ORIGIN = 18;
  const int FRINGE_TYPE = 18, FLOOR_SET = 18, PTC_DIR = 18;
  const int KILL_FRINGE = 19, THETA_ORIGIN = 19;
  const int B_PARAM = 19;
  const int D_SPACING = 20, L_HARD_EDGE = 20, PHI_ORIGIN = 20;
  const int FIELD_SCALE = 21, PSI_ORIGIN = 21;
  const int ROLL=22, N_CELL=22, X_RAY_LINE_LEN=22;
