...
namespace Bmad {
  ...
  const int NULL_ELE = 27, INIT_ELE = 28;
  ...
  const int DPHI0=15, N_SAMPLE=15, F0_RE2=15, ORIGIN_ELE_REF_PT=15;
  const int DPHI0_REF = 16, F0_IM2=16, X_HALF_LENGTH=16, DX_ORIGIN= 16;
