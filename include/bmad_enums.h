...
namespace Bmad {
  ...
  const int FB2 = 22, X_OFFSET_CALIB = 22, V1_UNITCELL = 22, PSI_ANGLE = 22;
  ...
  const int X_QUAD = 27, DS_PHOTON_SLICE = 27, MOSAIC_ANGLE_RMS_OUT_PLANE = 27, PY_APERTURE_CENTER = 27;
  const int ETAP_Y_OUT = 28, PHI0_MAX = 28, DY_ORIGIN = 28, Y_QUAD = 28, E_FIELD_X = 28, Z_APERTURE_WIDTH2 = 28;
  const int UPSTREAM_ELE_DIR = 29, DZ_ORIGIN = 29, MOSAIC_DIFFRACTION_NUM = 29, Z_APERTURE_CENTER = 29;
  const int CMAT_11 = 29, FIELD_AUTOSCALE = 29, L_SAGITTA = 29, E_FIELD_Y = 29;
  const int CMAT_12 = 30, DTHETA_ORIGIN = 30, B_PARAM = 30, L_CHORD = 30, SCALE_FIELD_TO_ONE = 30;
  const int DOWNSTREAM_ELE_DIR = 30, PZ_APERTURE_WIDTH2 = 30;
  const int CMAT_21 = 31, L_HARD_EDGE = 31, DPHI_ORIGIN = 31, REF_CAP_GAMMA = 31;
