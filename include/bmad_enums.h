...
namespace Bmad {
  ...
  const int PHI0 = 24, TILT_CALIB = 24, F0_RE = 24, F0_RE1 = 24;
  const int PHI0_ERR = 25, COEF = 25, CURRENT = 25, L_POLE = 25, PARTICLE = 25;
  const int QUAD_TILT = 25, DE_ETA_MEAS = 25, F0_IM = 25, F0_IM1 = 25;
  const int GEOMETRY = 26, BEND_TILT = 26, MODE = 26;
  const int DPHI0 = 26, N_SAMPLE = 26, F0_RE2 = 26, ORIGIN_ELE_REF_PT = 26;
  const int DPHI0_REF = 27, F0_IM2 = 27, X_HALF_LENGTH = 27, DX_ORIGIN =  17;
  ...
  const int HKICK = 39, D_SPACING = 39, T_OFFSET = 39, X_OFFSET_SOL = 39;
  const int VKICK = 40, L_X = 40, Y_OFFSET_SOL = 40;
  const int BL_HKICK = 41, X_PITCH_SOL = 41, L_Y = 41;
  const int BL_VKICK = 42, Y_PITCH_SOL = 42, L_Z = 42;
  const int BL_KICK = 43, COUPLER_AT = 43, EPS_STEP_SCALE = 43;
  ...
  const int B2_GRADIENT = 47, E2_GRADIENT = 47, H_X_NORM = 47;
  const int B3_GRADIENT = 48, E3_GRADIENT = 48, H_Y_NORM = 48;
  const int BS_FIELD = 49, E_TOT_OFFSET = 49, H_Z_NORM = 49, PTC_FIELD_GEOMETRY = 49;
