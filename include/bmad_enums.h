...
namespace Bmad {
  ...
  const int G_ERR = 7, BBI_CONST = 7, OSC_AMPLITUDE = 7;
  const int GRADIENT_ERR = 7, CRITICAL_ANGLE = 7, SAD_FLAG = 7;
  const int BRAGG_ANGLE_OUT = 7, IX_TO_BRANCH = 7;
  const int RHO = 8, DELTA_E_REF = 8, DIFFRACTION_LIMITED = 8, INTERPOLATION = 8;
  ...
  const int PHI0_ERR = 25, CURRENT = 25, PARTICLE = 25;
  ...
  const double M_NEUTRON  = 0.9395654133E9;
