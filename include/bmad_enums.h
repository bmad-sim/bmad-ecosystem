...
namespace Bmad {
  const int BMAD_INC_VERSION = 225;
  ...
  const int D1_THICKNESS = 20, DEFAULT_TRACKING_SPECIES = 20, DIRECTION_BEAM_START = 20, SIG_E2 = 20;
  ...
  const int E_LOSS = 21, DKS_DS = 21, GAP = 21, SPIN_X = 21, E_CENTER = 21;
  const int X_OFFSET_CALIB = 22, V1_UNITCELL = 22, PSI_ANGLE = 22;
  const int SPIN_Y = 22, E2_CENTER = 22;
  const int Y_OFFSET_CALIB = 23, V_UNITCELL = 23, V2_UNITCELL = 23, SPIN_Z = 23;
  const int CAVITY_TYPE = 23, BETA_A = 23, E2_PROBABILITY = 23;
  ...
  const int LATTICE = 86, PHI_A = 86, MULTIPOLES_ON = 86, PY_REF = 86, ELLIPTICAL_CURVATURE_Z = 84;
