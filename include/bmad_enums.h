...
namespace Bmad {
  const int BMAD_INC_VERSION = 244;
  ...
  const int AC_KICKER = 58, LENS = 59, BEAM_INIT = 60, CRAB_CAVITY = 61, N_KEY = 61;
  ...
  const int KS = 5, FLEXIBLE = 5, CRUNCH = 5, REF_ORBIT_FOLLOWS = 5, E_OUT_MIN = 5;
  const int GRADIENT = 6, K3 = 6, NOISE = 6, NEW_BRANCH = 6, IX_BRANCH = 6, G_MAX = 6;
  const int G = 6, SYMMETRY = 6, FIELD_SCALE_FACTOR = 6, E_OUT_MAX = 6;
  const int G_ERR = 7, BBI_CONST = 7, OSC_AMPLITUDE = 7, IX_TO_BRANCH = 7, ANGLE_OUT_MAX = 7;
  const int GRADIENT_ERR = 7, CRITICAL_ANGLE = 7, SAD_FLAG = 7, BRAGG_ANGLE_IN = 7;
  const int RHO = 8, DELTA_E_REF = 8, INTERPOLATION = 8, BRAGG_ANGLE_OUT = 8;
  const int CHARGE = 8, X_GAIN_CALIB = 8, IX_TO_ELEMENT = 8, VOLTAGE = 8;
  const int EPS_STEP_SCALE = 9, VOLTAGE_ERR = 9, BRAGG_ANGLE = 9;
  ...
  const int FB1 = 14, SIG_X = 14, EXACT_MULTIPOLES = 14, PENDELLOSUNG_PERIOD_PI = 14;
  ...
  const int E_LOSS = 21, GAP = 21, SPIN_X = 21, E_CENTER = 21;
  const int X_OFFSET_CALIB = 22, V1_UNITCELL = 22, PSI_ANGLE = 22;
  const int SPIN_Y = 22, E2_CENTER = 22, N_PERIOD = 22;
  const int Y_OFFSET_CALIB = 23, V_UNITCELL = 23, V2_UNITCELL = 23, SPIN_Z = 23, L_PERIOD = 23;
  const int CAVITY_TYPE = 23, BETA_A = 23, E2_PROBABILITY = 23, HIGH_ENERGY_SPACE_CHARGE_ON = 23;
  const int PHI0 = 24, TILT_CALIB = 24, BETA_B = 24, LIVE_BRANCH = 24, E_CENTER_RELATIVE_TO_REF = 24;
  const int IS_MOSAIC = 24;
  const int PHI0_ERR = 25, CURRENT = 25, PARTICLE = 25, MOSAIC_THICKNESS = 25;
  const int QUAD_TILT = 25, DE_ETA_MEAS = 25, ALPHA_A = 25, SPATIAL_DISTRIBUTION = 25;
  const int GEOMETRY = 26, BEND_TILT = 26, MODE = 26, ALPHA_B = 26, VELOCITY_DISTRIBUTION = 26;
  const int PHI0_MULTIPASS = 26, N_SAMPLE = 26, ORIGIN_ELE_REF_PT = 26, MOSAIC_ANGLE_RMS_IN_PLANE = 26;
  const int PHI0_AUTOSCALE = 27, DX_ORIGIN =  27, CMAT_11 = 27, ENERGY_DISTRIBUTION = 27;
  const int LATTICE_TYPE = 27, X_QUAD = 27, DS_PHOTON_SLICE = 27, MOSAIC_ANGLE_RMS_OUT_PLANE = 27;
  const int PHI0_MAX = 28, DY_ORIGIN = 28, Y_QUAD = 28, PHOTON_TYPE = 28;
  const int CMAT_12 = 28, E_FIELD_X = 28;
  const int FLOOR_SET = 29, UPSTREAM_ELE_DIR = 29, DZ_ORIGIN = 29, MOSAIC_DIFFRACTION_NUM = 29;
  const int FIELD_AUTOSCALE = 29, CMAT_21 = 29, L_SAGITTA = 29, E_FIELD_Y = 29;
  const int DTHETA_ORIGIN = 30, B_PARAM = 30, L_CHORD = 30, SCALE_FIELD_TO_ONE = 30;
  const int DOWNSTREAM_ELE_DIR = 30, CMAT_22 = 30;
  const int L_HARD_EDGE = 31, DPHI_ORIGIN = 31, REF_CAP_GAMMA = 31, TRANSVERSE_SIGMA_CUT = 31;
  const int L_SOFT_EDGE = 31;
  const int DPSI_ORIGIN = 32, T_OFFSET = 32, DS_SLICE = 32;
  ...
  const int BL_VKICK = 42, Y_PITCH_MULT = 42;
  const int BL_KICK = 43, B_FIELD = 43, E_FIELD = 43;
  const int COUPLER_PHASE = 44, B_FIELD_ERR = 44;
  const int B1_GRADIENT = 45, E1_GRADIENT = 45, COUPLER_ANGLE = 45;
  const int B2_GRADIENT = 46, E2_GRADIENT = 46, COUPLER_STRENGTH = 46;
  ...
  const int ETAP_Y = 85, LR_FREQ_SPREAD = 85, Y_REF = 85, ELLIPTICAL_CURVATURE_Y = 85;
  ...
  const int CSR_METHOD = 89, CMAT_12_BEGIN = 89, VAR = 89, Z_REF = 89;
  const int CMAT_21_BEGIN = 90, PZ_REF = 90, SPACE_CHARGE_METHOD = 90;
  ...
  const int X_POSITION = 102, PTC_EXACT_MODEL = 102;
