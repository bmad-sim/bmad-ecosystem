...
call test1_f_gg_taylor_term(ok); if (.not. ok) all_ok = .false.
call test1_f_gg_taylor(ok); if (.not. ok) all_ok = .false.
...
call test1_f_gen_grad_curve(ok); if (.not. ok) all_ok = .false.
call test1_f_gen_gradients(ok); if (.not. ok) all_ok = .false.
