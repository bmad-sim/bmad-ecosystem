...
call rf_auto_scale_phase_and_amp (lat%ele(2), lat%param, err_flag)
...
write (1, *)
write (1, '(a, es22.12)') '"dvec(1)" ABS  1E-19', orb2(2)%vec(1) - orb1(2)%vec(1)
write (1, '(a, es22.12)') '"dvec(2)" ABS  1E-19', orb2(2)%vec(2) - orb1(2)%vec(2)
write (1, '(a, es22.12)') '"dvec(3)" ABS  1E-19', orb2(2)%vec(3) - orb1(2)%vec(3)
write (1, '(a, es22.12)') '"dvec(4)" ABS  1E-19', orb2(2)%vec(4) - orb1(2)%vec(4)
write (1, '(a, es22.12)') '"dvec(5)" ABS  1E-15', orb2(2)%vec(5) - orb1(2)%vec(5)
write (1, '(a, es22.12)') '"dvec(6)" ABS  1E-14', orb2(2)%vec(6) - orb1(2)%vec(6)
