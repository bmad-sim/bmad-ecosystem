...
write (1, '(a, es20.10)') '"time_runge_kutta:vec(1)" ABS  1E-10', end_orb1%vec(1)
write (1, '(a, es20.10)') '"time_runge_kutta:vec(2)" ABS  1E-10', end_orb1%vec(2)
write (1, '(a, es20.10)') '"time_runge_kutta:vec(3)" ABS  1E-10', end_orb1%vec(3)
write (1, '(a, es20.10)') '"time_runge_kutta:vec(4)" ABS  1E-10', end_orb1%vec(4)
write (1, '(a, es20.10)') '"time_runge_kutta:vec(5)" ABS  1E-10', end_orb1%vec(5)
write (1, '(a, es20.10)') '"time_runge_kutta:vec(6)" ABS  1E-10', end_orb1%vec(6)
write (1, '(a, es20.10)') '"time_runge_kutta:s     " ABS  1E-10', end_orb1%s
write (1, '(a, es20.10)') '"time_runge_kutta:t     " ABS  1E-10', end_orb1%t
