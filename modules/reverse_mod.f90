...
!
!#########################################################################
! WARNING! THIS ROUTINE IS ANTIQUATED AND SHOULD NOT BE USED!
! INSTEAD: TRACK BACKWARDS IN AN UNREVERSED LATTICE.
! OR USE "--" ELEMENT REVERSAL IN YOUR LATTICE FILE
!#########################################################################
!
...
do i = 1, rlat%n_control_max
  ...
  if (con%lord%ix_ele <= rlat%n_ele_track)  con%lord%ix_ele  = rlat%n_ele_track+1-con%lord%ix_ele
enddo
