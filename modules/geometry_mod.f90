...
!---------------------------------------------------------------------------
!+
! Function coords_local_curvilinear_to_floor (local_position, ele, w_mat) result (global_position)
!
...
global_position = coords_relative_to_floor (floor, dr, local_position%theta, local_position%phi, local_position%psi)
