...
case (KIND0);        write (kind_str, '(a, i0)') kind0, ': KIND0 [Marker, Patch]'
case (KIND1);        write (kind_str, '(a, i0)') kind1, ': KIND1 [Drift]'
case (KIND2);        write (kind_str, '(a, i0)') kind2, ': KIND2 [Drift-Kick-Drift EXACT_MODEL = F]'
case (KIND3);        write (kind_str, '(a, i0)') kind3, ': KIND3 [Thin Element, L == 0]'
case (KIND4);        write (kind_str, '(a, i0)') kind4, ': KIND4 [RFcavity]'
case (KIND5);        write (kind_str, '(a, i0)') kind5, ': KIND5 [Solenoid]'
case (KIND6);        write (kind_str, '(a, i0)') kind6, ': KIND6 [Kick-SixTrack-Kick]'
case (KIND7);        write (kind_str, '(a, i0)') kind7, ': KIND7 [Matrix-Kick-Matrix]'
case (KIND8);        write (kind_str, '(a, i0)') kind8, ': KIND8 [Normal SMI]'
case (KIND9);        write (kind_str, '(a, i0)') kind9, ': KIND9 [Skew SMI]'
case (KIND10);       write (kind_str, '(a, i0)') kind10, ': KIND10 [Sector Bend, Exact_Model]'
case (KIND11);       write (kind_str, '(a, i0)') kind11, ': KIND11 [Monitor]'
case (KIND12);       write (kind_str, '(a, i0)') kind12, ': KIND12 [HMonitor]'
case (KIND13);       write (kind_str, '(a, i0)') kind13, ': KIND13 [VMonitor]'
case (KIND14);       write (kind_str, '(a, i0)') kind14, ': KIND14 [Instrument]'
case (KIND15);       write (kind_str, '(a, i0)') kind15, ': KIND15 [ElSeparator]'
case (KIND16);       write (kind_str, '(a, i0)') kind16, ': KIND16 [True RBend, EXACT_MODEL = T]'
case (KIND17);       write (kind_str, '(a, i0)') kind17, ': KIND17 [SixTrack Solenoid]'
case (KIND18);       write (kind_str, '(a, i0)') kind18, ': KIND18 [Rcollimator]'
case (KIND19);       write (kind_str, '(a, i0)') kind19, ': KIND19 [Ecollimator]'
case (KIND20);       write (kind_str, '(a, i0)') kind20, ': KIND20 [Straight Geometry MAD RBend]'
case (KIND21);       write (kind_str, '(a, i0)') kind21, ': KIND21 [Traveling Wave Cavity]'
case (KIND22);       write (kind_str, '(a, i0)') kind22, ': KIND22'
case (KIND23);       write (kind_str, '(a, i0)') kind23, ': KIND23'
case (KINDWIGGLER);  write (kind_str, '(a, i0)') kindwiggler, ': KINDWIGGLER [Wiggler]'
case (KINDPA);       write (kind_str, '(a, i0)') kindpa, ': KINDPA'
