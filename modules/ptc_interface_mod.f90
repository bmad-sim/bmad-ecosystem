...
case (marker$, detector$, branch$, photon_branch$, beginning_ele$, patch$, floor_shift$, fiducial$)
...
case (marker$, detector$, branch$, photon_branch$, beginning_ele$, em_field$, patch$, fiducial$, floor_shift$)
  return
