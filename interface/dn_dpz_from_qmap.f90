!+
! Subroutine dn_dpz_from_qmap (orb_mat, q_map, dn_dpz)
!
...
real(rp) w0(3,3), qv(0:3), n0(0:3), q0(0:3), qq(0:3)
complex(rp) eval(6), evec(6,6), dd(3,3), gv(3,1), n_eigen(6,3), vv(6,6), aa(6,1)
...
end subroutine dn_dpz_from_qmap
