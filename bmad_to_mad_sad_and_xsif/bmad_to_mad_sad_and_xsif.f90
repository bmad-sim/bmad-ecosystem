...
!
! Usage:
!   bmad_to_mad_sad_and_xsif {-nobpm} {-noaperture} {-xsif} {-mad8} {-madx} {-sad} <bmad_file_name>
!
...
!
! The SAD file name will be the bmad_file_name with the '.bmad' suffix
! (or whatever suffix is there) replaced by a '.sad' suffix.
!
