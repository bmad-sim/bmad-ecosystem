...
character(n_file_max_len) plot_file, data_file, var_file, file_name, startup_file, hook_init_file
character(n_file_max_len) building_wall_file, beam_file, why_invalid, init_tao_file, str, files(20)
