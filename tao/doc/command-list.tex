...
\begin{example}
  ...
  lat_calc_done, lat_ele_list, lat_list, lat_param_units, lord_control, matrix, merit, orbit_at_s,
  ...
  show, slave_control, species_to_int, species_to_str, spin_invariant, spin_polarization, 
