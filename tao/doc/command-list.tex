...
<b>NOTE: The fixer element is in construction and is not yet usable.</b>

The \vn{Fixer} command can be used to set the active fixer and can be used to transfer fixer parameters
from the from the actual to the stored.
Format:
\begin{example}
  fixer -activate <fixer>
  fixer -transfer <fixer> <parameters> 
\end{example}
...
The \vn{-activate} command activates (turns on) a given fixer element.
