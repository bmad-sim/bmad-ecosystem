...
Also see \vn{tao_hook_lattice_calc} and \vn{tao_hook_universe_calc_post_process}.
...
something else needs to be performed whenever the lattice is recalculated then it can be done here. A
custom lattice calculation can be performed in any universe separately, this allows for the
possibility of, for example, tracking a single particle for one lattice and beams in another.

See also \vn{tao_hook_branch_calc} and \vn{tao_hook_universe_calc_post_process}.
...
%-----------------------------------------------------------------
\subsection{tao_hook_universe_calc_post_process}
\index{customizing!tao_hook_universe_calc_post_process}

The standard lattice calculation can be performed for single particle, particle beam tracking and
will recalculate the orbit, transfer matrices, twiss parameters and load the data arrays. If
something else needs to be performed whenever the lattice is recalculated then it can be done
here. A custom lattice calculation can be performed in any universe separately, this allows for the
possibility of, for example, tracking a single particle for one universe and beams in another.

See also \vn{tao_hook_branch_calc} and \vn{tao_hook_lattice_calc}.
