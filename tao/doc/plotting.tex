...
\end{example}
In addition, all 138 CSS4 (CSS Color Level 4) named colors are available (e.g., \vn{"salmon"},
\vn{"darkslategray"}, \vn{"mediumspringgreen"}). Ten CSS4 names that share both name and RGB value
with original colors are excluded: \vn{black}, \vn{blue}, \vn{cyan}, \vn{green}, \vn{magenta},
\vn{orange}, \vn{purple}, \vn{red}, \vn{white}, and \vn{yellow}. See the ``Styles'' section of the
Quick\_Plot chapter in the Bmad manual for the full color index scheme.
