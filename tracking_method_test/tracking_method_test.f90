...
do ib = 0, ubound(lat%branch, 1)
  ...
  DO i = 1, branch%n_ele_max - 1
     ...
     DO j = 1, n_methods$
        ...
        call init_coord (start_orb, start_orb, ele, .false., E_photon = ele%value(p0c$) * 1.006)
        start_orb%field = [1, 2]
...
character(38) :: instr
  ...
  select case (instr)
    ...
    case('"SBEND4:Symp_Lie_PTC"')        ; tolerance = 'REL  1E-08'
    case('"SBEND4:Linear"')              ; tolerance = 'REL  1E-08'
    case('"SBEND4:Taylor"')              ; tolerance = 'REL  2E-07'
    case('"SBEND6:Symp_Lie_PTC"')        ; tolerance = 'REL  1E-08'
    case('"SBEND6:Linear"')              ; tolerance = 'REL  1E-08'
