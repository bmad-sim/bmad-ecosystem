...
! assuming both walls start at s=0
  ...
  walls%initial_end%power%power_tot = 0
  walls%initial_end%power%power_per_len = 0
  walls%initial_end%power%power_per_area = 0
  walls%initial_end%power%ix_ele_source = 0
  walls%initial_end%power%s_source = 0
  walls%initial_end%power%n_source = 0
  nullify (walls%initial_end%power%sources)
  ...
  walls%final_end%power%power_tot = 0
  walls%final_end%power%power_per_len = 0
  walls%final_end%power%power_per_area = 0
  walls%final_end%power%ix_ele_source = 0
  walls%final_end%power%s_source = 0
  walls%final_end%power%n_source = 0
  nullify (walls%final_end%power%sources)
