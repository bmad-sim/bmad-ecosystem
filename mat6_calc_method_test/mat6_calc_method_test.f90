...
case ('"SBEND5:Tracking:MatrixRow1"')              ; tolerance = 'ABS 2e-09'
case ('"SBEND5:Tracking:MatrixRow2"')              ; tolerance = 'ABS 5e-12'
case ('"SBEND5:Tracking:MatrixRow3"')              ; tolerance = 'ABS 2e-10'
case ('"SBEND5:Tracking:MatrixRow4"')              ; tolerance = 'ABS 1e-10'
case ('"SBEND5:Tracking:MatrixRow5"')              ; tolerance = 'ABS 4e-10'
case ('"SBEND5:Tracking:Symp_Err"')                ; tolerance = 'ABS 6e-10'
case ('"SBEND5:Tracking:Vector"')                  ; tolerance = 'ABS 6e-12'
case ('"SBEND7:Tracking:MatrixRow1"')              ; tolerance = 'ABS 3e-09'
case ('"SBEND7:Tracking:MatrixRow2"')              ; tolerance = 'ABS 2e-11'
case ('"SBEND7:Tracking:MatrixRow3"')              ; tolerance = 'ABS 3e-10'
case ('"SBEND7:Tracking:MatrixRow4"')              ; tolerance = 'ABS 2e-10'
case ('"SBEND7:Tracking:MatrixRow5"')              ; tolerance = 'ABS 2e-11'
case ('"SBEND7:Tracking:Symp_Err"')                ; tolerance = 'ABS 4e-10'
