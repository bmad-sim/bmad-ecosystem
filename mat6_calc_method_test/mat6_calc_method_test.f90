...
case ('"WIGGLER_MAP1:Tracking:MatrixRow1"')       ; tolerance = 'ABS 1e-11'
case ('"WIGGLER_MAP1:Tracking:MatrixRow2"')       ; tolerance = 'ABS 1e-11'
case ('"WIGGLER_MAP1:Tracking:MatrixRow3"')       ; tolerance = 'ABS 1e-11'
case ('"WIGGLER_MAP1:Tracking:MatrixRow5"')       ; tolerance = 'ABS 1e-11'
...
case ('"LCAVITY3:Tracking:MatrixRow6"')            ; tolerance = 'ABS 1e-11'

case ('"SBEND2:Tracking:MatrixRow5"')              ; tolerance = 'ABS 2e-12'
case ('"SBEND3:Tracking:MatrixRow5"')              ; tolerance = 'ABS 4e-12'
...
case ('"SBEND4:Tracking:MatrixRow1"')              ; tolerance = 'ABS 1e-08'
case ('"SBEND4:Tracking:MatrixRow2"')              ; tolerance = 'ABS 2e-10'
case ('"SBEND4:Tracking:MatrixRow3"')              ; tolerance = 'ABS 1e-07'
case ('"SBEND4:Tracking:MatrixRow4"')              ; tolerance = 'ABS 2e-11'
case ('"SBEND4:Tracking:MatrixRow5"')              ; tolerance = 'ABS 5e-06'
case ('"SBEND4:Tracking:MatrixRow6"')              ; tolerance = 'ABS 2e-11'
case ('"SBEND4:Tracking:Vector"')                  ; tolerance = 'ABS 1e-07'
case ('"SBEND4:Tracking:Symp_Err"')                ; tolerance = 'ABS 1e-06'
...
case ('"SBEND6:Tracking:MatrixRow5"')              ; tolerance = 'ABS 4e-12'
...
case ('"SBEND6:Tracking:MatrixRow1"')              ; tolerance = 'ABS 2e-11'
case ('"SBEND6:Tracking:MatrixRow2"')              ; tolerance = 'ABS 1e-10'
case ('"SBEND6:Tracking:MatrixRow4"')              ; tolerance = 'ABS 1e-11'
case ('"SBEND6:Tracking:Symp_Err"')                ; tolerance = 'ABS 1e-10'
