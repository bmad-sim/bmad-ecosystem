...
orbit = orbit0
mat6 = mat0
call second_order_bend_edge_kick(ele, lat%param, first_track_edge$, orbit, mat6, .true.)
...
orbit = orbit0
mat6 = mat0
call second_order_bend_edge_kick(ele, lat%param, second_track_edge$, orbit, mat6, .true.)
